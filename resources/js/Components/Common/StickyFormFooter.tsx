...
export default function StickyFormFooter({
  ...
  return (
    <div className="bg-white rounded-xl p-4 shadow-md border border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4 sticky bottom-4 z-40 mt-5">
