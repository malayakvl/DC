...
export const setScheduleDoctorIdAction = createAction('schedule/SETUP_DOCTOR_ID');
export const setScheduleAssistantIdAction = createAction('schedule/SETUP_ASSISTANT_ID');
...
export const initServicesAction = createAction('schedule/INIT_SERVICES_EVENTS');
