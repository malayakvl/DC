        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10 pt-[100px]">
          ...
          <section className="grid md:grid-cols-2 gap-8 items-center mt-6">
            ...
            <div className="space-y-5">
              ...
              <p className="text-white max-w-xl">Чесний облік для клінік. Прозорі звіти, реальні залишки, зрозумілі гроші. Не
                для усих - лише для тих, хто готов бачити правду</p>
          ...
          <div className="flex flex-col mt-8 w-full text-white bg-[#000a21] p-[40px]">
            <p>Лікар і пацієнт нарешті говорять однією мовою - лікування пояснене просто і зрозуміло</p>
            <p className="mt-[20px]">Інтерактивна медична хроніка з необмеженою кількістю файлів будь-яких типів у строгій послідовності за часом</p>
          </div>
