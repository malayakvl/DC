        ...
        >
          ...
          <g className="dentin">
            <g
              ...
              style={{
                visibility:
                  !tooth44Diagnozis.implant &&
                  !tooth44Diagnozis.apex &&
                  !tooth44Diagnozis.shaper
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                id="dentin_v_44"
                className={`st9 change-color-psr-up ${tooth44Diagnozis.change_color ? 'diagnoze' : ''}`}
                d="M816.2,1175.2c-1.2,11.4-2.5,22.7-4.1,34c-1.5,11-3.2,22-5.1,32.9
                                ...
                                c3-7.6,5.6-15.3,7.9-23.1l28.4,4.6l26.6-4.4c2.2,9.3,4.2,18.6,5.7,28C815.2,1168,815.7,1171.6,816.2,1175.2z"
                style={{ fill: 'gb(253,222,136)' }}
              ></path>
            </g>
            <g
              id="dentin_n_44"
            ...
            >
              <path
                id="dentin_n_44"
                className={`st10 change-color-psr ${tooth44Diagnozis.change_color ? 'diagnoze' : ''}`}
                d="M814.3,1191.4c-0.7,5.9-1.5,11.9-2.3,17.8c-1.5,11-3.2,22-5.1,32.9
                                ...
                                c5.1,0.9,10.4,0.6,15.4-0.8c2.4-0.6,4.7-1.5,7-2.6c9-4.3,16.3-11.5,21.7-20C814.2,1191.6,814.2,1191.5,814.3,1191.4z"
                style={{ fill: 'gb(253,222,136)' }}
              ></path>
            </g>
          </g>
          ...
          <g className="pulp">
            <g>
              <path
                className={`st22 target top ${tooth44Diagnozis.channel_class} ${tooth44Diagnozis.channel_class} ${tooth44Diagnozis.pulpit ? 'pulpit' : ''} ${tooth44Diagnozis.periodontit ? 'periodontit' : ''}`}
