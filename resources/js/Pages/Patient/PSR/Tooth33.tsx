        ...
        >
          ...
          <g className="dentin">
            <g
              ...
              style={{
                visibility:
                  !tooth33Diagnozis.implant &&
                  !tooth33Diagnozis.apex &&
                  !tooth33Diagnozis.shaper
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                id="dentin_v_33"
                className={`st9 change-color-psr-up ${tooth33Diagnozis.change_color ? 'diagnoze' : ''}`}
            ...
            >
              <path
                id="dentin_n_33"
                className={`st10 change-color-psr ${tooth33Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g className="pulp">
            <g>
              <path
                className={`st22 target top ${tooth33Diagnozis.channel_class} ${tooth33Diagnozis.channel_class} ${tooth33Diagnozis.pulpit ? 'pulpit' : ''} ${tooth33Diagnozis.periodontit ? 'periodontit' : ''}`}
