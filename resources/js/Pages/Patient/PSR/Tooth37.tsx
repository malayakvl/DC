    ...
    <>
      <g className={`f-tooth-active`}>
        ...
        >
          <path
            className="st40"
            d="M1663.7,1221.1c1.7,3.2,3.4,6.5,4.8,9.9c2.7,6.2,5.3,12.5,7.5,19
        ...
        <g
          ...
          style={{
            visibility: tooth37Diagnozis.absent ? 'hidden' : 'inherit',
            transform: 'matrix(1, 0, 0, 1, 0, 0)',
          }}
        >
          <g className="dentin">
            <g
              ...
              style={{
                visibility:
                  !tooth37Diagnozis.implant &&
                  !tooth37Diagnozis.apex &&
                  !tooth37Diagnozis.shaper
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st9 change-color-psr-up ${tooth37Diagnozis.change_color ? 'diagnoze' : ''}`}
            ...
            <g
              ...
              style={{
                visibility:
                  !tooth37Diagnozis.culttab &&
                  !tooth37Diagnozis.abutment &&
                  !tooth37Diagnozis.implant &&
                  !tooth37Diagnozis.shaper &&
                  !tooth37Diagnozis.apex
                    ? 'inherit'
            ...
            >
              <path
                id="dentin_n_37"
                className={`st10 change-color-psr ${tooth37Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g className="pulp">
            <g className=" pulpitis-pfilling" style={{ visibility: 'inherit' }}>
              <path
                className={`st22 target top ${tooth37Diagnozis.channel_class} ${tooth37Diagnozis.channel_class} ${tooth37Diagnozis.pulpit ? 'pulpit' : ''} ${tooth37Diagnozis.periodontit ? 'periodontit' : ''}`}
          ...
          >
            ...
            >
              <path
                className={`vinir-fill ${tooth37Diagnozis.vinir_color}`}
