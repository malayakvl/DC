    ...
    <>
      <g className={`f-tooth-active`}>
        ...
        >
          <path
            className="st40"
            d="M1734.1,269c0,0-6.9,35.5-2.1,54.2s30.7,47.3,36.1,69.1
        ...
        <g
          ...
          style={{
            visibility: tooth27Diagnozis.absent ? 'hidden' : 'inherit',
            transform: 'matrix(1, 0, 0, 1, 0, 0)',
          }}
        >
          {/*CHANGE COLOR*/}
          <g className="dentin">
            <g
              ...
              style={{
                visibility:
                  !tooth27Diagnozis.implant &&
                  !tooth27Diagnozis.apex &&
                  !tooth27Diagnozis.shaper
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                id="dentin_v_27"
                className={`st9 change-color-psr-up ${tooth27Diagnozis.change_color ? 'diagnoze' : ''}`}
            ...
            <g
              className={`st10 change-color ${tooth27Diagnozis?.change_color ? 'diagnoze' : ''}`}
              style={{ visibility: 'inherit' }}
            >
              <path
                className={`st10 change-color-psr ${tooth27Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g className="pulp">
            <g className="hEmpty hRoot hImplant pulpitis-pfilling">
              <path
                className={`st22 target ${tooth27Diagnozis.channel_class}`}
            ...
            <g className="hEmpty hImplant pulpitis-pfilling">
              <path
                className={`st22 target top ${tooth27Diagnozis.channel_class} ${tooth27Diagnozis.channel_class} ${tooth27Diagnozis.pulpit ? 'pulpit' : ''} ${tooth27Diagnozis.periodontit ? 'periodontit' : ''}`}
            ...
            >
              <path
                className={`st22 part ${tooth27Diagnozis.channel_class} ${tooth27Diagnozis.channel_class} ${tooth27Diagnozis.pulpit ? 'pulpit' : ''} ${tooth27Diagnozis.periodontit ? 'periodontit' : ''} top-sealed-part`}
          ...
          <g
            ...
            style={{
              visibility:
                !tooth27Diagnozis.culttab &&
                !tooth27Diagnozis.abutment &&
                !tooth27Diagnozis.implant &&
                !tooth27Diagnozis.apex &&
                !tooth27Diagnozis.shaper
                  ? 'inherit'
          ...
          >
            ...
            >
              <path
                className={`vinir-fill ${tooth27Diagnozis.vinir_color}`}
