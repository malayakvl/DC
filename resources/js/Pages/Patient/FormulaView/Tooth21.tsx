...
export default function Tooth21({ formulaToothData }) {
  ...
  return (
    <>
      <g
        id="21"
        className={`tooth-number-active ${!tooth21Diagnozis.show ? 'hide-number' : ''}`}
      >
        <text
      ...
      <g
        id="TH-21"
        className={`f-tooth-init ${tooth21Diagnozis.show && !tooth21Diagnozis.absent ? 'f-tooth-active' : ''} adult`}
      >
        <g
          className={`underlay`}
          style={{
        ...
        >
          ...
          <g
            ...
            style={{
              opacity: tooth21Diagnozis.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="caries-filling">
              ...
              <path
                ...
                d="M1069.1,527.6c-4.3,0-8.6-0.2-12.9-0.3l-2.9-1.2c-1-1.1-1.8-2.3-2.4-3.6c-0.7-1.5-1.1-3.1-1.2-4.7
                                ...
                                C1071.2,458.9,1069.6,511.2,1069.1,527.6z"
                style={{
                  fill: tooth21Diagnozis.caries_left
                    ? '#606c80'
                    : tooth21Diagnozis.seal_left
                      ? tooth21Diagnozis.seal_left_color
                      : 'transparent',
                }}
              />
            </g>
            <g className="caries-filling">
              ...
              <path
                ...
                d="M1148,501.4c-0.5,3.6-1.1,7.1-2,10.6c-1.7,3.4-4.1,6.3-7,8.7c-2.3,1.9-4.8,3.4-7.6,4.4
                                ...
                                C1148.8,478.7,1149.5,490.1,1148,501.4z"
                style={{
                  fill: tooth21Diagnozis.caries_right
                    ? '#606c80'
                    : tooth21Diagnozis.seal_right
                      ? tooth21Diagnozis.seal_right_color
                      : 'transparent',
                }}
              />
            </g>
            <g className="caries-filling">
              ...
              <path
                ...
                d="M1143.8,447.1c-5.1,3.7-14.3,10.7-14.8,13.2c-0.6,2.9-4.9,48.3-6.5,65.6c-7.5,0.6-15,1-22.6,1.3
                                ...
                                C1140.4,434.9,1142.4,441,1143.8,447.1z"
                style={{
                  fill: tooth21Diagnozis.caries_top
                    ? '#606c80'
                    : tooth21Diagnozis.seal_top
                      ? tooth21Diagnozis.seal_top_color
                      : 'transparent',
                }}
              />
            </g>
