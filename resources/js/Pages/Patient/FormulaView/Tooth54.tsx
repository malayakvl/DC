...
export default function Tooth54({ formulaToothData }) {
  ...
  return (
    <>
      <g
        id="53"
        className={`tooth-number-active ${!tooth54Diagnozis.show ? 'hide-number' : ''}`}
      >
        <text transform="matrix(1 0 0 1 720 716)" className={`st3 st4 st5`}>
          54
        </text>
      </g>
      <g
        id="TH-54"
        className={`f-tooth-init-milk ${tooth54Diagnozis.show && !tooth54Diagnozis.absent ? 'f-tooth-active' : ''} child`}
      >
        <g
          className={`underlay`}
          style={{
        ...
        >
          ...
          <g
            className="tartar"
            style={{
              opacity: tooth54Diagnozis.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
