...
export default function Tooth64({ formulaToothData }) {
  ...
  return (
    <>
      <g
        id="64"
        className={`tooth-number-active ${!tooth64Diagnozis.show ? 'hide-number' : ''}`}
      >
        <text transform="matrix(1 0 0 1 1340 716)" className={`st3 st4 st5`}>
          64
        </text>
      </g>
      <g
        id="TH-64"
        className={`f-tooth-init-milk ${tooth64Diagnozis.show && !tooth64Diagnozis.absent ? 'f-tooth-active' : ''} child`}
      >
        <g
          className={`underlay `}
          style={{
        ...
        >
          ...
          <g
            className="tartar"
            style={{
              opacity: tooth64Diagnozis.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
