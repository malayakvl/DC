...
export default function Tooth12({ formulaToothData }) {
  ...
  return (
    <>
      <g
        id="12"
        className={`tooth-number-active ${!tooth12Diagnozis.show ? 'hide-number' : ''}`}
      >
        <text
      ...
      <g
        id="TH-12"
        className={`f-tooth-init ${tooth12Diagnozis.show && !tooth12Diagnozis.absent ? 'f-tooth-active' : ''} adult`}
      >
        <g
          className={`underlay`}
          style={{
        ...
        >
          ...
          <g
            ...
            style={{
              opacity: tooth12Diagnozis.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="caries-filling">
              ...
              <path
                ...
                d="M877,462c0.2,10.2,0.3,20.5,3.6,30.2c0.9,2.8,2.1,5.6,3.6,8.2c1.3,2.9,3.1,5.4,5.3,7.5
                                ...
                                C876.7,448.8,876.9,455.4,877,462z"
                style={{
                  fill: tooth12Diagnozis.caries_left
                    ? '#606c80'
                    : tooth12Diagnozis.seal_left
                      ? tooth12Diagnozis.seal_left_color
                      : 'transparent',
                }}
              />
            </g>
            <g className="caries-filling">
              ...
              <path
                ...
                d="M936.7,508.2c1.4-0.4,2.8-0.9,4.3-1.4l4.2-3.9c0.4-0.5,0.7-1,1-1.5c0.3-0.5,0.6-1.1,0.8-1.6
                                ...
                                c-2.9,5.1-7,12.6-7.7,15.5C928.1,455,933.8,490.4,936.7,508.2z"
                style={{
                  fill: tooth12Diagnozis.caries_right
                    ? '#606c80'
                    : tooth12Diagnozis.seal_right
                      ? tooth12Diagnozis.seal_right_color
                      : 'transparent',
                }}
              />
            </g>
            <g className="caries-filling hoho1">
              ...
              <path
                ...
                d="M877.6,442.4c4.5,3.7,12.7,10.6,14.3,13.1c1.7,2.6,9.2,40.1,12.5,57c1.3,0,2.6,0.1,3.9,0.1
                                ...
                                c-4.2-4.2-9.2-7.3-14.6-9.2c-6.8-2.3-14.1-2.5-20.5,1c-6.7,3.6-11,10.5-13.3,18C878.5,436.7,877.9,439.5,877.6,442.4z"
                style={{
                  fill: tooth12Diagnozis.caries_top
                    ? '#606c80'
                    : tooth12Diagnozis.seal_top
                      ? tooth12Diagnozis.seal_top_color
                      : 'transparent',
                }}
              />
            </g>
