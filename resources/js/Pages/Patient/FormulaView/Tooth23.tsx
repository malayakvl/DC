...
export default function Tooth23({ formulaToothData }) {
  ...
  return (
    <>
      <g
        id="23"
        className={`tooth-number-active ${!tooth23Diagnozis.show ? 'hide-number' : ''}`}
      >
        <text
      ...
      <g
        id="TH-23"
        className={`f-tooth-init ${tooth23Diagnozis.show && !tooth23Diagnozis.absent ? 'f-tooth-active' : ''} adult`}
      >
        <g
          className={`underlay`}
          style={{
        ...
        >
          ...
          <g
            ...
            style={{
              opacity: tooth23Diagnozis.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="caries-filling">
              ...
              <path
                ...
                d="M1237.7,498.4c-2.8-1.7-5.5-3.4-7.9-5.5c-3.4-3-6-6.7-7.7-10.8c-1.3-7.2-1.4-14.5-0.4-21.8
                                ...
                                C1245.5,440.6,1240.6,477.6,1237.7,498.4z"
                style={{
                  fill: tooth23Diagnozis.caries_left
                    ? '#606c80'
                    : tooth23Diagnozis.seal_left
                      ? tooth23Diagnozis.seal_left_color
                      : 'transparent',
                }}
              />
            </g>
            <g className="caries-filling">
              ...
              <path
                ...
                d="M1315.6,464.9c-1.1,4.9-2.6,9.8-4.7,14.4c-2.8,6.4-6.5,12.3-10.5,17.9c-3.4,4.8-7.5,9.5-11.3,14
                                c3.3-19.6,10.2-59.8,11.2-61.5c0.9-1.6,8.9-9.7,13.2-13.9c0.7,2.3,1.2,4.6,1.7,7C1316.6,450.1,1316.7,457.5,1315.6,464.9z"
                style={{
                  fill: tooth23Diagnozis.caries_right
                    ? '#606c80'
                    : tooth23Diagnozis.seal_right
                      ? tooth23Diagnozis.seal_right_color
                      : 'transparent',
                }}
              />
            </g>
            ...
            <g className="caries-filling">
              ...
              <path
                ...
                d="M1313.4,435.8c-4.3,4.3-12.3,12.3-13.2,13.9c-0.9,1.7-7.8,41.8-11.2,61.5c-0.6,0.7-1.2,1.4-1.7,2
                                ...
                                c3,5.3,4.8,11.2,6.6,17C1311,428.2,1312.3,432,1313.4,435.8z"
                style={{
                  fill: tooth23Diagnozis.caries_top
                    ? '#606c80'
                    : tooth23Diagnozis.seal_top
                      ? tooth23Diagnozis.seal_top_color
                      : 'transparent',
                }}
              />
            </g>
