...
export default function Tooth22({ formulaToothData }) {
  ...
  return (
    <>
      <g
        id="22"
        className={`tooth-number-active ${!tooth22Diagnozis.show ? 'hide-number' : ''}`}
      >
        <text
      ...
      <g
        id="TH-22"
        className={`f-tooth-init ${tooth22Diagnozis.show && !tooth22Diagnozis.absent ? 'f-tooth-active' : ''} adult`}
      >
        <g
          className={`underlay`}
          style={{
        ...
        >
          ...
          <g
            ...
            style={{
              opacity: tooth22Diagnozis.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="caries-filling">
              ...
              <path
                ...
                d="M1161.3,508.2c-1.4-0.4-2.8-0.9-4.3-1.4l-4.2-3.9c-0.4-0.5-0.7-1-1-1.5c-0.3-0.5-0.6-1.1-0.8-1.6
                                ...
                                c2.9,5.1,7,12.6,7.7,15.5C1170,455,1164.3,490.4,1161.3,508.2z"
                style={{
                  fill: tooth22Diagnozis.caries_left
                    ? '#606c80'
                    : tooth22Diagnozis.seal_left
                      ? tooth22Diagnozis.seal_left_color
                      : 'transparent',
                }}
              />
            </g>
            <g className="caries-filling">
              ...
              <path
                ...
                d="M1221,462c-0.2,10.2-0.3,20.5-3.6,30.2c-0.9,2.8-2.1,5.6-3.6,8.2c-1.3,2.9-3.1,5.4-5.3,7.5
                                ...
                                C1221.3,448.8,1221.1,455.4,1221,462z"
                style={{
                  fill: tooth22Diagnozis.caries_right
                    ? '#606c80'
                    : tooth22Diagnozis.seal_right
                      ? tooth22Diagnozis.seal_right_color
                      : 'transparent',
                }}
              />
            </g>
