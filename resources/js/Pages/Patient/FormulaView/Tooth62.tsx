...
export default function Tooth62({ formulaToothData }) {
  ...
  return (
    <>
      <g
        id="62"
        className={`tooth-number-active ${!tooth62Diagnozis.show ? 'hide-number' : ''}`}
      >
        <text transform="matrix(1 0 0 1 1170 716)" className={`st3 st4 st5`}>
          62
        </text>
      </g>
      <g
        id="TH-62"
        className={`f-tooth-init-milk ${tooth62Diagnozis.show && !tooth62Diagnozis.absent ? 'f-tooth-active' : ''} child`}
      >
        <g
          className={`underlay`}
          style={{
        ...
        >
          ...
          <g
            ...
            style={{
              opacity: tooth62Diagnozis.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
          ...
          >
            <path
              className={`st46 target temporary-crown crown-fill
            ...
            <g className="caries-filling">
              ...
              <path
                ...
                d="M1161.3,508.2c-1.4-0.4-2.8-0.9-4.3-1.4l-4.2-3.9c-0.4-0.5-0.7-1-1-1.5c-0.3-0.5-0.6-1.1-0.8-1.6
                                ...
                                c2.9,5.1,7,12.6,7.7,15.5C1170,455,1164.3,490.4,1161.3,508.2z"
                style={{
                  fill: tooth62Diagnozis.caries_left
                    ? '#606c80'
                    : tooth62Diagnozis.seal_left
                      ? tooth62Diagnozis.seal_left_color
                      : 'transparent',
                }}
              />
            </g>
            <g className="caries-filling">
              ...
              <path
                ...
                d="M1221,462c-0.2,10.2-0.3,20.5-3.6,30.2c-0.9,2.8-2.1,5.6-3.6,8.2c-1.3,2.9-3.1,5.4-5.3,7.5
                                ...
                                C1221.3,448.8,1221.1,455.4,1221,462z"
                style={{
                  fill: tooth62Diagnozis.caries_right
                    ? '#606c80'
                    : tooth62Diagnozis.seal_right
                      ? tooth62Diagnozis.seal_right_color
                      : 'transparent',
                }}
              />
            </g>
            <g className="caries-filling">
              ...
              <path
                ...
                d="M1220.5,442.4c-4.5,3.7-12.7,10.6-14.3,13.1c-1.7,2.6-9.2,40.1-12.6,57c-1.3,0-2.6,0.1-3.9,0.1
                                ...
                                C1219.6,436.7,1220.1,439.5,1220.5,442.4z"
                style={{
                  fill: tooth62Diagnozis.caries_top
                    ? '#606c80'
                    : tooth62Diagnozis.seal_top
                      ? tooth62Diagnozis.seal_top_color
                      : 'transparent',
                }}
              />
            </g>
