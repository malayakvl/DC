...
export default function Tooth16({ formulaToothData }) {
  ...
  return (
    <>
      <g
        id="16"
        className={`tooth-number-active ${!tooth16Diagnozis.show ? 'hide-number' : ''}`}
      >
        <text
      ...
      <g
        id="TH-16"
        className={`f-tooth-init ${tooth16Diagnozis.show && !tooth16Diagnozis.absent ? 'f-tooth-active' : ''} adult`}
      >
        <g
          className={`underlay`}
          style={{
        ...
        >
          ...
          <g
            ...
            style={{
              opacity: tooth16Diagnozis.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
