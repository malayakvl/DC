...
export default function Tooth11({ formulaToothData }) {
  ...
  return (
    <>
      <g
        id="11"
        className={`tooth-number-active ${!tooth11Diagnozis.show ? 'hide-number' : ''}`}
      >
      ...
      <g
        id="TH-11"
        className={`f-tooth-init-milk ${tooth11Diagnozis.show && !tooth11Diagnozis.absent ? 'f-tooth-active' : ''} adult`}
      >
        <g
          className={`underlay`}
          style={{
        ...
        >
          ...
          <g
            className="tartar"
            style={{
              opacity: tooth11Diagnozis.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="caries-filling">
              ...
              <path
                ...
                d="M950,501.4c0.5,3.6,1.1,7.1,2,10.6c1.7,3.4,4.1,6.3,7,8.7c2.3,1.9,4.8,3.4,7.6,4.4c3,0.3,5.9,0.5,8.9,0.8
                                c-1.6-17.3-5.9-62.7-6.5-65.6c-0.5-2.5-9.7-9.5-14.8-13.2c-1.6,6.6-2.7,13.4-3.6,20.2C949.2,478.7,948.6,490.1,950,501.4z"
                style={{
                  fill: tooth11Diagnozis.caries_left
                    ? '#606c80'
                    : tooth11Diagnozis.seal_left
                      ? tooth11Diagnozis.seal_left_color
                      : 'transparent',
                }}
              />
            </g>
            <g className="caries-filling">
              ...
              <path
                ...
                d="M1029,527.6c4.3,0,8.6-0.2,12.9-0.3l2.9-1.2c1-1.1,1.8-2.3,2.4-3.6c0.7-1.5,1.1-3.1,1.2-4.7
                                ...
                                C1026.8,458.9,1028.4,511.2,1029,527.6z"
                style={{
                  fill: tooth11Diagnozis.caries_right
                    ? '#606c80'
                    : tooth11Diagnozis.seal_right
                      ? tooth11Diagnozis.seal_right_color
                      : 'transparent',
                }}
              />
            </g>
            <g className="caries-filling">
              ...
              <path
                ...
                d="M954.2,447.1c5.1,3.7,14.3,10.7,14.8,13.2c0.6,2.9,4.9,48.3,6.5,65.6c7.5,0.6,15,1,22.6,1.3
                                ...
                                C957.6,434.9,955.7,441,954.2,447.1z"
                style={{
                  fill: tooth11Diagnozis.caries_top
                    ? '#606c80'
                    : tooth11Diagnozis.seal_top
                      ? tooth11Diagnozis.seal_top_color
                      : 'transparent',
                }}
              />
            </g>
