...
export default function Tooth15({ formulaToothData }) {
  ...
  return (
    <>
      <g
        id="15"
        className={`tooth-number-active ${!tooth15Diagnozis.show ? 'hide-number' : ''}`}
      >
        <text
      ...
      <g
        id="TH-15"
        className={`f-tooth-init ${tooth15Diagnozis.show && !tooth15Diagnozis.absent ? 'f-tooth-active' : ''} adult`}
      >
        <g
          className={`underlay`}
          style={{
        ...
        >
          ...
          <g
            className="tartar"
            style={{
              opacity: tooth15Diagnozis.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="caries-filling">
              ...
              <path
                ...
                d="M673.7,485c4.7-4.3,10-8,14.2-12.7c2.8-3.1,5-6.7,6.6-10.5c1.3-7,1.4-14.1,0.4-21.1
                                ...
                                C675,457.5,674.1,474.1,673.7,485z"
                style={{
                  fill: tooth15Diagnozis.caries_right
                    ? '#606c80'
                    : tooth15Diagnozis.seal_right
                      ? tooth15Diagnozis.seal_right_color
                      : 'transparent',
                }}
              />
            </g>
