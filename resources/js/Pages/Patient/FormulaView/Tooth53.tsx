...
export default function Tooth53({ formulaToothData }) {
  ...
  return (
    <>
      <g
        id="53"
        className={`tooth-number-active ${!tooth53Diagnozis.show ? 'hide-number' : ''}`}
      >
        <text transform="matrix(1 0 0 1 805 716)" className={`st3 st4 st5`}>
          53
        </text>
      </g>
      <g
        id="TH-53"
        className={`f-tooth-init-milk ${tooth53Diagnozis.show && !tooth53Diagnozis.absent ? 'f-tooth-active' : ''} child`}
      >
        <g
          className={`underlay`}
          style={{
        ...
        >
          ...
          <g
            ...
            style={{
              opacity: tooth53Diagnozis.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="caries-filling">
              ...
              <path
                ...
                d="M782.4,464.9c1,4.9,2.6,9.8,4.7,14.4c2.8,6.4,6.5,12.3,10.5,17.9c3.5,4.8,7.5,9.5,11.3,14
                                c-3.3-19.6-10.2-59.8-11.2-61.5c-0.9-1.6-8.9-9.7-13.2-13.9c-0.7,2.3-1.2,4.6-1.7,7C781.5,450,781.3,457.5,782.4,464.9z"
                style={{
                  fill: tooth53Diagnozis.caries_left
                    ? '#606c80'
                    : tooth53Diagnozis.seal_left
                      ? tooth53Diagnozis.seal_left_color
                      : 'transparent',
                }}
              />
            </g>
            <g className="caries-filling">
              ...
              <path
                ...
                d="M860.3,498.4c2.8-1.7,5.5-3.4,7.9-5.5c3.4-3,6-6.7,7.7-10.8c1.3-7.2,1.4-14.5,0.4-21.8
                                ...
                                C852.6,440.5,857.5,477.6,860.3,498.4z"
                style={{
                  fill: tooth53Diagnozis.caries_right
                    ? '#606c80'
                    : tooth53Diagnozis.seal_right
                      ? tooth53Diagnozis.seal_right_color
                      : 'transparent',
                }}
              />
            </g>
            ...
            <g className="caries-filling">
              ...
              <path
                ...
                d="M784.6,435.8c4.3,4.3,12.3,12.3,13.2,13.9c0.9,1.7,7.8,41.8,11.2,61.5c0.6,0.7,1.2,1.4,1.7,2
                                ...
                                c-11.8,0.7-22.1,7.9-27.9,18.2c-3,5.3-4.8,11.2-6.6,17C787,428.2,785.7,431.9,784.6,435.8z"
                style={{
                  fill: tooth53Diagnozis.caries_top
                    ? '#606c80'
                    : tooth53Diagnozis.seal_top
                      ? tooth53Diagnozis.seal_top_color
                      : 'transparent',
                }}
              />
            </g>
