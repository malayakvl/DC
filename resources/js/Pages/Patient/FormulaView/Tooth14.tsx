...
export default function Tooth14({ formulaToothData }) {
  ...
  return (
    <>
      <g
        id="14"
        className={`tooth-number-active ${!tooth14Diagnozis.show ? 'hide-number' : ''}`}
      >
        <text
      ...
      <g
        id="TH-14"
        className={`f-tooth-init ${tooth14Diagnozis.show && !tooth14Diagnozis.absent ? 'f-tooth-active' : ''} adult`}
      >
        <g
          className={`underlay`}
          style={{
        ...
        >
          ...
          <g
            style={{
              opacity: tooth14Diagnozis.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="caries-filling">
              ...
              <path
                ...
                d="M713.8,452.7c1.2,14.7,2.7,35.1,3.4,45.3c3.3,4.6,6.8,9.3,12.2,11.7c4.8,2.2,10.5,2,15.3-0.1
                                ...
                                C728.3,447.6,719.2,450.6,713.8,452.7z"
                style={{
                  fill: tooth14Diagnozis.caries_center
                    ? '#606c80'
                    : tooth14Diagnozis.seal_center
                      ? tooth14Diagnozis.seal_center_color
                      : 'transparent',
                }}
              />
            </g>
