...
export default function Tooth24({ formulaToothData }) {
  ...
  return (
    <>
      <g
        id="24"
        className={`tooth-number-active ${!tooth24Diagnozis.show ? 'hide-number' : ''}`}
      >
        <text
      ...
      <g
        id="TH-24"
        className={`f-tooth-init ${tooth24Diagnozis.show && !tooth24Diagnozis.absent ? 'f-tooth-active' : ''} adult`}
      >
        <g
          className={`underlay`}
          style={{
        ...
        >
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth24Diagnozis.tartar ? 1 : 0,
            }}
          >
            <path
              className="st61 level2"
            ...
            <g className="caries-filling">
              ...
              <path
                ...
                d="M1384.2,452.7c-1.2,14.7-2.7,35.1-3.4,45.3c-3.3,4.6-6.8,9.3-12.2,11.7c-4.8,2.2-10.5,2-15.3-0.1
                                ...
                                C1369.8,447.6,1378.9,450.6,1384.2,452.7z"
                style={{
                  fill: tooth24Diagnozis.caries_center
                    ? '#606c80'
                    : tooth24Diagnozis.seal_center
                      ? tooth24Diagnozis.seal_center_color
                      : 'transparent',
                }}
              />
            </g>
