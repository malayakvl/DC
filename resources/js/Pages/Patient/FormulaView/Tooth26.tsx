...
export default function Tooth26({ formulaToothData }) {
  ...
  return (
    <>
      <g
        id="26"
        className={`tooth-number-active ${!tooth26Diagnozis.show ? 'hide-number' : ''}`}
      >
        <text
      ...
      <g
        id="TH-26"
        className={`f-tooth-init ${tooth26Diagnozis.show && !tooth26Diagnozis.absent ? 'f-tooth-active' : ''} adult`}
      >
        <g
          className={`underlay`}
          style={{
        ...
        >
          ...
          <g
            ...
            style={{
              opacity: tooth26Diagnozis.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
