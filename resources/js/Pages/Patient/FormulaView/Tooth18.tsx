...
export default function Tooth18({ formulaToothData }) {
  ...
  return (
    <>
      <g
        id="18"
        className={`tooth-number-active ${!tooth18Diagnozis.show ? 'hide-number' : ''}`}
      >
        <text transform="matrix(1 0 0 1 247 717)" className={`st3 st4 st5`}>
          18
        </text>
      </g>
      <g
        id="TH-18"
        className={`f-tooth-init ${tooth18Diagnozis.show && !tooth18Diagnozis.absent ? 'f-tooth-active' : ''} adult`}
      >
        <g
          className={`underlay`}
          style={{
        ...
        >
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth18Diagnozis.tartar ? 1 : 0,
            }}
          >
            <path
