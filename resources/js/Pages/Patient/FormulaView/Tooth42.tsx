...
export default function Tooth42({ formulaToothData }) {
  ...
  return (
    <>
      <g
        id="42"
        className={`tooth-number-active ${!tooth42Diagnozis.show ? 'hide-number' : ''}`}
      >
        <text
      ...
      <g
        id="TH-42"
        className={`f-tooth-init ${tooth42Diagnozis.show && !tooth42Diagnozis.absent ? 'f-tooth-active' : ''} adult`}
      >
        <g
          className={`underlay`}
          style={{
        ...
        >
          ...
          <g
            style={{
              opacity: tooth42Diagnozis.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
