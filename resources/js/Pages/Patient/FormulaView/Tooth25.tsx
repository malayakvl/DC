...
export default function Tooth25({ formulaToothData }) {
  ...
  return (
    <>
      ...
      <g
        id="TH-25"
        className={`f-tooth-init ${tooth25Diagnozis.show && !tooth25Diagnozis.absent ? 'f-tooth-active' : ''} adult`}
      >
        <g
          className={`underlay`}
          style={{
        ...
        >
          ...
          <g
            ...
            style={{
              opacity: tooth25Diagnozis.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
          ...
          >
            ...
            <g className="caries-filling">
              ...
              <path
                ...
                d="M1468.9,429.6c-0.3,0.8-0.4,6.5-0.3,14.2c-5.1-2-14.7-5-24.4-4.1c-7.2,0.7-17,4.8-22.1,7.1
                                ...
                                c3-0.9,6.2-1.3,9.3-1.1c11.8,0.6,22.2,7.6,27.9,17.7c2.4,4.2,3.8,8.9,5.5,13.4C1475.6,418.5,1469.7,427.6,1468.9,429.6z"
                style={{
                  fill: tooth25Diagnozis.caries_bottom
                    ? '#606c80'
                    : tooth25Diagnozis.seal_bottom
                      ? tooth25Diagnozis.seal_bottom_color
                      : 'transparent',
                }}
              />
            </g>
            ...
            <g className="caries-filling">
              <path
                ...
                style={{
                  fill: tooth25Diagnozis.caries_right
                    ? '#606c80'
                    : tooth25Diagnozis.seal_right
                      ? tooth25Diagnozis.seal_right_color
                      : 'transparent',
                }}
              />
              <path
