...
export default function Tooth45() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth45.caries_bottom =
          !teethDiagnozis.tooth45.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth45.caries_center =
          !teethDiagnozis.tooth45.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth45.caries_left =
          !teethDiagnozis.tooth45.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth45.caries_right =
          !teethDiagnozis.tooth45.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth45.seal_center =
            !teethDiagnozis.tooth45.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth45.seal_bottom =
            !teethDiagnozis.tooth45.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth45.seal_right =
            !teethDiagnozis.tooth45.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth45.wedge_shaped_defect_color =
          !teethDiagnozis.tooth45.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 659 842)"
          className={`st3 st4 st5 ${selectedTooth === 45 ? 'num-active' : ''}`}
        >
          45
        </text>
      </g>
      <g
        id="TH-45"
        className={`f-tooth-init ${(teethDiagnozis.tooth45.show || allTeeth) && !teethDiagnozis.tooth45.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 45 ? 'selected' : ''}`}
          onMouseOver={() => {
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth45Diagnozis.change_color ? 'diagnoze' : ''}`}
            ...
            <g
              style={{
                visibility:
                  tooth45Diagnozis?.apex || tooth45Diagnozis.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
          ...
          <g
            style={{
              visibility:
                tooth45Diagnozis.implant || tooth45Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth45Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
            ...
            <circle
              ...
              cy="979"
              r="12.25"
              style={{ fill: 'black', opacity: tooth45Diagnozis.pin ? 1 : 0 }}
            />
          </g>
          <g
            className="stump"
            style={{
              visibility: !tooth45Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth45Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            style={{
              opacity: teethDiagnozis.tooth45.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="with down">
              ...
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth45Diagnozis.seal_left &&
                      !tooth45Diagnozis.seal_bottom &&
                      !tooth45Diagnozis.seal_center) ||
                    (tooth45Diagnozis.seal_left &&
                      !tooth45Diagnozis.seal_bottom) ||
                    (tooth45Diagnozis.seal_bottom &&
                      tooth45Diagnozis.seal_center &&
          ...
          <g style={{ visibility: 'inherit' }}>
            ...
            >
              <path
                className="st55"
                d="M731.603 1001.6C730.703 1003.9 729.403 1006.2 727.703 1008.2C725.903 1010.6 723.603 1012.7 721.003 1014.6C716.803 1017.7 711.703 1020 707.203 1022.5C701.903 1025.4 696.903 1028.6 690.703 1029.8C679.303 1032 668.303 1027 659.403 1020.5C654.103 1016.6 649.303 1012.1 645.503 1007C644.803 1006.1 644.203 1005.1 643.503 1004.1C639.88 998.288 637.738 991.792 637.464 985C640.684 985.5 647.372 987.3 648.364 990.5C649.189 993.224 650.403 995.84 651.959 998.301C652.519 999.09 652.999 999.88 653.559 1000.59C656.6 1004.61 660.441 1008.17 664.682 1011.24C671.804 1016.37 680.607 1020.32 689.73 1018.58C694.691 1017.64 698.692 1015.11 702.933 1012.82C706.535 1010.85 710.616 1009.03 713.977 1006.59C716.057 1005.09 717.898 1003.43 719.338 1001.54C720.699 999.959 721.739 998.143 722.459 996.328C723.048 994.914 723.457 993.468 723.719 992C725.412 988 730.973 987.181 733.542 987.272C733.893 992.169 733.484 997.018 731.603 1001.6Z"
              ></path>
            </g>
          </g>
          ...
          <g
            ...
            style={{
              visibility:
                tooth45Diagnozis.temporary_crown ||
                tooth45Diagnozis.ceramic_crown ||
                tooth45Diagnozis.mceramic_crown ||
                tooth45Diagnozis.metalic_crown ||
                tooth45Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth45Diagnozis.temporary_crown ||
          ...
          >
            ...
            />
            <path
              className={`st3 fissure ${tooth45Diagnozis.fissure ? 'diagnoze' : tooth45Diagnozis.fissure ? 'hidden' : ''}`}
          ...
          >
            <path
              className={`st3 fissure ${tooth45Diagnozis.fissure ? 'diagnoze' : ''}`}
              d="M667,980l-1-0.3c0.6-1.9,1.3-3.8,2-5.6c0.6-1.4,1.2-2.9,2.6-3.8c1.8-1.2,3.7-0.8,5.7-0.5
                            c0.9,0.1,1.9,0.3,2.7,0.3c2.1,0,4-1,6-2c1.1-0.5,2.2-1.1,3.4-1.5c2.4-0.8,4.7-0.9,6.7-0.1c2.2,0.8,4,2.5,5.7,5.4
                            c1.3,2.2,2.3,4.6,3,7.1l-1,0.3c-0.6-2.4-1.6-4.7-2.9-6.8c-1.6-2.7-3.2-4.2-5.1-5c-2.2-0.8-4.5-0.4-6,0.1
                            c-1.1,0.4-2.2,0.9-3.3,1.5c-2,1-4.1,2-6.4,2.1c-1,0-2-0.1-2.9-0.3c-1.8-0.3-3.5-0.5-4.9,0.4c-1.1,0.7-1.6,1.9-2.2,3.3
        ...
        >
          ...
          >
            <path
              className="st14"
              d="M655.4,1277.4L655.4,1277.4c1.4,0.1,2.6-0.8,3.1-2.1l24.4-71.3c-0.4,0-0.8,0.1-1.1,0.1
                            c-5.4,0.5-10.9,0-16-2c-0.6-0.2-1.2-0.5-1.7-0.7c0,0,0,0,0,0l-11.5,72.4C652.2,1275.7,653.6,1277.3,655.4,1277.4z"
            />
            <path
              className="st15"
              d="M642.9,1163.8c0.4,4.8,0.7,9.6,0.9,14.3c1.5,3.9,3.5,7.7,5.9,11.2c3.7,5.2,8.5,9.5,14.3,12.1
          ...
          >
            <path
              className="st16"
              d="M711.3,1189.2l-24.4,31.9l-31.8-7.1l-11.3-35.9c1.5,3.9,3.5,7.7,5.9,11.2c3.8,5.3,8.7,9.7,14.6,12.3
                            c8.3,3.6,17.6,3.5,26.2,0.7C698.5,1199.8,705.5,1195.1,711.3,1189.2z"
            />
            <path
              className="st17"
              d="M717.1,1157.8c0,5-0.2,10.1-0.6,15.1c-1.8,5.4-3.5,10.9-5.2,16.3c-5.8,5.9-12.8,10.5-20.7,13.1
          ...
          <g className="shaper" style={{ visibility: 'hidden', opacity: 0 }}>
            <path
              className="st44"
              d="M654.777 1173.81C654.88 1171.38 657.112 1169.61 659.505 1170.05L697.51 1177.13C699.902 1177.57 701.346 1180.03 700.569 1182.34L687.855 1220.06C687.217 1221.96 685.28 1223.09 683.317 1222.72L656.339 1217.58C654.389 1217.21 653.006 1215.47 653.09 1213.48L654.777 1173.81Z"
            ></path>
          </g>
          {/* IMPLANT/CULTTAB */}
          <g
          ...
          >
            <path
              className="st18"
              d="M649.1,1213c0,0-5.5,32.2-7.1,40.3s-6.8,45.5-7.6,51.8c-0.8,6.3-4.1,38.3-4.1,38.9s6,9.5,16.1,8.4
          ...
          <g
            ...
            style={{
              visibility:
                !tooth45Diagnozis.culttab && !tooth45Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            />
            <path
              className={`st7 ${tooth45Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
