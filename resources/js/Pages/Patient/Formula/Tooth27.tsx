...
export default function Tooth27() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth27.caries_bottom =
          !teethDiagnozis.tooth27.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth27.caries_center =
          !teethDiagnozis.tooth27.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth27.caries_left =
          !teethDiagnozis.tooth27.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth27.caries_right =
          !teethDiagnozis.tooth27.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth27.seal_center =
            !teethDiagnozis.tooth27.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth27.seal_bottom =
            !teethDiagnozis.tooth27.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth27.seal_right =
            !teethDiagnozis.tooth27.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth27.wedge_shaped_defect_color =
          !teethDiagnozis.tooth27.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 1690.5684 716.1968)"
          className={`st3 st4 st5 ${selectedTooth === 27 ? 'num-active' : ''}`}
        >
          27
        </text>
      </g>
      <g
        id="TH-27"
        className={`f-tooth-init ${(teethDiagnozis.tooth27.show || allTeeth) && !teethDiagnozis.tooth27.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 27 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth27Diagnozis.change_color ? 'diagnoze' : ''}`}
            ...
            <g
              style={{
                visibility:
                  tooth27Diagnozis?.apex || tooth27Diagnozis.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st24 change-color ${tooth27Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth27Diagnozis?.apex ? 'apex' : ''}`}
              ...
              />
              <path
                className={`st53 change-color ${tooth27Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth27Diagnozis?.apex ? 'apex' : ''}`}
          ...
          <g
            className="pulp"
            style={{ visibility: tooth27Diagnozis.apex ? 'inherit' : 'hidden' }}
          >
            <g
              className="pulpitis-pfilling"
              style={{
                visibility: tooth27Diagnozis?.apex ? 'inherit' : 'hidden',
              }}
            >
              <ellipse
          ...
          <g
            ...
            style={{
              visibility:
                tooth27Diagnozis.implant || tooth27Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            ...
            style={{
              visibility: tooth27Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth27Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth27Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
            ...
            <circle
              ...
              r="12.25"
              transform="matrix(-1 0 0 1 1706.02 598)"
              style={{ fill: 'black', opacity: tooth27Diagnozis.pin ? 1 : 0 }}
            />
          </g>
          {/* CULTTAB */}
          <g
            ...
            style={{
              visibility: !tooth27Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth27Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              opacity: teethDiagnozis.tooth27.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="with">
              ...
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth27Diagnozis.seal_right &&
                      !tooth27Diagnozis.seal_top) ||
          ...
          <g
            ...
            style={{
              visibility:
                tooth27Diagnozis.temporary_crown ||
                tooth27Diagnozis.ceramic_crown ||
                tooth27Diagnozis.mceramic_crown ||
                tooth27Diagnozis.metalic_crown ||
                tooth27Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth27Diagnozis.temporary_crown ||
          ...
          >
            ...
            {/*FISSURE*/}
            <path
              className={`st3 fissure ${tooth27Diagnozis.fissure ? 'diagnoze' : ''}`}
        ...
        >
          ...
          <g
            ...
            style={{
              visibility:
                !tooth27Diagnozis.culttab && !tooth27Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            ></path>
            <path
              className={`st7 ${tooth27Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
