...
export default function Tooth23() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth23.caries_bottom =
          !teethDiagnozis.tooth23.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth23.caries_center =
          !teethDiagnozis.tooth23.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth23.caries_left =
          !teethDiagnozis.tooth23.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth23.caries_right =
          !teethDiagnozis.tooth23.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth23.seal_center =
            !teethDiagnozis.tooth23.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth23.seal_bottom =
            !teethDiagnozis.tooth23.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth23.seal_right =
            !teethDiagnozis.tooth23.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth23.wedge_shaped_defect_color =
          !teethDiagnozis.tooth23.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 1250.251 716.1968)"
          className={`st3 st4 st5 ${selectedTooth === 23 ? 'num-active' : ''}`}
        >
          23
        </text>
      </g>
      <g
        id="TH-23"
        className={`f-tooth-init ${(teethDiagnozis.tooth23.show || allTeeth) && !teethDiagnozis.tooth23.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 23 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          ...
          <g className="dentin">
            <g
              ...
              style={{
                visibility:
                  !tooth23Diagnozis.culttab &&
                  !tooth23Diagnozis.implant &&
                  !tooth23Diagnozis.shaper
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st24 ${tooth23Diagnozis.apex ? 'apex' : ''}`}
            ...
            <g
              ...
              style={{
                visibility:
                  tooth23Diagnozis?.apex || tooth23Diagnozis.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st24 change-color ${tooth23Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth23Diagnozis?.apex ? 'apex' : ''}`}
          ...
          <g
            className="pulp"
            style={{ visibility: tooth23Diagnozis.apex ? 'inherit' : 'hidden' }}
          >
            <g
              className="pulpitis-pfilling"
              style={{
                visibility: tooth23Diagnozis?.apex ? 'inherit' : 'hidden',
              }}
            >
              <path
          ...
          <g
            ...
            style={{
              visibility:
                tooth23Diagnozis.implant || tooth23Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            ...
            style={{
              visibility: tooth23Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth23Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth23Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
            ...
            <circle
              ...
              r="12.25"
              transform="matrix(-1 0 0 1 1269.15 596)"
              style={{ fill: 'black', opacity: tooth23Diagnozis.pin ? 1 : 0 }}
            />
          </g>
          {/* CULTTAB */}
          <g
            ...
            style={{
              visibility: !tooth23Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth23Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility:
                !tooth23Diagnozis.culttab &&
                !tooth23Diagnozis.abutment &&
                !tooth23Diagnozis.implant &&
                !tooth23Diagnozis.apex &&
                !tooth23Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          ...
          <g
            ...
            style={{
              opacity: teethDiagnozis.tooth23.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="with">
              ...
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth23Diagnozis.seal_right &&
                      !tooth23Diagnozis.seal_bottom &&
                      !tooth23Diagnozis.seal_center) ||
                    (tooth23Diagnozis.seal_bottom &&
                      !tooth23Diagnozis.seal_center &&
                      !tooth23Diagnozis.seal_left &&
                      !tooth23Diagnozis.seal_right &&
                      tooth23Diagnozis.seal_top) ||
                    (!tooth23Diagnozis.seal_right &&
                      !tooth23Diagnozis.seal_top &&
                      !tooth23Diagnozis.seal_center &&
                      tooth23Diagnozis.seal_bottom)
          ...
          <g
            ...
            style={{
              visibility:
                tooth23Diagnozis.temporary_crown ||
                tooth23Diagnozis.ceramic_crown ||
                tooth23Diagnozis.mceramic_crown ||
                tooth23Diagnozis.metalic_crown ||
                tooth23Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth23Diagnozis.temporary_crown ||
          ...
          >
            ...
            {/*FISSURE*/}
            <path
              className={`st3 fissure ${tooth23Diagnozis.fissure ? 'diagnoze' : tooth23Diagnozis.fissure ? 'hidden' : ''}`}
          ...
          {/* FISSURES */}
          <g
            className={`st3 fissure ${tooth23Diagnozis.fissure ? 'diagnoze' : ''}`}
            style={{
              visibility:
                !tooth23Diagnozis.culttab &&
                !tooth23Diagnozis.abutment &&
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                id="dentin_v_23"
                className={`st10 change-color ${tooth23Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g className="pulp">
            <g>
              <path
                className={`st22 target top ${tooth23Diagnozis.channel_class} ${tooth23Diagnozis.channel_class} ${tooth23Diagnozis.pulpit ? 'pulpit' : ''} ${tooth23Diagnozis.periodontit ? 'periodontit' : ''}`}
            ...
            <g>
              <path
                className={`st22 target part ${tooth23Diagnozis.channel_class} ${tooth23Diagnozis.channel_class} ${tooth23Diagnozis.pulpit ? 'pulpit' : ''} ${tooth23Diagnozis.periodontit ? 'periodontit' : ''} top-sealed-part`}
          ...
          <g
            ...
            style={{
              visibility:
                !tooth23Diagnozis.culttab && !tooth23Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            ></path>
            <path
              className={`st7 ${tooth23Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
            ...
            >
              ...
              <path
                ...
                d="M1237.7,498.4c-2.8-1.7-5.5-3.4-7.9-5.5c-3.4-3-6-6.7-7.7-10.8c-1.3-7.2-1.4-14.5-0.4-21.8
                                ...
                                C1245.5,440.6,1240.6,477.6,1237.7,498.4z"
                style={{
                  fill: teethDiagnozis.tooth23.caries_left
                    ? '#606c80'
                    : teethDiagnozis.tooth23.seal_left
                      ? teethDiagnozis.tooth23.seal_left_color
                      : 'transparent',
                }}
              />
            </g>
            ...
            >
              ...
              <path
                ...
                d="M1315.6,464.9c-1.1,4.9-2.6,9.8-4.7,14.4c-2.8,6.4-6.5,12.3-10.5,17.9c-3.4,4.8-7.5,9.5-11.3,14
                                c3.3-19.6,10.2-59.8,11.2-61.5c0.9-1.6,8.9-9.7,13.2-13.9c0.7,2.3,1.2,4.6,1.7,7C1316.6,450.1,1316.7,457.5,1315.6,464.9z"
                style={{
                  fill: teethDiagnozis.tooth23.caries_right
                    ? '#606c80'
                    : teethDiagnozis.tooth23.seal_right
                      ? teethDiagnozis.tooth23.seal_right_color
                      : 'transparent',
                }}
              />
            </g>
            ...
            >
              ...
              <path
                ...
                d="M1313.4,435.8c-4.3,4.3-12.3,12.3-13.2,13.9c-0.9,1.7-7.8,41.8-11.2,61.5c-0.6,0.7-1.2,1.4-1.7,2
                                ...
                                c3,5.3,4.8,11.2,6.6,17C1311,428.2,1312.3,432,1313.4,435.8z"
                style={{
                  fill: teethDiagnozis.tooth23.caries_top
                    ? '#606c80'
                    : teethDiagnozis.tooth23.seal_top
                      ? teethDiagnozis.tooth23.seal_top_color
                      : 'transparent',
                }}
              />
            </g>
          ...
          >
            ...
            >
              <path
                className={`vinir-fill ${tooth23Diagnozis.vinir_color}`}
