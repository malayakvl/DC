...
export default function Tooth12() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth12.caries_bottom =
          !teethDiagnozis.tooth12.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth12.caries_center =
          !teethDiagnozis.tooth12.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth12.caries_left =
          !teethDiagnozis.tooth12.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth12.caries_right =
          !teethDiagnozis.tooth12.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth12.seal_center =
            !teethDiagnozis.tooth12.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth12.seal_bottom =
            !teethDiagnozis.tooth12.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth12.seal_right =
            !teethDiagnozis.tooth12.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth12.wedge_shaped_defect_color =
          !teethDiagnozis.tooth12.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 889.209 716.1968)"
          className={`st3 st4 st5 ${selectedTooth === 12 ? 'num-active' : ''}`}
        >
          12
        </text>
      </g>
      <g
        id="TH-12"
        className={`f-tooth-init ${(teethDiagnozis.tooth12.show || allTeeth) && !teethDiagnozis.tooth12.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 12 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          ...
          <g className="dentin">
            ...
            <g
              style={{
                visibility:
                  tooth12Diagnozis?.apex || tooth12Diagnozis.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st24 change-color ${tooth12Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth12Diagnozis?.apex ? 'apex' : ''}`}
          ...
          <g
            className="pulp"
            style={{ visibility: tooth12Diagnozis.apex ? 'inherit' : 'hidden' }}
          >
            <g
              className="pulpitis-pfilling"
              style={{
                visibility: tooth12Diagnozis?.apex ? 'inherit' : 'hidden',
              }}
            >
              <path
                className="st22 target"
                d="M908.171 597.772C908.171 598.17 907.749 599.199 909.763 601.356C911.265 602.729 911.78 605.151 913.701 605.189C915.77 605.229 916.34 603.039 917.679 601.58C919.285 599.829 919.512 598.545 919.319 597.772C918.921 596.179 917.824 596.15 913.701 596.125C909.578 596.1 908.171 597.374 908.171 597.772Z"
                style={{ fill: '#e80808' }}
              ></path>
            </g>
          </g>
          ...
          <g
            ...
            style={{
              visibility:
                tooth12Diagnozis.implant || tooth12Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            className="abutment"
            style={{
              visibility: tooth12Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth12Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
              d="M882.489 594.821C880.282 588.167 885.858 582.381 892.945 580.211C898.987 578.331 905.841 
            ...
            <path
              className="st47"
              d="M891.349 597.015C889.773 592.262 893.756 588.129 898.818 586.58C903.133 585.237 908.029 585.237 912.926 585.133C917.822 585.03 922.718 584.72 
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth12Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
              className="st56"
            ...
            <circle
              ...
              cy="600"
              r="12.25"
              style={{ fill: 'black', opacity: tooth12Diagnozis.pin ? 1 : 0 }}
            />
          </g>
          {/* CULTTAB */}
          <g
          ...
          <g
            ...
            style={{
              opacity: teethDiagnozis.tooth12.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="with">
              ...
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth12Diagnozis.seal_left &&
                      !tooth12Diagnozis.seal_bottom &&
                      !tooth12Diagnozis.seal_center) ||
                    (tooth12Diagnozis.seal_left &&
                      !tooth12Diagnozis.seal_bottom &&
                      !tooth12Diagnozis.seal_center) ||
                    (!tooth12Diagnozis.seal_left &&
          ...
          >
            ...
            >
              <path
                className="st55"
                d="M884.611 581.577C886.411 580.377 888.511 579.377 890.811 578.777C897.611 576.877 905.311 
          ...
          <g
            ...
            style={{
              visibility:
                tooth12Diagnozis.temporary_crown ||
                tooth12Diagnozis.ceramic_crown ||
                tooth12Diagnozis.mceramic_crown ||
                tooth12Diagnozis.metalic_crown ||
                tooth12Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth12Diagnozis.temporary_crown ||
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                id="dentin_v_12"
                className={`st10 change-color ${tooth12Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          >
            <path
              className="st56"
              d="M879 437.1C879.8 444.5 881.001 451.8 882.701 459C885.201 469.3 888.701 479.4 
            ...
            <path
              className="st57"
              d="M892.6 330.5L905.2 490.6L926.4 487.7L912.9 415L912.8 414.6L904.5 370L903.2 362.9L897.1 330.1C896.9 329 
          ...
          >
            <path
              className="st30"
              d="M935.1,433c-2-3.2-4.3-6.1-6.9-8.7c-4.2-4.1-9.2-7.3-14.6-9.2c-6.8-2.3-14.1-2.5-20.5,1
                            c-5.8,3.1-11.7,14.6-14.1,20.8l10.9-37.1l25.9-2.4L935.1,433z"
            />
            <path
              className="st17"
              d="M938.6,483.3l-1.7,2.4l-2.1,1l-38.5,5.2l-1.9-1.4l-1.1-1.5c-4.5-9.7-8-19.8-10.5-30.1
          ...
          <g className="shaper" style={{ visibility: 'hidden', opacity: 0 }}>
            <path
              className="st44"
              d="M928.473 437.859C929.031 440.197 927.416 442.496 925.027 442.763L892.999 446.344C890.611 446.611 888.528 444.726 888.555 442.324L888.999 402.614C889.022 400.587 890.558 398.898 892.573 398.682L914.959 396.284C916.96 396.07 918.808 397.375 919.275 399.333L928.473 437.859Z"
            ></path>
          </g>
          {/* IMPLANT/CULTTAB */}
          <g
          ...
          >
            <path
              className="st18"
              d="M923.1,398.9l-37.9,3.6c-1.8-20.1-3.1-40.2-3.9-60.3c-0.8-19.5-1.2-39-1.1-58.5c2.7-3.8,6.8-6.3,11.4-6.7
          ...
          <g
            ...
            style={{
              visibility:
                !tooth12Diagnozis.culttab && !tooth12Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            <path
              className="st7 st59"
              d="M879.522 433.9C878.622 436.7 878.122 439.5 877.722 442.4C876.922 448.8 877.122 455.4 877.322 461.8L877.323 461.82C877.523 
            ...
            />
            <path
              className={`st7 ${tooth12Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
            ...
            >
              ...
              <path
                ...
                d="M877,462c0.2,10.2,0.3,20.5,3.6,30.2c0.9,2.8,2.1,5.6,3.6,8.2c1.3,2.9,3.1,5.4,5.3,7.5
                                ...
                                C876.7,448.8,876.9,455.4,877,462z"
                style={{
                  fill: teethDiagnozis.tooth12.caries_left
                    ? '#606c80'
                    : teethDiagnozis.tooth12.seal_left
                      ? teethDiagnozis.tooth12.seal_left_color
                      : 'transparent',
                }}
              />
            </g>
            ...
            >
              ...
              <path
                ...
                d="M936.7,508.2c1.4-0.4,2.8-0.9,4.3-1.4l4.2-3.9c0.4-0.5,0.7-1,1-1.5c0.3-0.5,0.6-1.1,0.8-1.6
                                ...
                                c-2.9,5.1-7,12.6-7.7,15.5C928.1,455,933.8,490.4,936.7,508.2z"
                style={{
                  fill: teethDiagnozis.tooth12.caries_right
                    ? '#606c80'
                    : teethDiagnozis.tooth12.seal_right
                      ? teethDiagnozis.tooth12.seal_right_color
                      : 'transparent',
                }}
              />
            </g>
            ...
            >
              ...
              <path
                ...
                d="M877.6,442.4c4.5,3.7,12.7,10.6,14.3,13.1c1.7,2.6,9.2,40.1,12.5,57c1.3,0,2.6,0.1,3.9,0.1
                                ...
                                c-4.2-4.2-9.2-7.3-14.6-9.2c-6.8-2.3-14.1-2.5-20.5,1c-6.7,3.6-11,10.5-13.3,18C878.5,436.7,877.9,439.5,877.6,442.4z"
                style={{
                  fill: teethDiagnozis.tooth12.caries_top
                    ? '#606c80'
                    : teethDiagnozis.tooth12.seal_top
                      ? teethDiagnozis.tooth12.seal_top_color
                      : 'transparent',
                }}
              />
            </g>
