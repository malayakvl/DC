...
export default function Tooth71() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth71.caries_bottom =
          !teethDiagnozis.tooth71.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth71.caries_center =
          !teethDiagnozis.tooth71.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth71.caries_left =
          !teethDiagnozis.tooth71.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth71.caries_right =
          !teethDiagnozis.tooth71.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth71.seal_center =
            !teethDiagnozis.tooth71.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth71.seal_bottom =
            !teethDiagnozis.tooth71.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth71.seal_right =
            !teethDiagnozis.tooth71.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth71.wedge_shaped_defect_color =
          !teethDiagnozis.tooth71.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  const showHideOverlay = type => {
    if (type === 'over') {
      if (
        teethType === 'child' &&
        !teethDiagnozis.tooth71.show &&
        !teethDiagnozis.tooth31.show
      ) {
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 1060 842)"
          className={`st3 st4 st5 ${selectedTooth === 71 ? 'num-active' : ''}`}
        >
          71
        </text>
      </g>
      <g
        id="TH-71"
        className={`f-tooth-init-milk ${(teethDiagnozis.tooth71.show || allTeeth) && !teethDiagnozis.tooth71.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 71 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        <g
          ...
          style={{
            visibility: 'inherit',
            transform: 'matrix(0.55, 0, 0, 0.55, 15, -7)',
          }}
          onMouseOver={() => {
        ...
        >
          <g className="dentin">
            <g
              style={{
                visibility:
                  !tooth71Diagnozis.culttab &&
                  !tooth71Diagnozis.implant &&
                  !tooth71Diagnozis.shaper
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st6 change-color ${tooth71Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth71Diagnozis?.apex ? 'apex' : ''}`}
            ...
            <g
              style={{
                visibility:
                  tooth71Diagnozis?.apex || tooth71Diagnozis.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
          ...
          <g
            className="pulp"
            style={{ visibility: tooth71Diagnozis.apex ? 'inherit' : 'hidden' }}
          >
            <g>
              <path
          ...
          <g
            ...
            style={{
              visibility:
                tooth71Diagnozis.implant || tooth71Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            ...
            style={{
              visibility: tooth71Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth71Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth71Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
            ...
            <circle
              ...
              r="12.25"
              transform="matrix(-1 0 0 1 1085.13 983)"
              style={{ fill: 'black', opacity: tooth71Diagnozis.pin ? 1 : 0 }}
            ></circle>
          </g>
          {/* CULTTAB */}
          <g
            ...
            style={{
              visibility: !tooth71Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth71Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility:
                !tooth71Diagnozis.culttab &&
                !tooth71Diagnozis.abutment &&
                !tooth71Diagnozis.implant &&
                !tooth71Diagnozis.apex &&
                !tooth71Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          ...
          <g
            className="tartar"
            style={{
              opacity: teethDiagnozis.tooth71.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="with">
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth71Diagnozis.seal_right &&
                      !tooth71Diagnozis.seal_center) ||
                    (!tooth71Diagnozis.seal_right &&
                      tooth71Diagnozis.seal_center)
                      ? 5
                      : 0,
          ...
          >
            ...
            >
              <path
                className={`vinir-fill ${tooth71Diagnozis.vinir_color}`}
          ...
          <g
            ...
            style={{
              visibility:
                tooth71Diagnozis.temporary_crown ||
                tooth71Diagnozis.ceramic_crown ||
                tooth71Diagnozis.mceramic_crown ||
                tooth71Diagnozis.metalic_crown ||
                tooth71Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth71Diagnozis.temporary_crown ||
        ...
        <g
          ...
          style={{
            visibility: 'inherit',
            transform: 'matrix(0.55, 0, 0, 0.55, 15, -20)',
          }}
          onMouseOver={() => {
            showHideTopCommonView('over');
          }}
        ...
        >
          <g className="dentin">
            ...
            >
              <path
                className={`st10 change-color ${tooth71Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g className="pulp">
            <g>
              <path
                className={`st22 target top ${tooth71Diagnozis.channel_class} ${tooth71Diagnozis.channel_class} ${tooth71Diagnozis.pulpit ? 'pulpit' : ''} ${tooth71Diagnozis.periodontit ? 'periodontit' : ''}`}
          ...
          >
            ...
            <path
              className="st57"
              style={{ fill: tooth71Diagnozis.pin ? '#dbd9d3' : 'none' }}
          ...
          <g
            ...
            style={{
              visibility:
                !tooth71Diagnozis.culttab && !tooth71Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            ></path>
            <path
              className={`st7 ${tooth71Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
