...
export default function Tooth17() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth17.caries_bottom =
          !teethDiagnozis.tooth17.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth17.caries_center =
          !teethDiagnozis.tooth17.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth17.caries_left =
          !teethDiagnozis.tooth17.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth17.caries_right =
          !teethDiagnozis.tooth17.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth17.seal_center =
            !teethDiagnozis.tooth17.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth17.seal_bottom =
            !teethDiagnozis.tooth17.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth17.seal_right =
            !teethDiagnozis.tooth17.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth17.wedge_shaped_defect_color =
          !teethDiagnozis.tooth17.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 366.4678 716.1968)"
          className={`st3 st4 st5 ${selectedTooth === 17 ? 'num-active' : ''}`}
        >
          17
        </text>
      </g>
      <g
        id="TH-17"
        className={`f-tooth-init ${(teethDiagnozis.tooth17.show || allTeeth) && !teethDiagnozis.tooth17.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 17 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth17Diagnozis.apex ? 'apex' : ''}`}
            ...
            <g
              style={{
                visibility:
                  tooth17Diagnozis?.apex || tooth17Diagnozis.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st24 change-color ${tooth17Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth17Diagnozis?.apex ? 'apex' : ''}`}
              ...
              />
              <path
                className={`st53 change-color ${tooth17Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth17Diagnozis?.apex ? 'apex' : ''}`}
          ...
          <g
            className="pulp"
            style={{ visibility: tooth17Diagnozis.apex ? 'inherit' : 'hidden' }}
          >
            <g
              className="pulpitis-pfilling"
              style={{
                visibility: tooth17Diagnozis?.apex ? 'inherit' : 'hidden',
              }}
            >
              <ellipse
          ...
          <g
            ...
            style={{
              visibility:
                tooth17Diagnozis.implant || tooth17Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            ...
            style={{
              visibility: tooth17Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth17Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth17Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
            ...
            <circle
              ...
              cy="598"
              r="12.25"
              style={{ fill: 'black', opacity: tooth17Diagnozis.pin ? 1 : 0 }}
            />
          </g>
          {/* CULTTAB */}
          <g
            ...
            style={{
              visibility: !tooth17Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth17Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              opacity: teethDiagnozis.tooth17.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="with">
              ...
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth17Diagnozis.seal_left &&
                      !tooth17Diagnozis.seal_top) ||
          ...
          <g
            ...
            style={{
              visibility:
                tooth17Diagnozis.temporary_crown ||
                tooth17Diagnozis.ceramic_crown ||
                tooth17Diagnozis.mceramic_crown ||
                tooth17Diagnozis.metalic_crown ||
                tooth17Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth17Diagnozis.temporary_crown ||
          ...
          >
            ...
            {/*FISSURE*/}
            <path
              className={`st3 fissure ${tooth17Diagnozis.fissure ? 'diagnoze' : ''}`}
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                id="dentin_v_17"
                className={`st9 change-color ${tooth17Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g
            ...
            style={{
              visibility:
                !tooth17Diagnozis.culttab && !tooth17Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            />
            <path
              className={`st7 ${tooth17Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
