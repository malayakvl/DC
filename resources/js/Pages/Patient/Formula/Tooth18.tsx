...
export default function Tooth18() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth18.caries_bottom =
          !teethDiagnozis.tooth18.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth18.caries_center =
          !teethDiagnozis.tooth18.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth18.caries_left =
          !teethDiagnozis.tooth18.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth18.caries_right =
          !teethDiagnozis.tooth18.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth18.seal_center =
            !teethDiagnozis.tooth18.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth18.seal_bottom =
            !teethDiagnozis.tooth18.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth18.seal_right =
            !teethDiagnozis.tooth18.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth18.wedge_shaped_defect_color =
          !teethDiagnozis.tooth18.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
    ...
    <>
      ...
      >
        <text
          ...
          className={`st3 st4 st5 ${selectedTooth === 18 ? 'num-active' : ''}`}
        >
          18
        </text>
      </g>
      ...
      >
        <g
          className={`underlay ${selectedTooth === 18 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              ...
              >
                <path
                  className={`st24 ${tooth18Diagnozis.apex ? 'apex' : ''}`}
                  d="M227.9 595C229.6 586.4 234.4 578.8 242.9 573.2C252.9 566.5 266.3 563.9
                ...
                />
                <path
                  className={`st53 ${tooth18Diagnozis.apex ? 'apex' : ''}`}
                  d="M253.5 592.5C252.702 598.351 262.578 601.803 265.522 606.498C270.817
            ...
            <g
              ...
              style={{
                visibility:
                  tooth18Diagnozis?.apex || tooth18Diagnozis?.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
          ...
          <g className="pulp">
            <g
              ...
              style={{
                visibility: tooth18Diagnozis?.apex ? 'inherit' : 'hidden',
              }}
            >
              <ellipse
          ...
          <g
            ...
            style={{
              visibility:
                tooth18Diagnozis.implant || tooth18Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            ...
            style={{
              visibility: tooth18Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth18Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
              d="M227.9 595C229.6 586.4 234.4 578.8 242.9 573.2C252.9 566.5 266.3 563.9 279.6 562.9C290.8 562.1 302.7 562.6 310.5 568.5C315.9 572.5 317.9 578.3 319.1 583.9C320.2 589.6 320.5 595.5 320.4 601.3C320.2 607 319.6 612.9 315.9 618C312 623.5 305.2 627.4 297.6 630C274.1 638.1 246.2 633.7 233.4 617.6C227.9 610.9 226.3 602.9 227.9 595Z"
            ></path>
            <path
              className="st47"
              d="M244.374 596.429C245.451 591.006 248.492 586.213 253.879 582.682C260.215 578.457 268.707 576.817 277.135 576.187C284.232 575.682 291.773 575.997 296.715 579.718C300.137 582.24 301.404 585.898 302.165 589.429C302.862 593.024 303.052 596.744 302.989 600.402C302.862 603.996 302.482 607.717 300.137 610.933C297.666 614.401 293.357 616.861 288.541 618.5C273.649 623.608 255.97 620.833 247.859 610.681C244.374 606.456 243.36 601.411 244.374 596.429Z"
            ></path>
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth18Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
            ...
            <circle
              ...
              cy="598"
              r="12.25"
              style={{ fill: 'black', opacity: tooth18Diagnozis.pin ? 1 : 0 }}
            />
          </g>
          {/* CULTTAB */}
          <g
            ...
            style={{
              visibility: !tooth18Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth18Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: teethDiagnozis.tooth18.tartar ? 1 : 0,
            }}
          >
            <path
              className="st61 tartat-part"
          ...
          >
            ...
            <g className="with">
              ...
              <path
                className="st54"
                d="M247.5 614.5C244.5 615 236.6 617.8 229 625"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth18Diagnozis.seal_left &&
                      !tooth18Diagnozis.seal_top) ||
              ...
              <path
                className="st54"
                d="M247.5 614.5C243.333 608.333 237.9 593.5 249.5 583.5"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth18Diagnozis.seal_left &&
                      !tooth18Diagnozis.seal_center) ||
                    (!tooth18Diagnozis.seal_left &&
                      tooth18Diagnozis.seal_center)
                      ? 5
                      : 0,
              ...
              <path
                className="st54"
                d="M236.5 565C238.167 567.833 243 575.4 249 583"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth18Diagnozis.seal_left &&
                      !tooth18Diagnozis.seal_bottom) ||
                    (!tooth18Diagnozis.seal_left &&
                      tooth18Diagnozis.seal_bottom)
                      ? 5
                      : 0,
              ...
              <path
                className="st54"
                d="M249.5 583.5C260.833 576 288 565.6 306 584"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth18Diagnozis.seal_center &&
              ...
              <path
                className="st54"
                d="M320 575C318.667 576.5 314.2 580.5 307 584.5"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth18Diagnozis.seal_right &&
                      !tooth18Diagnozis.seal_bottom) ||
                    (!tooth18Diagnozis.seal_right &&
                      tooth18Diagnozis.seal_bottom)
                      ? 5
              ...
              <path
                className="st54"
                d="M306 584C308.333 587.667 311.4 598.6 305 613"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (!tooth18Diagnozis.seal_right &&
              ...
              <path
                className="st54"
                d="M315 631C312.833 629.167 307.8 623.5 305 615.5"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth18Diagnozis.seal_right &&
              ...
              <path
                className="st54"
                d="M305 613C300.5 622 264.3 628.6 247.5 615"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth18Diagnozis.seal_center &&
          ...
          <g
            ...
            style={{
              visibility:
                tooth18Diagnozis.temporary_crown ||
                tooth18Diagnozis.ceramic_crown ||
                tooth18Diagnozis.mceramic_crown ||
                tooth18Diagnozis.metalic_crown ||
                tooth18Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth18Diagnozis.temporary_crown ||
          ...
          >
            ...
            {/*FISSURE*/}
            <path
              className={`st3 fissure ${tooth18Diagnozis.fissure ? 'diagnoze' : tooth18Diagnozis.fissure ? 'hidden' : ''}`}
            ...
            />
            <path
              className={`st3 fissure ${tooth18Diagnozis.fissure ? 'diagnoze' : ''}`}
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth18Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g
            className="stump hEmpty hIntact hImplant"
            style={{
              visibility: tooth18Diagnozis.culttab ? 'inherit' : 'hidden',
              opacity: tooth18Diagnozis.culttab ? 1 : 0,
            }}
          >
            <path
              className="st14"
              d="M267.7,337.7c0,0,0.1,0,0.1,0v0c0,0,0,0,0,0c0.9,0.1,1.9,0.3,2.8,0.5c0.5,0.1,1,0.2,1.4,0.3
            ...
            <path
              className="st15"
              d="M228.3,362.4c0,7.7,0.4,15.4,1.1,23.1c0.8,7.9,1.9,15.7,3.5,23.5c3.4-1.8,6.9-3.5,10.3-5.1
          ...
          >
            <path
              className="st25"
              d="M326,368.6c-5.6-7.8-12.8-14.3-21.2-19c-8-4.5-16.7-7.3-25.6-9.5c-9.7-2.4-19.7-4-29.7-3.1
                            c-0.2,0-0.5,0-0.7,0.1c-3.9,0.4-7.8,1.3-11.2,3c0,0,0,0,0,0l35.5-12l31.5,4.5L326,368.6z"
            />
            <path
              className="st26"
              d="M326.3,369.4c-0.2,10.3-3.9,25.6-6.2,32.8c-1.1,3.4-2.3,6.9-3.5,10.3c-1.2,3.4-2.5,6.8-3.8,10.2
          ...
          >
            <path
              className="st18"
              d="M317.5,287.2c-0.9,16.3-2.7,32.5-5.5,48.5l-0.2,0l-51.8-7.5l-0.2,0c3.1-15.8,6.9-31.4,11.5-47
          ...
          <g
            ...
            style={{
              visibility:
                !tooth18Diagnozis.culttab && !tooth18Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          >
            ...
            <g className="with">
              ...
              <path
                className={`st54`}
                d="M236.5 380.999C236.412 386.832 236.188 401.599 236 413.999"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth18Diagnozis.seal_left &&
              ...
              <path
                className={`st54`}
                d="M236.5 380.999C236.333 375.499 234.3 363.799 227.5 360.999"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth18Diagnozis.seal_left &&
              ...
              <path
                className={`st54`}
                d="M236.5 380.999C252.5 372.5 292.2 379.999 307 395.999"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (!tooth18Diagnozis.seal_top &&
              ...
              <path
                className={`st54`}
                d="M307 395.999C307 390.832 309.9 379.699 321.5 376.499"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth18Diagnozis.seal_right &&
