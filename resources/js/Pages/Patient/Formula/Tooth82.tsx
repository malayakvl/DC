...
export default function Tooth82() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth82.caries_bottom =
          !teethDiagnozis.tooth82.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth82.caries_center =
          !teethDiagnozis.tooth82.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth82.caries_left =
          !teethDiagnozis.tooth82.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth82.caries_right =
          !teethDiagnozis.tooth82.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth82.seal_center =
            !teethDiagnozis.tooth82.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth82.seal_bottom =
            !teethDiagnozis.tooth82.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth82.seal_right =
            !teethDiagnozis.tooth82.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth82.wedge_shaped_defect_color =
          !teethDiagnozis.tooth82.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  const showHideOverlay = type => {
    if (type === 'over' && !excludeToothEffect.includes(diagnozis)) {
      if (
        teethType === 'child' &&
        !teethDiagnozis.tooth82.show &&
        !teethDiagnozis.tooth42.show
      ) {
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 930 842)"
          className={`st3 st4 st5 ${selectedTooth === 82 ? 'num-active' : ''}`}
        >
          82
        </text>
      </g>
      <g
        id="TH-82"
        className={`f-tooth-init-milk ${teethType} ${(teethDiagnozis.tooth82.show || allTeeth) && !teethDiagnozis.tooth82.absent ? 'f-tooth-active' : ''}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 82 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        <g
          ...
          style={{
            visibility: 'inherit',
            transform: 'matrix(0.55, 0, 0, 0.55, 17, -4)',
          }}
          onMouseOver={() => {
        ...
        >
          <g className="dentin">
            <g
              style={{
                visibility:
                  !tooth82Diagnozis.culttab &&
                  !tooth82Diagnozis.implant &&
                  !tooth82Diagnozis.shaper
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st6 change-color ${tooth82Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth82Diagnozis?.apex ? 'apex' : ''}`}
            ...
            <g
              style={{
                visibility:
                  tooth82Diagnozis?.apex || tooth82Diagnozis.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
          ...
          <g
            className="pulp"
            style={{ visibility: tooth82Diagnozis.apex ? 'inherit' : 'hidden' }}
          >
            <g>
              <path
          ...
          <g
            ...
            style={{
              visibility:
                tooth82Diagnozis.implant || tooth82Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            ...
            style={{
              visibility: tooth82Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth82Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth82Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
            ...
            <circle
              ...
              cy="983"
              r="12.25"
              style={{ fill: 'black', opacity: tooth82Diagnozis.pin ? 1 : 0 }}
            ></circle>
          </g>
          {/* CULTTAB */}
          <g
            ...
            style={{
              visibility: !tooth82Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth82Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility:
                !tooth82Diagnozis.culttab &&
                !tooth82Diagnozis.abutment &&
                !tooth82Diagnozis.implant &&
                !tooth82Diagnozis.apex &&
                !tooth82Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          ...
          <g
            className="tartar"
            style={{
              opacity: teethDiagnozis.tooth82.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="with">
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth82Diagnozis.seal_left &&
                      !tooth82Diagnozis.seal_center) ||
                    (!tooth82Diagnozis.seal_left &&
                      tooth82Diagnozis.seal_center)
                      ? 5
                      : 0,
          ...
          <g
            ...
            style={{
              visibility:
                tooth82Diagnozis.temporary_crown ||
                tooth82Diagnozis.ceramic_crown ||
                tooth82Diagnozis.mceramic_crown ||
                tooth82Diagnozis.metalic_crown ||
                tooth82Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth82Diagnozis.temporary_crown ||
        ...
        <g
          ...
          style={{
            visibility: 'inherit',
            transform: 'matrix(0.55, 0, 0, 0.55, 20, -17)',
          }}
          onMouseOver={() => {
            showHideTopCommonView('over');
          }}
        ...
        >
          <g className="dentin">
            ...
            >
              <path
                className={`st10 change-color ${tooth82Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g className="pulp">
            <g>
              <path
                className={`st22 target top ${tooth82Diagnozis.channel_class} ${tooth82Diagnozis.channel_class} ${tooth82Diagnozis.pulpit ? 'pulpit' : ''} ${tooth82Diagnozis.periodontit ? 'periodontit' : ''}`}
          ...
          >
            ...
            />
            <path
              style={{ fill: tooth82Diagnozis.pin ? '#dbd9d3' : 'none' }}
          ...
          <g
            ...
            style={{
              visibility:
                !tooth82Diagnozis.culttab && !tooth82Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            ></path>
            <path
              className={`st7 ${tooth82Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
