...
export default function Tooth38() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth38.caries_bottom =
          !teethDiagnozis.tooth38.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth38.caries_center =
          !teethDiagnozis.tooth38.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth38.caries_left =
          !teethDiagnozis.tooth38.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth38.caries_right =
          !teethDiagnozis.tooth38.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth38.seal_center =
            !teethDiagnozis.tooth38.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth38.seal_bottom =
            !teethDiagnozis.tooth38.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth38.seal_right =
            !teethDiagnozis.tooth38.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth38.wedge_shaped_defect_color =
          !teethDiagnozis.tooth38.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 1809.8652 842.0025)"
          className={`st3 st4 st5 ${selectedTooth === 38 ? 'num-active' : ''}`}
        >
          38
        </text>
      </g>
      <g
        id="TH-38"
        className={`f-tooth-init ${(teethDiagnozis.tooth38.show || allTeeth) && !teethDiagnozis.tooth38.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 38 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st24 change-color ${tooth38Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth38Diagnozis?.apex ? 'apex' : ''}`}
            ...
            <g
              style={{
                visibility:
                  tooth38Diagnozis?.apex || tooth38Diagnozis?.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
          ...
          <g className="pulp">
            <g
              className="hIntact pulpitis-pfilling"
              style={{
                visibility: tooth38Diagnozis?.apex ? 'inherit' : 'hidden',
              }}
            >
              <ellipse
                ...
                rx="10.0966"
                ry="8.05456"
                transform="matrix(0.0164692 -0.999864 -0.999835 -0.0181353 1853.35 938.211)"
                style={{ fill: '#e80808' }}
              ></ellipse>
              <ellipse
                className="st22 target"
                rx="8.25802"
                ry="7.57128"
                transform="matrix(0.981917 -0.189312 -0.142513 -0.989793 1813.66 930.453)"
                style={{ fill: '#e80808' }}
              ></ellipse>
              <ellipse
                className="st22 target"
                rx="9.05222"
                ry="7.94373"
                transform="matrix(-0.997644 -0.068601 -0.0623222 0.998056 1813.98 950.549)"
                style={{ fill: '#e80808' }}
              ></ellipse>
            </g>
          </g>
          ...
          <g
            ...
            style={{
              visibility:
                tooth38Diagnozis.implant || tooth38Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            <g className="st27">
              ...
              <path
                ...
                d="M1816.46 922.352L1817.08 920.45L1815.91 920.069L1815.04 920.942L1816.46 922.352ZM1819.9 923.474L1819.29 925.376L1820.36 925.725L1821.21 924.989L1819.9 923.474ZM1810.23 933.124L1808.3 932.601L1807.98 933.789L1808.89 934.611L1810.23 933.124ZM1812.93 935.55L1814.89 935.921L1815.1 934.815L1814.27 934.063L1812.93 935.55ZM1812.93 943.45L1814.27 944.937L1815.1 944.184L1814.89 943.079L1812.93 943.45ZM1810.23 945.875L1808.89 944.388L1807.98 945.211L1808.3 946.398L1810.23 945.875ZM1816.46 956.648L1815.04 958.057L1815.91 958.93L1817.08 958.549L1816.46 956.648ZM1819.9 955.525L1821.21 954.011L1820.36 953.275L1819.29 953.624L1819.9 955.525ZM1826.74 959.478L1828.7 959.063L1828.47 957.961L1827.4 957.59L1826.74 959.478ZM1827.49 963.024L1825.54 963.439L1825.79 964.644L1826.98 964.958L1827.49 963.024ZM1839.94 963.024L1840.45 964.958L1841.64 964.643L1841.89 963.438L1839.94 963.024ZM1840.69 959.477L1840.03 957.589L1838.96 957.96L1838.73 959.063L1840.69 959.477ZM1847.52 955.525L1848.14 953.623L1847.07 953.274L1846.22 954.01L1847.52 955.525ZM1850.97 956.647L1850.35 958.549L1851.52 958.93L1852.39 958.057L1850.97 956.647ZM1857.2 945.874L1859.13 946.396L1859.45 945.209L1858.53 944.386L1857.2 945.874ZM1854.5 943.448L1852.53 943.077L1852.33 944.183L1853.16 944.935L1854.5 943.448ZM1854.5 935.552L1853.16 934.064L1852.33 934.817L1852.53 935.923L1854.5 935.552ZM1857.2 933.126L1858.53 934.613L1859.45 
                                ...
                                1818.6 921.96L1821.21 924.989Z"
                mask="url(#implant_38)"
              />
            </g>
          </g>
          ...
          <g
            className="stump"
            style={{
              visibility: !tooth38Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth38Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
            ...
            <g className="with up">
              ...
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth38Diagnozis.seal_right &&
                      !tooth38Diagnozis.seal_bottom) ||
                    (!tooth38Diagnozis.seal_right &&
                      tooth38Diagnozis.seal_bottom)
                      ? 5
                      : 0,
          ...
          <g
            ...
            style={{
              visibility:
                tooth38Diagnozis.temporary_crown ||
                tooth38Diagnozis.ceramic_crown ||
                tooth38Diagnozis.mceramic_crown ||
                tooth38Diagnozis.metalic_crown ||
                tooth38Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth38Diagnozis.temporary_crown ||
          ...
          >
            ...
            />
            <path
              className={`st3 fissure ${tooth38Diagnozis.fissure ? 'diagnoze' : tooth38Diagnozis.fissure ? 'hidden' : ''}`}
          ...
          >
            <path
              className={`st3 fissure ${tooth38Diagnozis.fissure ? 'diagnoze' : ''}`}
              d="M1873.7,921.4c-1,3.2-2.7,6.2-4.9,8.7c-2.1,2.4-4.3,3.9-6.6,4.6c-4,1.2-8.2-0.4-12.1-1.9
                            c-0.9-0.3-1.8-0.7-2.6-1c-4.1-1.4-8.3-2.2-12.7-2.4c0-1.5,0-3,0.1-4.2c0-0.8,0.1-1.7,0.1-2.6c0.2-5,0.5-10.1-0.6-15.1
                            c-0.7-3.3-2-6.5-3.9-9.3l-0.9,0.6c1.8,2.8,3,5.8,3.7,9c1.1,4.8,0.8,9.9,0.6,14.8c0,0.9-0.1,1.7-0.1,2.6c-0.1,1.3-0.1,2.7-0.1,4.3
                            c-3.5,0.6-7.1,1-10.7,1.1c-0.8,0-1.7,0-2.5,0.1c-2.2,0-4.4,0.1-6.5,0.3c-0.5-1.1-0.9-2.2-1.1-3.3c-0.2-0.8-0.3-1.6-0.4-2.4
        ...
        >
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth38Diagnozis.change_color ? 'diagnoze' : ''}`}
            ...
            >
              <path
                className={`st10 change-color ${tooth38Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          {/* CULT TAB */}
          <g
            className="stump  hImplant"
            style={{
              visibility: tooth38Diagnozis.culttab ? 'inherit' : 'hidden',
              opacity: tooth38Diagnozis.culttab ? 1 : 0,
            }}
          >
            <path
              className="st14"
              d="M1881.8,1160.5L1881.8,1160.5c-0.8,0.8-2.1,0.6-2.6-0.4l-20.2-38.8c1.2-0.6,2.4-1.2,3.5-1.9
                            c2.4-1.4,4.8-2.8,7.1-4.5c0.7-0.5,1.3-1,1.9-1.5l10.6,45.5C1882.3,1159.6,1882.2,1160.1,1881.8,1160.5z"
            />
            <path
              className="st15"
              d="M1892.2,1087.7c-4.7,10.1-11.8,19-20.6,25.8c-0.6,0.5-1.3,1-1.9,1.5c-2.3,1.6-4.6,3.1-7.1,4.5
          ...
          >
            <path
              className="st16"
              d="M1786.7,1129.1l50.2,14.9l31.6-14.4l24.4-42.2c-5.9,10.6-14.2,19.7-24.2,26.5c-11.4,7.9-24.7,12.6-38.3,15
                            C1815.9,1131.6,1801.1,1131.6,1786.7,1129.1z"
            />
            <path
              className="st17"
              d="M1777.6,1096.3c0.5,8.3,1.4,18.6,2.8,26.8c1.3,1.3,2.5,2.5,3.6,3.8c0.9,0.8,1.8,1.6,2.7,2.3
          ...
          <g className="shaper" style={{ visibility: 'hidden', opacity: 0 }}>
            <path
              className="st44"
              d="M1863.41 1090.01C1862.82 1087.6 1860.19 1086.31 1857.92 1087.31L1812.84 1107.14C1810.57 1108.13 1809.74 1110.94 1811.12 1113.01L1833.23 1146.35C1834.3 1147.97 1836.4 1148.59 1838.18 1147.79L1870.73 1133.35C1872.5 1132.56 1873.46 1130.62 1872.99 1128.73L1863.41 1090.01Z"
            ></path>
          </g>
          {/* IMPLANT/CULTTAB */}
          <g
          ...
          >
            <path
              className="st18"
              d="M1876.4,1127c0,0,8.8,27.5,11.9,39.6s7.2,39.1,7.4,40.5s-5.8,9.5-13.5,12.1s-15.1-1.1-15.6-1.4
          ...
          <g
            ...
            style={{
              visibility:
                !tooth38Diagnozis.culttab && !tooth38Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
