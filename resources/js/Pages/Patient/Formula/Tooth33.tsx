...
export default function Tooth33() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth33.caries_bottom =
          !teethDiagnozis.tooth33.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth33.caries_center =
          !teethDiagnozis.tooth33.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth33.caries_left =
          !teethDiagnozis.tooth33.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth33.caries_right =
          !teethDiagnozis.tooth33.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth33.seal_center =
            !teethDiagnozis.tooth33.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth33.seal_bottom =
            !teethDiagnozis.tooth33.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth33.seal_right =
            !teethDiagnozis.tooth33.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth33.wedge_shaped_defect_color =
          !teethDiagnozis.tooth33.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 1204.7012 842.0025)"
          className={`st3 st4 st5 ${selectedTooth === 33 ? 'num-active' : ''}`}
        >
          33
        </text>
      </g>
      <g
        id="TH-33"
        className={`f-tooth-init ${(teethDiagnozis.tooth33.show || allTeeth) && !teethDiagnozis.tooth33.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 33 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth33Diagnozis.change_color ? 'diagnoze' : ''}`}
            ...
            <g
              style={{
                visibility:
                  tooth33Diagnozis?.apex || tooth33Diagnozis.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
          ...
          <g className="pulp">
            <g
              ...
              style={{
                visibility: tooth33Diagnozis.apex ? 'inherit' : 'hidden',
              }}
            >
              <path
          ...
          <g
            style={{
              visibility:
                tooth33Diagnozis.implant || tooth33Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            className="abutment"
            style={{
              visibility: tooth33Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth33Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth33Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
            ...
            <circle
              ...
              r="12.25"
              transform="matrix(-1 0 0 1 1225.36 983)"
              style={{ fill: 'black', opacity: tooth33Diagnozis.pin ? 1 : 0 }}
            />
          </g>
          <g
            className="stump"
            style={{
              visibility: !tooth33Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth33Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            style={{
              opacity: teethDiagnozis.tooth33.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="with up">
              ...
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth33Diagnozis.seal_right &&
                      !tooth33Diagnozis.seal_center) ||
                    (!tooth33Diagnozis.seal_right &&
                      tooth33Diagnozis.seal_center)
                      ? 5
                      : 0,
          ...
          <g
            ...
            style={{
              visibility:
                tooth33Diagnozis.temporary_crown ||
                tooth33Diagnozis.ceramic_crown ||
                tooth33Diagnozis.mceramic_crown ||
                tooth33Diagnozis.metalic_crown ||
                tooth33Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth33Diagnozis.temporary_crown ||
          ...
          >
            ...
            />
            <path
              className={`st3 fissure ${tooth33Diagnozis.fissure ? 'diagnoze' : tooth33Diagnozis.fissure ? 'hidden' : ''}`}
          ...
          >
            <path
              className={`st3 fissure ${tooth33Diagnozis.fissure ? 'diagnoze' : ''}`}
              d="M1223.6,981.3c-4.9,0-9.7-0.8-14.4-2.3l0.3-1c5.4,1.7,11,2.5,16.5,2.2c5.3-0.3,10.6-1.5,15.5-3.7l0.4,1
                            c-5,2.2-10.4,3.5-15.9,3.8C1225.3,981.3,1224.5,981.3,1223.6,981.3z"
            />
          </g>
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                id="dentin_n_33"
                className={`st10 change-color ${tooth33Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          >
            ...
            <path
              className="st57"
              style={{ fill: tooth33Diagnozis.pin ? '#dbd9d3' : 'none' }}
          ...
          <g
            ...
            style={{
              visibility:
                !tooth33Diagnozis.culttab && !tooth33Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            ></path>
            <path
              className={`st7 ${tooth33Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
          ...
          >
            ...
            >
              ...
              <path
                ...
                d="M1205.1,1197.7c-1,2.8-5.4,6.8-8.5,9.3c-1.3-2.6-2.6-5.3-3.8-8c-3.4-7.7-6.5-15.5-8.4-23.8
                                ...
                                C1206.5,1177.4,1206.7,1193.3,1205.1,1197.7z"
                style={{
                  fill: teethDiagnozis.tooth33.caries_left
                    ? '#606c80'
                    : teethDiagnozis.tooth33.seal_left
                      ? teethDiagnozis.tooth33.seal_left_color
                      : 'transparent',
                }}
              />
            </g>
            ...
            >
              ...
              <path
                ...
                d="M1263,1201.9L1263,1201.9c-1.3,3.6-2.8,7.1-4.5,10.5c-4,8.3-9,16.3-16.2,21.9c-4.2,3.3-9.2,5.7-14.5,5.4
                                ...
                                c1.1,12.8,4,35.9,5.4,40.8C1255.9,1196.1,1258.6,1198.4,1263,1201.9z"
                style={{
                  fill: teethDiagnozis.tooth33.caries_center
                    ? '#606c80'
                    : teethDiagnozis.tooth33.seal_center
                      ? teethDiagnozis.tooth33.seal_center_color
                      : 'transparent',
                }}
              />
            </g>
            {/* КАРИЕС R */}
            <g
              className="caries-filling right"
              onClick={() => {
                setColordedPart(diagnozis, 'right');
              }}
            >
              ...
              <path
                ...
                d="M1269.2,1181.4c-1.6,7-3.6,13.8-6.2,20.5c-4.4-3.5-7.1-5.7-8.2-9.8c-1.4-4.9-4.2-28-5.4-40.8
                                ...
                                C1272.4,1165.4,1271,1173.5,1269.2,1181.4z"
                style={{
                  fill: teethDiagnozis.tooth33.caries_right
                    ? '#606c80'
                    : teethDiagnozis.tooth33.seal_right
                      ? teethDiagnozis.tooth33.seal_right_color
                      : 'transparent',
                }}
              />
            </g>
