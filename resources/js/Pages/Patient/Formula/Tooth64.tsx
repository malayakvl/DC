...
export default function Tooth64() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth64.caries_bottom =
          !teethDiagnozis.tooth64.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth64.caries_center =
          !teethDiagnozis.tooth64.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth64.caries_left =
          !teethDiagnozis.tooth64.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth64.caries_right =
          !teethDiagnozis.tooth64.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth64.seal_center =
            !teethDiagnozis.tooth64.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth64.seal_bottom =
            !teethDiagnozis.tooth64.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth64.seal_right =
            !teethDiagnozis.tooth64.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth64.wedge_shaped_defect_color =
          !teethDiagnozis.tooth64.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  const showHideOverlay = type => {
    if (type === 'over' && !excludeToothEffect.includes(diagnozis)) {
      if (
        teethType === 'child' &&
        !teethDiagnozis.tooth64.show &&
        !teethDiagnozis.tooth24.show
      ) {
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 1340 716)"
          className={`st3 st4 st5 ${selectedTooth === 64 ? 'num-active' : ''}`}
        >
          64
        </text>
      </g>
      <g
        id="TH-64"
        className={`f-tooth-init-milk ${(teethDiagnozis.tooth64.show || allTeeth) && !teethDiagnozis.tooth64.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        ...
        <g
          ...
          style={{
            visibility: 'inherit',
            transform: 'matrix(0.55, 0, 0, 0.55, 500, 274)',
          }}
          onMouseOver={() => {
            showHideOverlay('over');
          }}
        ...
        >
          ...
          <g className="dentin">
            <g
              ...
              style={{
                visibility:
                  !tooth64Diagnozis.culttab &&
                  !tooth64Diagnozis.implant &&
                  !tooth64Diagnozis.shaper
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st24 change-color ${tooth64Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth64Diagnozis?.apex ? 'apex' : ''}`}
            ...
            >
              <path
                className={`st24 ${tooth64Diagnozis.apex ? 'apex' : ''}`}
          ...
          <g
            ...
            style={{
              visibility:
                tooth64Diagnozis.apex || tooth64Diagnozis.pulpit
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            ...
            style={{
              visibility:
                tooth64Diagnozis.implant || tooth64Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            className="abutment"
            style={{
              visibility: tooth64Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth64Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth64Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
          ...
          <g
            ...
            style={{
              visibility: !tooth64Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth64Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            style={{
              visibility:
                !tooth64Diagnozis.culttab &&
                !tooth64Diagnozis.abutment &&
                !tooth64Diagnozis.implant &&
                !tooth64Diagnozis.apex &&
                !tooth64Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          ...
          <g
            className="tartar"
            style={{
              opacity: teethDiagnozis.tooth64.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="with">
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth64Diagnozis.seal_right &&
                      !tooth64Diagnozis.seal_bottom) ||
                    (!tooth64Diagnozis.seal_right &&
                      tooth64Diagnozis.seal_bottom)
                      ? 5
                      : 0,
          ...
          <g>
            ...
            >
              <path
                className={`vinir-fill ${tooth64Diagnozis.vinir_color}`}
          ...
          <g
            ...
            style={{
              visibility:
                tooth64Diagnozis.temporary_crown ||
                tooth64Diagnozis.ceramic_crown ||
                tooth64Diagnozis.mceramic_crown ||
                tooth64Diagnozis.metalic_crown ||
                tooth64Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth64Diagnozis.temporary_crown ||
          ...
          >
            ...
            {/*FISSURE*/}
            <path
              className={`st3 fissure ${tooth64Diagnozis.fissure ? 'diagnoze' : tooth64Diagnozis.fissure ? 'hidden' : ''}`}
          ...
          >
            <path
              className={`st3 fissure ${tooth64Diagnozis.fissure ? 'diagnoze' : ''}`}
              d="M1618.9,584.5c-1.5,3.9-3.7,7.3-6.7,10.2c-3.5,3.4-7.8,5.9-12.1,8.3l-1.2,0.7c-4.3,2.5-8.6,5.1-12.8,7.8
                            l-0.5-0.5c-0.5,0.5-0.9,1.1-1.3,1.6c-6.2-6.7-14-11.9-22.6-15.1c-5.7-2.1-12.2-3.5-20.5-4.3c-6.8-0.7-13.7-1-20.6-0.7l-19.1-13.1
                            l-0.6,0.9l19.4,13.3l0.2,0c6.9-0.2,13.8,0,20.6,0.7c8.1,0.8,14.6,2.2,20.2,4.3c8.5,3.1,16.3,8.3,22.4,15
                            c-2.2,3.6-2.8,7.7-3.3,11.8c-0.2,1.5-0.4,3-0.7,4.4c-1.3,6.7-4.4,13-9,18.2l0.8,0.7c4.7-5.3,7.9-11.8,9.2-18.7
        ...
        <g
          ...
          style={{
            visibility: 'inherit',
            transform: 'matrix(0.55, 0, 0, 0.55, -165, 99)',
          }}
          onMouseOver={() => {
        ...
        >
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth64Diagnozis.change_color ? 'diagnoze' : ''}`}
            ...
            >
              <path
                className={`st10 change-color ${tooth64Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g className="pulp">
            <g className="pulpitis-pfilling" style={{ visibility: 'inherit' }}>
              <path
                className={`st22 target top ${tooth64Diagnozis.channel_class} ${tooth64Diagnozis.channel_class} ${tooth64Diagnozis.pulpit ? 'pulpit' : ''} ${tooth64Diagnozis.periodontit ? 'periodontit' : ''}`}
            ...
            <g className="pulpitis-pfilling" style={{ visibility: 'inherit' }}>
              <path
                className={`st22 target middle ${tooth64Diagnozis.channel_class} ${tooth64Diagnozis.channel_class} ${tooth64Diagnozis.pulpit ? 'pulpit' : ''} ${tooth64Diagnozis.periodontit ? 'periodontit' : ''}`}
          ...
          <g
            className="stump"
            style={{
              visibility: tooth64Diagnozis.culttab ? 'inherit' : 'hidden',
              opacity: tooth64Diagnozis.culttab ? 1 : 0,
            }}
          >
            <path
              className="st14"
          ...
          <g
            ...
            style={{
              visibility:
                !tooth64Diagnozis.culttab && !tooth64Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
