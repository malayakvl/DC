...
export default function Tooth37() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth37.caries_bottom =
          !teethDiagnozis.tooth37.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth37.caries_center =
          !teethDiagnozis.tooth37.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth37.caries_left =
          !teethDiagnozis.tooth37.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth37.caries_right =
          !teethDiagnozis.tooth37.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth37.seal_center =
            !teethDiagnozis.tooth37.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth37.seal_bottom =
            !teethDiagnozis.tooth37.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth37.seal_right =
            !teethDiagnozis.tooth37.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth37.wedge_shaped_defect_color =
          !teethDiagnozis.tooth37.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 1668.877 842.0025)"
          className={`st3 st4 st5 ${selectedTooth === 37 ? 'num-active' : ''}`}
        >
          37
        </text>
      </g>
      <g
        id="TH-37"
        className={`f-tooth-init ${(teethDiagnozis.tooth37.show || allTeeth) && !teethDiagnozis.tooth37.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 37 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st24 change-color ${tooth37Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth37Diagnozis?.apex ? 'apex' : ''}`}
          ...
          <g className="pulp">
            <g
              ...
              style={{
                visibility: tooth37Diagnozis?.apex ? 'inherit' : 'hidden',
              }}
            >
              <ellipse
          ...
          <g
            ...
            style={{
              visibility:
                tooth37Diagnozis.implant || tooth37Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            className="abutment"
            style={{
              visibility: tooth37Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth37Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth37Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
          ...
          <g
            className="stump"
            style={{
              visibility: !tooth37Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth37Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: teethDiagnozis.tooth37.tartar ? 1 : 0,
            }}
          >
            <path
            ...
            <g className="with">
              ...
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth37Diagnozis.seal_right &&
                      !tooth37Diagnozis.seal_top) ||
          ...
          <g
            ...
            style={{
              visibility:
                tooth37Diagnozis.temporary_crown ||
                tooth37Diagnozis.ceramic_crown ||
                tooth37Diagnozis.mceramic_crown ||
                tooth37Diagnozis.metalic_crown ||
                tooth37Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth37Diagnozis.temporary_crown ||
          ...
          >
            ...
            />
            <path
              className={`st3 fissure ${tooth37Diagnozis.fissure ? 'diagnoze' : tooth37Diagnozis.fissure ? 'hidden' : ''}`}
          ...
          >
            <path
              className={`st3 fissure ${tooth37Diagnozis.fissure ? 'diagnoze' : ''}`}
              d="M1742.7,946.3c-1.5,2.6-2.9,5.3-4.1,8.1l-0.2,0.4c-1,2.3-2,4.7-4.1,5.9
                            c-2.4,1.3-4.9,0.8-7.7,0.2c-0.5-0.1-1.1-0.2-1.6-0.3c-5.9-1.1-12.3-0.1-17.7,1c-5,1-10,2.4-14.8,4.2c-0.2-1.9-0.1-3.8,0-5.5
                            c0.1-0.9,0.2-1.9,0.3-2.8c0.3-2.2,0.5-4.4,0.5-6.6c0-2.7-0.5-5.5-0.9-8.1c-0.5-3.2-1.1-6.5-0.8-9.8c0.4-5,2.5-9.8,6.1-13.4
                            l-0.8-0.8c-3.7,3.8-6,8.8-6.4,14c-0.3,3.4,0.3,6.8,0.8,10c0.4,2.6,0.9,5.3,0.9,8c0,2.2-0.3,4.4-0.5,6.5c-0.1,0.9-0.2,1.9-0.3,2.8
        ...
        >
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth37Diagnozis.change_color ? 'diagnoze' : ''}`}
            ...
            >
              <path
                className={`st10 change-color ${tooth37Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          >
            ...
            <path
              className="st57"
              d="M1684.4 1109.3L1765.3 1211.1L1766.5 1212.6L1780.4 1230.1C1781.1 1231 1782.4 1231.2 1783.3 1230.6C1784.3 1230 1784.6 1228.7 1784 1227.7L1771.4 1205.5L1745.6 1160.4L1713.4 
          ...
          <g
            className="stump"
            style={{
              visibility: tooth37Diagnozis.culttab ? 'inherit' : 'hidden',
              opacity: tooth37Diagnozis.culttab ? 1 : 0,
            }}
          >
            <path
              className="st14"
          ...
          <g
            ...
            style={{
              visibility:
                !tooth37Diagnozis.culttab && !tooth37Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            />
            <path
              className={`st7 ${tooth37Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
