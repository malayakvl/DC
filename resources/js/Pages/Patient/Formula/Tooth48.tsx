...
export default function Tooth48() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth48.wedge_shaped_defect_color =
          !teethDiagnozis.tooth48.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  return (
    <>
      ...
      <g
        id="TH-48"
        className={`f-tooth-init ${(teethDiagnozis.tooth48.show || allTeeth) && !teethDiagnozis.tooth48.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 48 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st24 change-color ${tooth48Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth48Diagnozis?.apex ? 'apex' : ''}`}
          ...
          <g className="pulp">
            <g
              ...
              style={{
                visibility: tooth48Diagnozis?.apex ? 'inherit' : 'hidden',
              }}
            >
              <ellipse
                ...
                rx="10.0966"
                ry="8.05456"
                transform="matrix(-0.0164692 -0.999864 0.999835 -0.0181353 245.152 933.211)"
                style={{ fill: '#e80808' }}
              />
              <ellipse
                className="st22 target"
                rx="8.25802"
                ry="7.57128"
                transform="matrix(-0.981917 -0.189312 0.142513 -0.989793 284.84 925.453)"
                style={{ fill: '#e80808' }}
              />
              <ellipse
                className="st22 target"
                rx="9.05222"
                ry="7.94373"
                transform="matrix(0.997644 -0.068601 0.0623222 0.998056 284.526 945.549)"
                style={{ fill: '#e80808' }}
              />
            </g>
          </g>
          ...
          >
            ...
            <g className="st27">
              <mask id="implant_48" className="st49">
                <path
                  className="st50"
                  d="M251.905 920.474L248.458 919.352C245.529 922.3 243.349 925.994 242.231 930.124L244.928 932.55C244.686 933.829 244.56 935.15 244.56 936.5C244.56 937.85 244.686 939.17 244.928 940.45L242.231 942.875C243.349 947.006 245.529 950.7 248.458 953.648L251.905 952.525C253.895 954.242 256.209 955.594 258.743 956.478L259.494 960.024C261.479 960.548 263.564 
              ...
              <path
                className="st50 st51"
                d="M251.905 920.474L248.458 919.352C245.529 922.3 243.349 925.994 242.231 930.124L244.928 932.55C244.686 933.829 244.56 935.15 244.56 936.5C244.56 937.85 244.686 939.17 244.928 940.45L242.231 942.875C243.349 947.006 245.529 950.7 
              ...
              <path
                className="st52"
                d="M248.458 919.352L249.078 917.45L247.907 917.069L247.04 917.942L248.458 919.352ZM251.905 920.474L251.286 922.376L252.357 922.725L253.211 921.989L251.905 920.474ZM242.231 930.124L240.3 929.601L239.979 930.789L240.893 931.611L242.231 930.124ZM244.928 932.55L246.893 932.921L247.102 931.815L246.265 931.063L244.928 932.55ZM244.928 940.45L246.265 941.937L247.102 
                                ...
                                250.599 918.96L253.211 921.989Z"
                mask="url(#implant_48)"
              />
            </g>
          </g>
          ...
          >
            ...
            <circle
              ...
              cy="940"
              r="12.25"
              style={{ fill: 'black', opacity: tooth48Diagnozis.pin ? 1 : 0 }}
            />
          </g>
          {/* CULTTAB */}
          <g
            className="stump"
            style={{
              visibility: !tooth48Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth48Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility:
                tooth48Diagnozis.temporary_crown ||
                tooth48Diagnozis.ceramic_crown ||
                tooth48Diagnozis.mceramic_crown ||
                tooth48Diagnozis.metalic_crown ||
                tooth48Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth48Diagnozis.temporary_crown ||
          ...
          >
            ...
            {/*FISSURE*/}
            <path
              className={`st3 fissure ${tooth48Diagnozis.fissure ? 'diagnoze' : tooth48Diagnozis.fissure ? 'hidden' : ''}`}
          ...
          >
            <path
              className={`st3 fissure ${tooth48Diagnozis.fissure ? 'diagnoze' : ''}`}
              d="M298.2,939.4c-1.4-2.6-3.5-4.7-6.1-6.2c-2.1-1.2-4.5-1.8-6.8-2.2c0.4-1,0.8-2.1,1-3.2
                            c0.2-0.8,0.3-1.6,0.4-2.5c0.1-0.7,0.2-1.4,0.3-2c0.3-1.7,0.8-3.6,2.4-5.4c1.6-1.8,3.5-3.8,6.5-5l-0.4-1c-3.2,1.3-5.3,3.4-6.9,5.3
                            c-1.7,2-2.3,4-2.6,5.9c-0.1,0.7-0.2,1.4-0.3,2.1c-0.1,0.8-0.2,1.6-0.4,2.4c-0.2,1.1-0.6,2.2-1.1,3.3c-2.2-0.2-4.4-0.3-6.5-0.3
                            c-0.9,0-1.7,0-2.5-0.1c-3.6-0.1-7.1-0.5-10.7-1.1c0-1.6,0-3-0.1-4.3c0-0.9-0.1-1.7-0.1-2.6c-0.2-4.9-0.5-10,0.6-14.8
        ...
        >
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth48Diagnozis.change_color ? 'diagnoze' : ''}`}
            ...
            >
              <path
                className={`st10 change-color ${tooth48Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          >
            <path
              className="st56 hIntact"
              d="M205.5 1088.4C210.2 1098.5 217.8 1106.7 226.6 1113.5C227.2 1114 227.9 1114.5 228.6 1115C230.9 1116.6 233.2 1118.1 235.6 1119.5C236.8 1120.2 237.9 1120.8 239.1 1121.4C247.8 1125.7 257.2 1128.4 266.8 1130.1C268.9 1130.5 271.1 1130.8 273.3 1131C285.7 1132.5 298.2 1132.2 310.5 1130.2C311.1 1129.7 311.7 1129.3 312.2 1128.8C313.6 1127.4 315 1126 316.5 1124.5C317.9 1116.3 319.1 1105.7 319.6 1097.4C320 1089.9 
            ...
            <path
              className="st57"
              d="M263.2 1075.5L239.3 1121.2L224.8 1148.9L219 1160.1C218.5 1161.1 217.2 1161.3 216.5 1160.5C216.1 1160.1 215.9 1159.5 216.1 1159L247.2 1064.7C247.9 1065.2 248.5 1065.7 249.2 1066.2C249.3 1066.3 249.4 1066.3 249.5 1066.4C250.2 1066.9 251 1067.5 251.7
          ...
          <g
            className="stump"
            style={{
              visibility: tooth48Diagnozis.culttab ? 'inherit' : 'hidden',
              opacity: tooth48Diagnozis.culttab ? 1 : 0,
            }}
          >
            <path
              className="st14"
              d="M216.4,1160.5L216.4,1160.5c0.8,0.8,2.1,0.6,2.6-0.4l20.2-38.8c-1.2-0.6-2.4-1.2-3.5-1.9
                            c-2.4-1.4-4.8-2.8-7-4.5c-0.7-0.5-1.3-1-2-1.5L216,1159C215.9,1159.6,216,1160.1,216.4,1160.5z"
            />
            <path
              className="st15"
              d="M205.5,1088.4c4.7,10.1,12.3,18.3,21.1,25.1c0.6,0.5,1.3,1,2,1.5c2.3,1.6,4.6,3.1,7,4.5
          ...
          >
            <path
              className="st16"
              d="M310.2,1130.1l-50.2,14.9l-31.6-14.4l-24.4-42.2c5.9,10.6,14.2,19.7,24.2,26.5c11.4,7.9,24.7,12.6,38.3,15
                            C281,1132.6,295.8,1132.6,310.2,1130.1z"
            />
            <path
              className="st17"
              d="M319.3,1097.3c-0.5,8.3-1.4,18.6-2.8,26.8c-1.3,1.3-2.5,2.5-3.6,3.8c-0.9,0.8-1.8,1.6-2.7,2.3
          ...
          <g className="shaper" style={{ visibility: 'inherit', opacity: 0 }}>
            <path
              className="st44"
              d="M234.447 1090.01C235.043 1087.6 237.667 1086.31 239.94 1087.31L285.021 1107.14C287.292 1108.13 288.115 1110.94 286.744 1113.01L264.634 1146.35C263.556 1147.97 261.462 1148.59 259.678 1147.79L227.129 1133.35C225.356 1132.56 224.403 1130.62 224.869 1128.73L234.447 1090.01Z"
            ></path>
          </g>
          {/* IMPLANT/CULTTAB */}
          <g
          ...
          >
            ...
            ></path>
            <path
              className={`st7 ${tooth48Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
