...
export default function Tooth72() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth72.caries_bottom =
          !teethDiagnozis.tooth72.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth72.caries_center =
          !teethDiagnozis.tooth72.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth72.caries_left =
          !teethDiagnozis.tooth72.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth72.caries_right =
          !teethDiagnozis.tooth72.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth72.seal_center =
            !teethDiagnozis.tooth72.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth72.seal_bottom =
            !teethDiagnozis.tooth72.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth72.seal_right =
            !teethDiagnozis.tooth72.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth72.wedge_shaped_defect_color =
          !teethDiagnozis.tooth72.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  const showHideOverlay = type => {
    if (type === 'over') {
      if (
        teethType === 'child' &&
        !teethDiagnozis.tooth72.show &&
        !teethDiagnozis.tooth32.show
      ) {
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 1125 842)"
          className={`st3 st4 st5 ${selectedTooth === 72 ? 'num-active' : ''}`}
        >
          72
        </text>
      </g>
      <g
        id="TH-72"
        className={`f-tooth-init-milk ${(teethDiagnozis.tooth72.show || allTeeth) && !teethDiagnozis.tooth72.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 72 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        <g
          ...
          style={{
            visibility: 'inherit',
            transform: 'matrix(0.55, 0, 0, 0.55, 15, -6)',
          }}
          onMouseOver={() => {
        ...
        >
          <g className="dentin">
            <g
              style={{
                visibility:
                  !tooth72Diagnozis.culttab &&
                  !tooth72Diagnozis.implant &&
                  !tooth72Diagnozis.shaper
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st6 change-color ${tooth72Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth72Diagnozis?.apex ? 'apex' : ''}`}
            ...
            <g
              style={{
                visibility:
                  tooth72Diagnozis?.apex || tooth72Diagnozis.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
          ...
          <g
            className="pulp"
            style={{ visibility: tooth72Diagnozis.apex ? 'inherit' : 'hidden' }}
          >
            <g>
              <path
          ...
          <g
            ...
            style={{
              visibility:
                tooth72Diagnozis.implant || tooth72Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth72Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
            ...
            <circle
              ...
              r="12.25"
              transform="matrix(-1 0 0 1 1150.13 983)"
              style={{ fill: 'black', opacity: tooth72Diagnozis.pin ? 1 : 0 }}
            ></circle>
          </g>
          {/* CULTTAB */}
          <g
            ...
            style={{
              visibility: !tooth72Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth72Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility:
                !tooth72Diagnozis.culttab &&
                !tooth72Diagnozis.abutment &&
                !tooth72Diagnozis.implant &&
                !tooth72Diagnozis.apex &&
                !tooth72Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
            ...
            <g className="with">
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth72Diagnozis.seal_right &&
                      !tooth72Diagnozis.seal_center) ||
                    (!tooth72Diagnozis.seal_right &&
                      tooth72Diagnozis.seal_center)
                      ? 5
                      : 0,
          ...
          <g
            ...
            style={{
              visibility:
                tooth72Diagnozis.temporary_crown ||
                tooth72Diagnozis.ceramic_crown ||
                tooth72Diagnozis.mceramic_crown ||
                tooth72Diagnozis.metalic_crown ||
                tooth72Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth72Diagnozis.temporary_crown ||
        ...
        <g
          ...
          style={{
            visibility: 'inherit',
            transform: 'matrix(0.55, 0, 0, 0.55, 17, -23)',
          }}
          onMouseOver={() => {
            showHideTopCommonView('over');
          }}
        ...
        >
          <g className="dentin">
            ...
            >
              <path
                className={`st10 change-color ${tooth72Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g className="pulp">
            <g>
              <path
                className={`st22 target top ${tooth72Diagnozis.channel_class} ${tooth72Diagnozis.channel_class} ${tooth72Diagnozis.pulpit ? 'pulpit' : ''} ${tooth72Diagnozis.periodontit ? 'periodontit' : ''}`}
          ...
          >
            <path
              className="st56 hIntact"
              d="M1172.59 1211.6C1170.19 1217 1167.09 1222 1162.09 1225.2C1160.29 1226.3 1158.39 1227.2 1156.49 1227.7C1156.19 1227.8 1155.89 1227.9 1155.59 1227.9C1151.99 1228.8 1148.09 1228.6 1144.49 1227.5C1144.39 1227.5 1144.29 1227.4 1144.19 1227.4C1142.79 1226.9 1141.39 1226.3 1140.09 1225.6C1131.69 1220.7 1127.69 1211.1 1124.79 1201.7C1124.39 1200.3 1123.99 1198.9 1123.59 1197.6C1123.39 1194.5 1123.29 1191.4 1123.09 1188.3C1122.89 1183.1 1122.79 1177.9 1122.79 1172.7C1122.79 1165.2 1123.09 1157.8 1123.79 1150.3L1125.19 1147.8L1126.89 1146.8L1164.79 1146.9L1166.39 1148.3L1167.29 1149.8C1169.09 1158.4 1170.49 1167.1 1171.39 1175.8C1171.89 1180.8 1172.29 1185.9 1172.49 1191C1172.79 1197.8 1172.79 1204.7 1172.59 1211.6Z"
              style={{ visibility: 'inherit' }}
            />
            <path
              className="st57"
              style={{ fill: tooth72Diagnozis.pin ? '#dbd9d3' : 'none' }}
          ...
          >
            <path
              className="st14"
              d="M1155.1,1314.5L1155.1,1314.5c-1.1,0-2-0.8-2.1-1.9l-8.7-85.2c0.1,0,0.2,0.1,0.3,0.1
                            c3.6,1.1,7.4,1.3,11.1,0.4c0.3-0.1,0.6-0.1,0.9-0.2l0.6,84.7C1157.2,1313.5,1156.2,1314.5,1155.1,1314.5z"
            />
            <path
              className="st15"
              d="M1172.6,1211.6c-2.4,5.4-5.5,10.4-10.5,13.6c-1.8,1.1-3.7,2-5.6,2.5c-0.3,0.1-0.6,0.2-0.9,0.2
          ...
          >
            <path
              className="st16"
              d="M1123.6,1197.5l17.9,40.2l19.2-1.2l11.9-24.9c-2.3,5.4-5.5,10.3-10.5,13.6c-6.7,4.3-15.1,4.4-22,0.4
                            c-8.4-4.9-12.4-14.5-15.3-23.9C1124.4,1200.3,1124,1198.9,1123.6,1197.5z"
            />
            <path
              className="st17"
              d="M1122.9,1172.7c0,5.2,0.1,10.4,0.3,15.6c0.1,3.1,0.3,6.1,0.5,9.2c0.4,1.4,0.8,2.8,1.3,4.2
          ...
          >
            <path
              className="st44"
              d="M1167.6 1196.47C1167.76 1194.1 1165.83 1192.12 1163.46 1192.21L1137.58 1193.18C1135.21 1193.27 1133.44 1195.39 1133.77 1197.74L1139.37 1236.97C1139.66 1239 1141.45 1240.49 1143.5 1240.4L1161.12 1239.64C1163.16 1239.55 1164.81 1237.95 1164.94 1235.91L1167.6 1196.47Z"
            ></path>
          </g>
          {/* IMPLANT/CULTTAB */}
          <g
          ...
          >
            <path
              className="st18"
              d="M1166.9,1236.8c0,0,1.5,49.5,1.8,57.5c0.3,8,0.5,60.5,0.5,60.5s-4.1,6.2-11.8,7c-7.8,0.8-11.2-7.2-11.2-7.2
          ...
          <g
            ...
            style={{
              visibility:
                !tooth72Diagnozis.culttab && !tooth72Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
