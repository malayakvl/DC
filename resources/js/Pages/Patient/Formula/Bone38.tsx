...
export default function Bone38() {
  ...
  return (
    <g
      ...
      onMouseOver={() => {
        !teethDiagnozis.tooth38.active &&
        !allTeeth &&
        document.getElementById('38').classList.add('tooth-number-hover');
      }}
      onMouseLeave={() => {
        !teethDiagnozis.tooth38.active &&
        !allTeeth &&
        document.getElementById('38').classList.remove('tooth-number-hover');
      }}
      onClick={() => {
