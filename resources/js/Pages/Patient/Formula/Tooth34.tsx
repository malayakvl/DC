...
export default function Tooth34() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth34.caries_bottom =
          !teethDiagnozis.tooth34.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth34.caries_center =
          !teethDiagnozis.tooth34.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth34.caries_left =
          !teethDiagnozis.tooth34.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth34.caries_right =
          !teethDiagnozis.tooth34.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth34.seal_center =
            !teethDiagnozis.tooth34.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth34.seal_bottom =
            !teethDiagnozis.tooth34.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth34.seal_right =
            !teethDiagnozis.tooth34.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth34.wedge_shaped_defect_color =
          !teethDiagnozis.tooth34.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 1304.4775 842.0025)"
          className={`st3 st4 st5 ${selectedTooth === 34 ? 'num-active' : ''}`}
        >
          34
        </text>
      </g>
      <g
        id="TH-34"
        className={`f-tooth-init ${(teethDiagnozis.tooth34.show || allTeeth) && !teethDiagnozis.tooth34.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 34 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth34Diagnozis.change_color ? 'diagnoze' : ''}`}
            ...
            <g
              style={{
                visibility:
                  tooth34Diagnozis?.apex || tooth34Diagnozis.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
          ...
          <g className="pulp">
            <g
              ...
              style={{
                visibility: tooth34Diagnozis.apex ? 'inherit' : 'hidden',
              }}
            >
              <path
                className="st22 target"
                d="M1320.22 991.299C1323.84 991.408 1328.85 987.936 1329.03 981.838C1329.22 975.739 1324.5 969.324 1320.88 969.215C1317.25 969.107 1313.51 973.944 1313.33 980.042C1313.15 986.14 1316.59 991.191 1320.22 991.299Z"
                style={{ fill: '#e80808' }}
              ></path>
            </g>
          </g>
          ...
          <g
            style={{
              visibility:
                tooth34Diagnozis.implant || tooth34Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          >
            ...
            <circle
              ...
              r="12.25"
              transform="matrix(-1 0 0 1 1318.94 982)"
              style={{ fill: 'black', opacity: tooth34Diagnozis.pin ? 1 : 0 }}
            />
          </g>
          <g
            className="stump"
            style={{
              visibility: !tooth34Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth34Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
            ...
            <g className="with up">
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth34Diagnozis.seal_right &&
                      !tooth34Diagnozis.seal_bottom) ||
                    (tooth34Diagnozis.seal_bottom &&
                      tooth34Diagnozis.seal_center &&
                      !tooth34Diagnozis.seal_right) ||
                    (tooth34Diagnozis.seal_bottom &&
                      !tooth34Diagnozis.seal_center &&
                      !tooth34Diagnozis.seal_right)
          ...
          <g
            ...
            style={{
              visibility:
                tooth34Diagnozis.temporary_crown ||
                tooth34Diagnozis.ceramic_crown ||
                tooth34Diagnozis.mceramic_crown ||
                tooth34Diagnozis.metalic_crown ||
                tooth34Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth34Diagnozis.temporary_crown ||
          ...
          >
            ...
            />
            <path
              className={`st3 fissure ${tooth34Diagnozis.fissure ? 'diagnoze' : tooth34Diagnozis.fissure ? 'hidden' : ''}`}
          ...
          >
            <path
              className={`st3 fissure ${tooth34Diagnozis.fissure ? 'diagnoze' : ''}`}
              d="M1337,983.7c-0.4-1.3-0.7-2.7-0.7-4.1l0-0.8c-0.1-3.1-0.2-6.3-2.8-7c-1.3-0.3-2.3,0.2-3.6,0.9
                            c-0.5,0.3-1,0.5-1.5,0.7c-2.1,0.9-4.5,0.7-6.7,0.6c-0.4,0-0.9,0-1.3-0.1c-0.4,0-0.8,0-1.2,0c-2.1,0-4.3-0.1-6.3-1
                            c-0.9-0.4-1.7-0.9-2.5-1.4c-1.7-1.1-3.3-2.2-5.1-1.6c-1.8,0.6-2.6,2.5-3.4,4.3l-0.1,0.2c-0.9,2.1-1.9,4.1-2.9,6l-1-0.5
                            c1-1.9,2-3.8,2.9-6l0.1-0.2c0.8-1.9,1.8-4.2,4.1-4.9c2.2-0.7,4.2,0.5,6,1.7c0.8,0.5,1.5,1,2.3,1.4c1.8,0.8,3.8,0.9,5.9,0.9
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                id="dentin_v_34"
                className={`st10 change-color ${tooth34Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          >
            <path
              className="st14"
              d="M1330.5,1304L1330.5,1304c-1.8,0-3.4-1.3-3.7-3.1l-15.3-86.9c0.3,0.1,0.7,0.2,1,0.3
                            c5,1.4,10.3,1.7,15.4,0.8c0.6-0.1,1.1-0.2,1.6-0.3l4.7,85.3C1334.4,1302.2,1332.7,1304,1330.5,1304z"
            />
            <path
              className="st15"
              d="M1358.3,1174c-1.5,6.5-2.8,13.1-3.9,19.6c-1.9,3.5-4.1,6.8-6.7,9.7c-4.4,4.9-9.9,8.8-16.1,10.8
          ...
          >
            <path
              className="st16"
              d="M1283.8,1191.7l24.3,38l28.5-5.1l17.9-31c-1.9,3.5-4.1,6.8-6.8,9.7c-4.4,5-9.8,8.9-16.1,10.8
                            c-8.7,2.7-17.9,1.4-26.1-2.5C1296.5,1207.4,1289.2,1200.2,1283.8,1191.7z"
            />
            <path
              className="st17"
              d="M1281.8,1175.2c0.6,5.4,1.2,10.8,1.8,16.2c0,0.1,0.1,0.2,0.2,0.3c5.5,8.5,12.8,15.7,21.7,20
          ...
          >
            <path
              className="st44"
              d="M1341.27 1183.72C1341.32 1181.29 1339.21 1179.38 1336.8 1179.66L1299.81 1184.02C1297.4 1184.3 1295.8 1186.65 1296.41 1189L1306.41 1227.51C1306.92 1229.45 1308.78 1230.72 1310.77 1230.47L1336.95 1227.28C1338.93 1227.04 1340.42 1225.38 1340.46 1223.39L1341.27 1183.72Z"
            ></path>
          </g>
          {/* IMPLANT/CULTTAB */}
          <g
          ...
          >
            <path
              className="st18"
              d="M1340.7,1224.9c0,0,4.5,42.8,5.3,54.1s3.8,77.4,3.8,77.4s-4,8.2-16.2,7.7c-12.2-0.6-11.7-5.5-12.3-8.2
          ...
          <g
            ...
            style={{
              visibility:
                !tooth34Diagnozis.culttab && !tooth34Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
