...
export default function Tooth25() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth25.caries_bottom =
          !teethDiagnozis.tooth25.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth25.caries_center =
          !teethDiagnozis.tooth25.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth25.caries_left =
          !teethDiagnozis.tooth25.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth25.caries_right =
          !teethDiagnozis.tooth25.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth25.seal_center =
            !teethDiagnozis.tooth25.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth25.seal_bottom =
            !teethDiagnozis.tooth25.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth25.seal_right =
            !teethDiagnozis.tooth25.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth25.wedge_shaped_defect_color =
          !teethDiagnozis.tooth25.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 1425.9434 716.1968)"
          className={`st3 st4 st5 ${selectedTooth === 25 ? 'num-active' : ''}`}
        >
          25
        </text>
      </g>
      <g
        id="TH-25"
        className={`f-tooth-init ${(teethDiagnozis.tooth25.show || allTeeth) && !teethDiagnozis.tooth25.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 25 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st24 ${tooth25Diagnozis.apex ? 'apex' : ''}`}
                d="M1483.3,597.4c1.5-6.3,0.3-12.6-3.2-18.3c-2.8-4.5-6.9-8.6-11.5-12
            ...
            <g
              ...
              style={{
                visibility:
                  tooth25Diagnozis?.apex || tooth25Diagnozis.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st24 change-color ${tooth25Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth25Diagnozis?.apex ? 'apex' : ''}`}
          ...
          <g
            className="pulp"
            style={{ visibility: tooth25Diagnozis.apex ? 'inherit' : 'hidden' }}
          >
            <g
              className="pulpitis-pfilling"
              style={{
                visibility: tooth25Diagnozis?.apex ? 'inherit' : 'hidden',
              }}
            >
              <path
                className="st22 target"
                d="M1455 593.5C1455 600.956 1450.5 609 1446.5 609C1442.5 609 1438 601.456 1438 594C1438 586.544 1443 582 1446.5 582C1449.5 582 1455 586.044 1455 593.5Z"
                style={{ fill: '#e80808' }}
              ></path>
            </g>
          </g>
          ...
          <g
            ...
            style={{
              visibility:
                tooth25Diagnozis.implant || tooth25Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          >
            <circle
              className="st44"
              r="22.435"
              transform="matrix(-1 0 0 1 1446.57 595.435)"
            ></circle>
            <path
              className="st45"
              d="M1448.42 586.739C1447.87 584.804 1445.13 584.804 1444.58 586.739L1444.07 588.511C1443.77 589.549 1442.71 590.164 1441.66 589.902L1439.87 589.454C1437.92 588.965 1436.55 591.339 1437.95 592.785L1439.23 594.109C1439.98 594.884 1439.98 596.116 1439.23 596.891L1437.95 598.215C1436.55 599.661 1437.92 602.035 1439.87 601.546L1441.66 601.098C1442.71 600.836 1443.77 601.451 1444.07 602.489L1444.58 604.261C1445.13 606.196 1447.87 606.196 1448.42 604.261L1448.93 602.489C1449.23 601.451 1450.29 600.836 1451.34 601.098L1453.13 601.546C1455.08 602.035 1456.45 599.661 1455.05 598.215L1453.77 596.891C1453.02 596.116 1453.02 594.884 1453.77 594.109L1455.05 592.785C1456.45 591.339 1455.08 588.965 1453.13 589.454L1451.34 589.902C1450.29 590.164 1449.23 589.549 1448.93 588.511L1448.42 586.739Z"
            ></path>
          </g>
          {/* ABUTMENT */}
          <g
            ...
            style={{
              visibility: tooth25Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth25Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
              d="
diagnozis.fissure ? 'hidden' : ''}`}
          ...
          >
            <path
              className={`st3 fissure ${tooth25Diagnozis.fissure ? 'diagnoze' : ''}`}
              d="M1472.8,597.6l-0.4-1c-9.4,3.7-19.9,5.5-30.5,5.2c-1.6-0.2-3.4-0.4-5.1-0.4c-0.4,0-0.8,0-1.2,0
                        c-5.4-0.6-10.4-1.7-15-3.4l-0.4,1c3,1.1,6.3,2,9.7,2.6c-3.7,0.4-6.9,1.1-9.1,2.1l0.5,1c3.1-1.5,8.5-2.3,14.3-2.3
                        c1.9,0.2,3.9,0.3,6,0.4c0.1,0,0.3,0,0.4,0c0.3,0,0.7,0.1,1,0.1l0-0.1c0.3,0,0.7,0,1,0C1453.9,602.9,1463.9,601.1,1472.8,597.6z"
            />
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                id="dentin_v_25"
                className={`st10 change-color ${tooth25Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          >
            <path
              className="st56 hIntact"
              d="M1476.5 438.6C1475.5 448.2 1473.2 457.7 1469.7 466.8L1445.8 463.9L1419.6 470.6C1415.6 459.7 1412.5 448.6 1410.4 437.3C1409.2 431 1408.3 424.6 1407.8 
            ...
            <path
              className="st57"
              d="M1453.9 464.9L1446.1 464H1446L1433.6 467.2L1442.7 296C1442.9 294.6 1443.1 293.1 1443.3 291.3C1443.7 290.7 1444.3 290.3 1445.1 290.2C1446.4 290.1 1447.6 291.1 
          ...
          <g
            ...
            style={{
              visibility:
                !tooth25Diagnozis.culttab && !tooth25Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            <path
              className="st7 st59"
              d="M1483.27 422.955C1484.95 426.605 1486.62 430.256 1487.8 434.1C1490 441 1490.5 448.3 1489.3 455.4C1487.6 460.3 1485.3 465 1482.5 469.4C1480.03 473.369 1477.17 477.085 1474.33 480.794C1472.8 482.785 1471.27 484.774 1469.8 486.8C1469.75 486.85 
            ...
            />
            <path
              className={`st7 ${tooth25Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
          ...
          >
            <path
              className="st61 level2"
              d="M1404 435.999L1406 434.499L1407.5 431.499L1409 428.999V424.999L1410.5 422.499L1411.5 418.499V416.499L1413 414.999L1414 410.999L1415.5 407.999L1417 405.999V403.999L1419 399.999L1421.5 397.999L1423 395.499L1427 
          ...
          >
            ...
            >
              ...
              <path
                ...
                d="M1468.9,429.6c-0.3,0.8-0.4,6.5-0.3,14.2c-5.1-2-14.7-5-24.4-4.1c-7.2,0.7-17,4.8-22.1,7.1
                                ...
                                c3-0.9,6.2-1.3,9.3-1.1c11.8,0.6,22.2,7.6,27.9,17.7c2.4,4.2,3.8,8.9,5.5,13.4C1475.6,418.5,1469.7,427.6,1468.9,429.6z"
                style={{
                  fill: teethDiagnozis.tooth25.caries_bottom
                    ? '#606c80'
                    : teethDiagnozis.tooth25.seal_bottom
                      ? teethDiagnozis.tooth25.seal_bottom_color
                      : 'transparent',
                }}
              />
            </g>
            ...
            >
              <path
                ...
                style={{
                  fill: teethDiagnozis.tooth25.caries_right
                    ? '#606c80'
                    : teethDiagnozis.tooth25.seal_right
                      ? teethDiagnozis.tooth25.seal_right_color
                      : 'transparent',
                }}
              />
              <path
