...
export default function Tooth47() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth47.caries_bottom =
          !teethDiagnozis.tooth47.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth47.caries_center =
          !teethDiagnozis.tooth47.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth47.caries_left =
          !teethDiagnozis.tooth47.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth47.caries_right =
          !teethDiagnozis.tooth47.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth47.seal_center =
            !teethDiagnozis.tooth47.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth47.seal_bottom =
            !teethDiagnozis.tooth47.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth47.seal_right =
            !teethDiagnozis.tooth47.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth47.wedge_shaped_defect_color =
          !teethDiagnozis.tooth47.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 388.1582 842.0025)"
          className={`st3 st4 st5 ${selectedTooth === 47 ? 'num-active' : ''}`}
        >
          47
        </text>
      </g>
      ...
      >
        <g
          className={`underlay ${selectedTooth === 47 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st24 change-color ${tooth47Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth47Diagnozis?.apex ? 'apex' : ''}`}
          ...
          <g className="pulp">
            <g
              ...
              style={{
                visibility: tooth47Diagnozis?.apex ? 'inherit' : 'hidden',
              }}
            >
              <ellipse
          ...
          <g
            ...
            style={{
              visibility:
                tooth47Diagnozis.implant || tooth47Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            className="abutment"
            style={{
              visibility: tooth47Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth47Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth47Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
            ...
            <circle
              ...
              style={{ fill: 'black', opacity: tooth47Diagnozis.pin ? 1 : 0 }}
            ></circle>
          </g>
          {/* CULTTAB */}
          <g
            className="stump"
            style={{
              visibility: !tooth47Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth47Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: teethDiagnozis.tooth47.tartar ? 1 : 0,
            }}
          >
            <path
            ...
            <g className="with">
              ...
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth47Diagnozis.seal_left &&
                      !tooth47Diagnozis.seal_bottom) ||
                    (!tooth47Diagnozis.seal_left &&
                      tooth47Diagnozis.seal_bottom)
                      ? 5
                      : 0,
          ...
          <g
            ...
            style={{
              visibility:
                tooth47Diagnozis.temporary_crown ||
                tooth47Diagnozis.ceramic_crown ||
                tooth47Diagnozis.mceramic_crown ||
                tooth47Diagnozis.metalic_crown ||
                tooth47Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth47Diagnozis.temporary_crown ||
          ...
          >
            ...
            {/*FISSURE*/}
            <path
              className={`st3 fissure ${tooth47Diagnozis.fissure ? 'diagnoze' : tooth47Diagnozis.fissure ? 'hidden' : ''}`}
          ...
          >
            <path
              className={`st3 fissure ${tooth47Diagnozis.fissure ? 'diagnoze' : ''}`}
              d="M454.1,963.8c-3.8,0.4-7.7,1-11.5,1.8c-2,0.4-4.1,0.8-5.9,0c-0.1,0-0.1-0.1-0.2-0.1
                            c0-0.1,0.1-0.2,0.1-0.3l-1-0.5c0,0.1,0,0.1-0.1,0.2c-0.4-0.3-0.8-0.6-1.1-1c-1-0.9-2.1-1.9-3.5-2.2c-2.3-0.5-4.1,0.8-5.8,2
                            l-0.4,0.3c-1.7,1.2-3.6,2.1-5.4,2.7c-4.2,1.5-8.7,1.3-12.7-0.5c0.3-2.1,0.2-4.2,0-6c-0.1-0.9-0.2-1.9-0.3-2.8
                            c-0.3-2.1-0.5-4.3-0.5-6.5c0-2.7,0.5-5.4,0.9-8c0.5-3.3,1.1-6.6,0.8-10c-0.4-5.3-2.7-10.3-6.4-14l-0.8,0.8
        ...
        >
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth47Diagnozis.change_color ? 'diagnoze' : ''}`}
            ...
            >
              <path
                className={`st10 change-color ${tooth47Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g
            className="stump"
            style={{
              visibility: tooth47Diagnozis.culttab ? 'inherit' : 'hidden',
              opacity: tooth47Diagnozis.culttab ? 1 : 0,
            }}
          >
            <path
              className="st14"
          ...
          <g
            ...
            style={{
              visibility:
                !tooth47Diagnozis.culttab && !tooth47Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            ></path>
            <path
              className={`st7 ${tooth47Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
