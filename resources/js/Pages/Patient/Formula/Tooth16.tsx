...
export default function Tooth16() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth16.caries_bottom =
          !teethDiagnozis.tooth16.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth16.caries_center =
          !teethDiagnozis.tooth16.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth16.caries_left =
          !teethDiagnozis.tooth16.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth16.caries_right =
          !teethDiagnozis.tooth16.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth16.seal_center =
            !teethDiagnozis.tooth16.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth16.seal_bottom =
            !teethDiagnozis.tooth16.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth16.seal_right =
            !teethDiagnozis.tooth16.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth16.wedge_shaped_defect_color =
          !teethDiagnozis.tooth16.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 507.4561 716.1968)"
          className={`st3 st4 st5 ${selectedTooth === 16 ? 'num-active' : ''}`}
        >
          16
        </text>
      </g>
      <g
        id="TH-16"
        className={`f-tooth-init ${(teethDiagnozis.tooth16.show || allTeeth) && !teethDiagnozis.tooth16.absent ? 'f-tooth-active' : ''} adult`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 16 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st24 ${tooth16Diagnozis.apex ? 'apex' : ''}`}
            ...
            <g
              style={{
                visibility:
                  tooth16Diagnozis?.apex || tooth16Diagnozis.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st24 change-color ${tooth16Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth16Diagnozis?.apex ? 'apex' : ''}`}
              ...
              />
              <path
                className={`st53 change-color ${tooth16Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth16Diagnozis?.apex ? 'apex' : ''}`}
          ...
          <g
            className="pulp"
            style={{ visibility: tooth16Diagnozis.apex ? 'inherit' : 'hidden' }}
          >
            <g
              className="pulpitis-pfilling"
              style={{
                visibility: tooth16Diagnozis?.apex ? 'inherit' : 'hidden',
              }}
            >
              <ellipse
          ...
          <g
            ...
            style={{
              visibility:
                tooth16Diagnozis.implant || tooth16Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            ...
            style={{
              visibility: tooth16Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth16Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth16Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
              className="st56 hIntact"
              d="M462 607.201C463.5 603.701 465.3 600.301 466.8 596.901C470.7 
            ...
            <path
              className="st56 hIntact"
              d="M479.403 605.459C480.507 602.888 481.832 600.391 
            ...
            <circle
              ...
              cy="598.001"
              r="12.25"
              style={{ fill: 'black', opacity: tooth16Diagnozis.pin ? 1 : 0 }}
            />
          </g>
          {/* CULTTAB */}
          <g
            ...
            style={{
              visibility: !tooth16Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth16Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            className="tartar"
            style={{
              opacity: teethDiagnozis.tooth16.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="with">
              ...
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth16Diagnozis.seal_left &&
                      !tooth16Diagnozis.seal_top) ||
          ...
          <g
            ...
            style={{
              visibility:
                tooth16Diagnozis.temporary_crown ||
                tooth16Diagnozis.ceramic_crown ||
                tooth16Diagnozis.mceramic_crown ||
                tooth16Diagnozis.metalic_crown ||
                tooth16Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth16Diagnozis.temporary_crown ||
          ...
          >
            ...
            {/*FISSURE*/}
            <path
              className={`st3 fissure ${tooth16Diagnozis.fissure ? 'diagnoze' : tooth16Diagnozis.fissure ? 'hidden' : ''}`}
            ...
            />
            <path
              className={`st3 fissure ${tooth16Diagnozis.fissure ? 'diagnoze' : ''}`}
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth16Diagnozis.change_color ? 'diagnoze' : ''}`}
            ...
            >
              ...
              />
              <path
                className={`st10 change-color ${tooth16Diagnozis?.change_color ? 'diagnoze' : ''}`}
          ...
          >
            <path
              className="st56 hIntact"
              d="M491.7 449.2L519.7 441.1L549 453.1L570.6 450.3L588.9 463.4C594.6 453.7 599 
            ...
            <path
              className="st57"
              d="M534.5 447.099L549.1 453.099L569.9 450.399L560.6 356.299V355.799L552.6 274.599C552.4 
          ...
          <g
            style={{
              visibility: tooth16Diagnozis.culttab ? 'inherit' : 'hidden',
              opacity: tooth16Diagnozis.culttab ? 1 : 0,
            }}
          >
            <path
              className="st14"
          ...
          <g
            ...
            style={{
              visibility:
                !tooth16Diagnozis.culttab && !tooth16Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            />
            <path
              className={`st7 ${tooth16Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
          ...
          >
            <path
              className="st61 level2"
              d="M608 427L606 426V424.5L605 422.5L604 419.5L602.5 417.5V414L599 409.5L597.5 
            ...
            <path
              className="st61 level1"
              d="M608.5 427L606.5 426V424.5L605.5 422.5L604.5 419.5L603 417.5V414L599.5 409.5L598 405L595 403L593.5 
