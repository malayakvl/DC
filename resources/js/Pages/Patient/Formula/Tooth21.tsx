...
export default function Tooth21() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth21.caries_bottom =
          !teethDiagnozis.tooth21.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth21.caries_center =
          !teethDiagnozis.tooth21.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth21.caries_left =
          !teethDiagnozis.tooth21.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth21.caries_right =
          !teethDiagnozis.tooth21.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth21.seal_center =
            !teethDiagnozis.tooth21.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth21.seal_bottom =
            !teethDiagnozis.tooth21.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth21.seal_right =
            !teethDiagnozis.tooth21.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth21.wedge_shaped_defect_color =
          !teethDiagnozis.tooth21.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
    ...
    <>
      ...
      >
        <text
          ...
          className={`st3 st4 st5 ${selectedTooth === 21 ? 'num-active' : ''}`}
        >
          21
        </text>
      </g>
      <g
        id="TH-21"
        className={`f-tooth-init ${(teethDiagnozis.tooth21.show || allTeeth) && !teethDiagnozis.tooth21.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 21 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          ...
          <g className="dentin">
            <g
              style={{
                visibility:
                  !tooth21Diagnozis.culttab &&
                  !tooth21Diagnozis.implant &&
                  !tooth21Diagnozis.shaper
                    ? 'inherit'
                    : 'hidden',
              }}
            >
            ...
            <g
              style={{
                visibility:
                  tooth21Diagnozis?.apex || tooth21Diagnozis.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st24 change-color ${tooth21Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth21Diagnozis?.apex ? 'apex' : ''}`}
          ...
          <g
            className="pulp"
            style={{ visibility: tooth21Diagnozis.apex ? 'inherit' : 'hidden' }}
          >
            <g
              className="pulpitis-pfilling"
              style={{
                visibility: tooth21Diagnozis?.apex ? 'inherit' : 'hidden',
              }}
            >
              <path
                className="st22 target"
                style={{ fill: '#e80808' }}
                d="M1108.34 604.016C1108.25 605.739 1106.79 606.641 1104.18 608.969C1102.27 610.67 1101.63 612.996 1099.21 613.014C1096.62 613.033 1095.93 610.273 1094.27 608.421C1092.29 606.198 1090.54 605.623 1090.66 603.47C1090.78 601.317 1094.18 600.785 1099.89 600.743C1105.61 600.701 1108.47 601.65 1108.34 604.016Z"
              ></path>
            </g>
          </g>
          {/* IMPLANT/CULTTAB */}
          <g
            style={{
              visibility:
                tooth21Diagnozis.implant || tooth21Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            <g className="st27">
              <mask id="implant_21" className="st49">
                <path
                  className="st50"
                  d="M1087.39 590.223L1084.32 589.223C1081.71 591.85 1079.77 595.141 1078.77 598.821L1081.17 600.981C1080.96 602.121 1080.84 603.298 1080.84 604.5C1080.84 605.703 1080.96 606.88 1081.17 608.02L1078.77 
              ...
              <path
                className="st50 st51"
                d="M1087.39 590.223L1084.32 589.223C1081.71 591.85 1079.77 595.141 1078.77 598.821L1081.17 600.981C1080.96 602.121 1080.84 603.298 1080.84 604.5C1080.84 605.703 1080.96 606.88 1081.17 608.02L1078.77 610.18C1079.77 
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth21Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
            ...
            <circle
              ...
              r="12.25"
              transform="matrix(-1 0 0 1 1100 605)"
              style={{ fill: 'black', opacity: tooth21Diagnozis.pin ? 1 : 0 }}
            />
          </g>
          {/* CULTTAB */}
          <g
            ...
            style={{
              visibility: !tooth21Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth21Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility:
                !tooth21Diagnozis.culttab &&
                !tooth21Diagnozis.abutment &&
                !tooth21Diagnozis.implant &&
                !tooth21Diagnozis.apex &&
                !tooth21Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
            ...
            <g className="with">
              ...
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth21Diagnozis.seal_right &&
                      !tooth21Diagnozis.seal_bottom &&
                      !tooth21Diagnozis.seal_center) ||
                    (tooth21Diagnozis.seal_bottom &&
                      !tooth21Diagnozis.seal_center &&
                      !tooth21Diagnozis.seal_left &&
                      !tooth21Diagnozis.seal_right &&
                      tooth21Diagnozis.seal_top) ||
                    (!tooth21Diagnozis.seal_right &&
                      !tooth21Diagnozis.seal_top &&
                      !tooth21Diagnozis.seal_center &&
                      tooth21Diagnozis.seal_bottom)
          ...
          <g
            ...
            style={{
              visibility:
                tooth21Diagnozis.temporary_crown ||
                tooth21Diagnozis.ceramic_crown ||
                tooth21Diagnozis.mceramic_crown ||
                tooth21Diagnozis.metalic_crown ||
                tooth21Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth21Diagnozis.temporary_crown ||
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth21Diagnozis.change_color ? 'diagnoze' : ''}`}
            ...
            >
              <path
                id="dentin_n_21"
                className={`st10 change-color ${tooth21Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g className="pulp">
            <g>
              <path
                className={`st22 target top ${tooth21Diagnozis.channel_class} ${tooth21Diagnozis.channel_class} ${tooth21Diagnozis.pulpit ? 'pulpit' : ''} ${tooth21Diagnozis.periodontit ? 'periodontit' : ''}`}
          ...
          >
            <path
              className="st56 hIntact"
              d="M1144.32 447.499C1143.82 461.699 1142.02 475.899 1138.92 489.799L1137.42 491.499L1134.92 493.099C1131.92 493.399 1128.92 493.699 1125.92 493.899C1123.72 494.099 1121.52 494.299 1119.32 494.399C1103.02 495.599 1086.72 496.099 1070.42 
            ...
            <path
              className="st57"
              d="M1116.62 301.799L1113.72 494.799H1113.62C1104.12 495.399 1094.62 495.799 1085.22 495.899L1109.02 301.099C1109.22 300.199 1109.62 
          ...
          >
            <path
              className="st16"
              d="M1116.4,301.8l-1.6,104c-0.2-0.1-0.5-0.1-0.7-0.2c-0.2-0.1-0.4-0.1-0.7-0.1c0,0,0,0,0,0
            ...
            <path
              className="st15"
              d="M1144.3,447.5C1144.3,447.5,1144.3,447.5,1144.3,447.5c-0.5,14.2-2.3,28.4-5.4,42.3l-1.5,1.7l-2.5,1.6
          ...
          >
            <path
              className="st30"
              d="M1058.6,442.1c4-6.4,12.9-21.1,16.6-24.4c5.5-4.8,12-8.5,19-10.7c8.8-2.8,18.5-3.1,26.7,1.1
                            c4.2,2.2,20.7,36.1,23.5,39.8l-2.7-10l-19.3-39.2l-36.3-3.4l-27.2,43C1058.8,438.4,1058.1,442.8,1058.6,442.1z"
            />
            <path
              className="st33"
              d="M1058.5,464.5c0.6,9.1,1.5,18.3,2.8,27.3l2.2,2.9l2.7,1.2c17.7,0.4,35.4-0.1,53.1-1.4
          ...
          >
            <path
              className="st44"
              d="M1074.36 433.822C1073.78 436.197 1075.44 438.538 1077.88 438.764L1119.15 442.601C1121.59 442.827 1123.65 440.834 1123.52 438.393L1121.27 398.596C1121.16 396.614 1119.61 395.013 1117.63 394.837L1088.14 392.209C1086.17 392.033 1084.37 393.318 1083.9 395.233L1074.36 433.822Z"
            ></path>
          </g>
          {/* IMPLANT/CULTTAB */}
          <g
          ...
          >
            <path
              className="st18"
              d="M1079.1,395.2l46.5,3.6c1.7-24.7,2.9-49.4,3.5-74.1c0.6-24,0.6-47.9,0.1-71.8c-3.4-4.6-8.5-7.5-14.1-8
          ...
          <g
            ...
            style={{
              visibility:
                !tooth21Diagnozis.culttab && !tooth21Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            >
              ...
              <path
                ...
                d="M1069.1,527.6c-4.3,0-8.6-0.2-12.9-0.3l-2.9-1.2c-1-1.1-1.8-2.3-2.4-3.6c-0.7-1.5-1.1-3.1-1.2-4.7
                                ...
                                C1071.2,458.9,1069.6,511.2,1069.1,527.6z"
                style={{
                  fill: teethDiagnozis.tooth21.caries_left
                    ? '#606c80'
                    : teethDiagnozis.tooth21.seal_left
                      ? teethDiagnozis.tooth21.seal_left_color
                      : 'transparent',
                }}
              />
            </g>
            ...
            >
              ...
              <path
                ...
                d="M1148,501.4c-0.5,3.6-1.1,7.1-2,10.6c-1.7,3.4-4.1,6.3-7,8.7c-2.3,1.9-4.8,3.4-7.6,4.4
                                ...
                                C1148.8,478.7,1149.5,490.1,1148,501.4z"
                style={{
                  fill: teethDiagnozis.tooth21.caries_right
                    ? '#606c80'
                    : teethDiagnozis.tooth21.seal_right
                      ? teethDiagnozis.tooth21.seal_right_color
                      : 'transparent',
                }}
              />
            </g>
            ...
            >
              ...
              <path
                ...
                d="M1143.8,447.1c-5.1,3.7-14.3,10.7-14.8,13.2c-0.6,2.9-4.9,48.3-6.5,65.6c-7.5,0.6-15,1-22.6,1.3
                                ...
                                C1140.4,434.9,1142.4,441,1143.8,447.1z"
                style={{
                  fill: teethDiagnozis.tooth21.caries_top
                    ? '#606c80'
                    : teethDiagnozis.tooth21.seal_top
                      ? teethDiagnozis.tooth21.seal_top_color
                      : 'transparent',
                }}
              />
            </g>
