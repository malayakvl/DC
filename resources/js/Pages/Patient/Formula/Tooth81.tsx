...
export default function Tooth81() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth81.caries_bottom =
          !teethDiagnozis.tooth81.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth81.caries_center =
          !teethDiagnozis.tooth81.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth81.caries_left =
          !teethDiagnozis.tooth81.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth81.caries_right =
          !teethDiagnozis.tooth81.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth81.seal_center =
            !teethDiagnozis.tooth81.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth81.seal_bottom =
            !teethDiagnozis.tooth81.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth81.seal_right =
            !teethDiagnozis.tooth81.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth81.wedge_shaped_defect_color =
          !teethDiagnozis.tooth81.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  const showHideOverlay = type => {
    if (type === 'over' && !excludeToothEffect.includes(diagnozis)) {
      if (
        teethType === 'child' &&
        !teethDiagnozis.tooth81.show &&
        !teethDiagnozis.tooth41.show
      ) {
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 995 842)"
          className={`st3 st4 st5 ${selectedTooth === 81 ? 'num-active' : ''}`}
        >
          81
        </text>
      </g>
      <g
        id="TH-81"
        className={`f-tooth-init-milk ${teethType} ${(teethDiagnozis.tooth81.show || allTeeth) && !teethDiagnozis.tooth81.absent ? 'f-tooth-active' : ''}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 81 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        <g
          ...
          style={{
            visibility: 'inherit',
            transform: 'matrix(0.55, 0, 0, 0.55, 17, -6)',
          }}
          onMouseOver={() => {
        ...
        >
          <g className="dentin">
            <g
              style={{
                visibility:
                  !tooth81Diagnozis.culttab &&
                  !tooth81Diagnozis.implant &&
                  !tooth81Diagnozis.shaper
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st6 change-color ${tooth81Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth81Diagnozis?.apex ? 'apex' : ''}`}
            ...
            <g
              style={{
                visibility:
                  tooth81Diagnozis?.apex || tooth81Diagnozis.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
          ...
          <g
            className="pulp"
            style={{ visibility: tooth81Diagnozis.apex ? 'inherit' : 'hidden' }}
          >
            <g>
              <path
          ...
          <g
            ...
            style={{
              visibility:
                tooth81Diagnozis.implant || tooth81Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            ...
            style={{
              visibility: tooth81Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth81Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth81Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
            ...
            <circle
              ...
              cy="983"
              r="12.25"
              style={{ fill: 'black', opacity: tooth81Diagnozis.pin ? 1 : 0 }}
            ></circle>
          </g>
          {/* CULTTAB */}
          <g
            ...
            style={{
              visibility: !tooth81Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth81Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility:
                !tooth81Diagnozis.culttab &&
                !tooth81Diagnozis.abutment &&
                !tooth81Diagnozis.implant &&
                !tooth81Diagnozis.apex &&
                !tooth81Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          ...
          <g
            className="tartar"
            style={{
              opacity: teethDiagnozis.tooth81.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="with">
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth81Diagnozis.seal_left &&
                      !tooth81Diagnozis.seal_center) ||
                    (!tooth81Diagnozis.seal_left &&
                      tooth81Diagnozis.seal_center)
                      ? 5
                      : 0,
          ...
          >
            ...
            >
              <path
                className={`vinir-fill ${tooth81Diagnozis.vinir_color}`}
          ...
          <g
            ...
            style={{
              visibility:
                tooth81Diagnozis.temporary_crown ||
                tooth81Diagnozis.ceramic_crown ||
                tooth81Diagnozis.mceramic_crown ||
                tooth81Diagnozis.metalic_crown ||
                tooth81Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth81Diagnozis.temporary_crown ||
        ...
        <g
          ...
          style={{
            visibility: 'inherit',
            transform: 'matrix(0.55, 0, 0, 0.55, 21, -19)',
          }}
          onMouseOver={() => {
            showHideTopCommonView('over');
          }}
        ...
        >
          <g className="dentin">
            ...
            >
              <path
                className={`st10 change-color ${tooth81Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g className="pulp">
            <g>
              <path
                className={`st22 target top ${tooth81Diagnozis.channel_class} ${tooth81Diagnozis.channel_class} ${tooth81Diagnozis.pulpit ? 'pulpit' : ''} ${tooth81Diagnozis.periodontit ? 'periodontit' : ''}`}
          ...
          >
            ...
            <path
              className="st57"
              style={{ fill: tooth81Diagnozis.pin ? '#dbd9d3' : 'none' }}
          ...
          <g
            ...
            style={{
              visibility:
                !tooth81Diagnozis.culttab && !tooth81Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            ></path>
            <path
              className={`st7 ${tooth81Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
