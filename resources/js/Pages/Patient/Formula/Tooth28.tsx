...
export default function Tooth28() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth28.caries_bottom =
          !teethDiagnozis.tooth28.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth28.caries_center =
          !teethDiagnozis.tooth28.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth28.caries_left =
          !teethDiagnozis.tooth28.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth28.caries_right =
          !teethDiagnozis.tooth28.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth28.seal_center =
            !teethDiagnozis.tooth28.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth28.seal_bottom =
            !teethDiagnozis.tooth28.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth28.seal_right =
            !teethDiagnozis.tooth28.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth28.wedge_shaped_defect_color =
          !teethDiagnozis.tooth28.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 1809.8652 716.1968)"
          className={`st3 st4 st5 ${selectedTooth === 28 ? 'num-active' : ''}`}
        >
          28
        </text>
      </g>
      <g
        id="TH-28"
        className={`f-tooth-init ${(teethDiagnozis.tooth28.show || allTeeth) && !teethDiagnozis.tooth28.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 28 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st24 ${tooth28Diagnozis.apex ? 'apex' : ''}`}
            ...
            <g
              ...
              style={{
                visibility:
                  tooth28Diagnozis?.apex || tooth28Diagnozis?.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st24 change-color ${tooth28Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth28Diagnozis?.apex ? 'apex' : ''}`}
          ...
          <g
            className="pulp"
            style={{ visibility: tooth28Diagnozis.apex ? 'inherit' : 'hidden' }}
          >
            <g
              className="pulpitis-pfilling"
              style={{
                visibility: tooth28Diagnozis?.apex ? 'inherit' : 'hidden',
              }}
            >
              <ellipse
                ...
                rx="7.15314"
                ry="5.64935"
                transform="rotate(-0.796347 1820.91 609.563)"
                style={{ fill: '#e80808' }}
              />
              <ellipse
                className="st22 target"
                ...
                rx="6.89579"
                ry="6.05115"
                transform="rotate(39.2014 1836.57 592.048)"
                style={{ fill: '#e80808' }}
              />
              <ellipse
                className="st22 target"
                ...
                rx="6.88191"
                ry="5.68612"
                transform="rotate(-49.1967 1805.94 589.924)"
                style={{ fill: '#e80808' }}
              />
            </g>
          </g>
          ...
          <g
            ...
            style={{
              visibility:
                tooth28Diagnozis.implant || tooth28Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            <g className="st27">
              <mask id="implant_28" className="st49">
                <path
                  className="st50"
                  d="M1806.9 582.474L1803.46 581.352C1800.53 584.3 1798.35 587.994 1797.23 592.124L1799.93 594.55C1799.69 595.829 1799.56 597.15 1799.56 598.5C1799.56 599.85 1799.69 601.17 1799.93 602.45L1797.23 604.875C1798.35 609.006 1800.53 612.7 1803.46 615.648L1806.91 614.525C1808.9 616.242 1811.21 617.594 1813.74 618.478L1814.49 622.024C1816.48 622.548 1818.56 622.827 1820.71 622.827C1822.86 622.827 1824.95 622.548 1826.94 622.024L1827.69 618.477C1830.22 617.593 1832.53 616.241 1834.52 614.525L1837.97 615.647C1840.9 612.699 1843.08 609.004 1844.2 604.874L1841.5 602.448C1841.74 601.169 1841.87 599.849 1841.87 598.5C1841.87 597.15 1841.74 595.831 1841.5 594.552L1844.2 592.126C1843.08 587.995 1840.9 584.301 1837.97 581.352L1834.52 582.475C1832.53 580.758 1830.22 579.406 1827.69 578.522L1826.94 574.976C1824.95 574.452 1822.86 574.173 1820.71 574.173C1818.56 574.173 1816.48 574.452 1814.49 574.975L1813.74 578.521C1811.21 579.405 1808.9 580.758 1806.9 582.474Z"
                ></path>
              </mask>
              <path
                className="st50 st51"
          ...
          <g
            ...
            style={{
              visibility: tooth28Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth28Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
              d="M1869.83 594.999C1868.13 586.399 1863.33 578.799 1854.83 573.199C1844.83 566.499 1831.43 563.899 1818.13 562.899C1806.93 562.099 1795.03 562.599 1787.23 568.499C1781.83 572.499 1779.83 578.299 1778.63 583.899C1777.53 589.599 1777.23 595.499 1777.33 601.299C1777.53 606.999 1778.13 612.899 1781.83 617.999C1785.73 623.499 1792.53 627.399 1800.13 629.999C1823.63 638.099 1851.53 633.699 1864.33 617.599C1869.83 610.899 1871.43 602.899 1869.83 594.999Z"
            ></path>
            <path
              className="st47"
              d="M1853.36 596.429C1852.28 591.006 1849.24 586.213 1843.85 582.682C1837.51 578.457 1829.02 576.817 1820.59 576.187C1813.5 575.682 1805.96 575.997 1801.01 579.718C1797.59 582.24 1796.32 585.898 1795.56 589.429C1794.87 593.024 1794.68 596.744 1794.74 600.402C1794.87 603.996 1795.25 607.717 1797.59 610.933C1800.06 614.401 1804.37 616.861 1809.19 618.5C1824.08 623.608 1841.76 620.833 1849.87 610.681C1853.36 606.456 1854.37 601.411 1853.36 596.429Z"
            ></path>
            <circle
              className="st45"
              r="13"
              transform="matrix(-1 0 0 1 1818.73 598)"
            ></circle>
          </g>
          {/* PIN */}
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth28Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
            ...
            <path
              className="st56 hIntact"
              d="M1853.35 596.429C1852.27 591.006 1849.23 586.213 1843.85 582.682C1837.51 578.457 1829.02 576.817 1820.59 576.187C1813.49 575.682 1805.95 575.997 1801.01 579.718C1797.59 582.24 1796.32 585.898 1795.56 589.429C1794.86 593.024 1794.67 596.744 1794.74 600.402C1794.86 603.996 1795.24 607.717 1797.59 610.933C1800.06 614.401 1804.37 616.861 1809.18 618.5C1824.08 623.608 1841.76 620.833 1849.87 610.681C1853.35 606.456 1854.37 601.411 1853.35 596.429Z"
              style={{ visibility: 'hidden' }}
            ></path>
            <circle
              className="st57"
              r="12.25"
              transform="matrix(-1 0 0 1 1818.73 598)"
              style={{ fill: 'black', opacity: tooth28Diagnozis.pin ? 1 : 0 }}
            />
          </g>
          {/* CULTTAB */}
          <g
            ...
            style={{
              visibility: !tooth28Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth28Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
            ...
            <g className="with">
              ...
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth28Diagnozis.seal_right &&
                      !tooth28Diagnozis.seal_top) ||
          ...
          <g
            ...
            style={{
              visibility:
                tooth28Diagnozis.temporary_crown ||
                tooth28Diagnozis.ceramic_crown ||
                tooth28Diagnozis.mceramic_crown ||
                tooth28Diagnozis.metalic_crown ||
                tooth28Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth28Diagnozis.temporary_crown ||
          ...
          >
            ...
            {/*FISSURE*/}
            <path
              className={`st3 fissure ${tooth28Diagnozis.fissure ? 'diagnoze' : tooth28Diagnozis.fissure ? 'hidden' : ''}`}
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth28Diagnozis.change_color ? 'diagnoze' : ''}`}
            ...
            >
              <path
                className={`st10 change-color ${tooth28Diagnozis?.change_color ? 'diagnoze' : ''}`}
          ...
          >
            ...
            <path
              className="st57"
              d="M1839.1 403.1C1836.6 404.2 1834.3 405.8 1832 407.3C1827.9 410 1823.6 412.6 1819.2 414.9C1818.2 413.7 1817.1 412.6 1815.8 411.6C1815.3 411.2 1813.1 409.7 1812.6 409.4L1813.3 276.8C1813.3 276.1 1813.8 275.6 1814.3 275.3C1814.5 275.2 1814.8 275.1 1815 275.1C1815.8 275.1 1816.5 275.7 1816.7 
          ...
          <g
            className="stump hEmpty hIntact hImplant"
            style={{
              visibility: tooth28Diagnozis.culttab ? 'inherit' : 'hidden',
              opacity: tooth28Diagnozis.culttab ? 1 : 0,
            }}
          >
            <path
              className="st14"
          ...
          <g
            ...
            style={{
              visibility:
                !tooth28Diagnozis.culttab && !tooth28Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            />
            <path
              className={`st7 ${tooth28Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
