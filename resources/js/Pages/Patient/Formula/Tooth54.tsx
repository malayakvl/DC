...
export default function Tooth54() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth54.caries_bottom =
          !teethDiagnozis.tooth54.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth54.caries_center =
          !teethDiagnozis.tooth54.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth54.caries_left =
          !teethDiagnozis.tooth54.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth54.caries_right =
          !teethDiagnozis.tooth54.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth54.seal_center =
            !teethDiagnozis.tooth54.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth54.seal_bottom =
            !teethDiagnozis.tooth54.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth54.seal_right =
            !teethDiagnozis.tooth54.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth54.wedge_shaped_defect_color =
          !teethDiagnozis.tooth54.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  const showHideOverlay = type => {
    if (type === 'over') {
      if (
        teethType === 'child' &&
        !teethDiagnozis.tooth54.show &&
        !teethDiagnozis.tooth14.show
      ) {
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 720 716)"
          className={`st3 st4 st5 ${selectedTooth === 54 ? 'num-active' : ''}`}
        >
          54
        </text>
      </g>
      <g
        id="TH-54"
        className={`f-tooth-init-milk ${(teethDiagnozis.tooth54.show || allTeeth) && !teethDiagnozis.tooth54.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 54 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        <g
          ...
          style={{
            visibility: 'inherit',
            transform: 'matrix(0.55, 0, 0, 0.55, 244, 33)',
          }}
          onMouseOver={() => {
            showHideOverlay('over');
          }}
        ...
        >
          ...
          <g className="dentin">
            <g
              ...
              style={{
                visibility:
                  !tooth54Diagnozis.culttab &&
                  !tooth54Diagnozis.implant &&
                  !tooth54Diagnozis.shaper
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st24 change-color ${tooth54Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth54Diagnozis?.apex ? 'apex' : ''}`}
            ...
            >
              <path
                className={`st24 ${tooth54Diagnozis.apex ? 'apex' : ''}`}
          ...
          <g
            ...
            style={{
              visibility:
                tooth54Diagnozis.apex || tooth54Diagnozis.pulpit
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            ...
            style={{
              visibility:
                tooth54Diagnozis.implant || tooth54Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            className="abutment"
            style={{
              visibility: tooth54Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth54Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth54Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
          ...
          <g
            ...
            style={{
              visibility: !tooth54Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth54Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            style={{
              visibility:
                !tooth54Diagnozis.culttab &&
                !tooth54Diagnozis.abutment &&
                !tooth54Diagnozis.implant &&
                !tooth54Diagnozis.apex &&
                !tooth54Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          ...
          <g
            className="tartar"
            style={{
              opacity: teethDiagnozis.tooth54.tartar ? 1 : 0,
              visibility: 'inherit',
            }}
          >
            <path
            ...
            <g className="with">
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth54Diagnozis.seal_left &&
                      !tooth54Diagnozis.seal_bottom) ||
                    (!tooth54Diagnozis.seal_left &&
                      tooth54Diagnozis.seal_bottom)
                      ? 5
                      : 0,
              ...
              <path
                className="st54"
                d="M488.5 621C483 612 482.8 583.5 496 573.5"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth54Diagnozis.seal_left &&
                      !tooth54Diagnozis.seal_center) ||
                    (!tooth54Diagnozis.seal_left &&
                      tooth54Diagnozis.seal_center)
                      ? 5
                      : 0,
              ...
              <path
                className="st54"
                d="M496 574C509 566.5 566.6 565.2 573 576"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth54Diagnozis.seal_center &&
              ...
              <path
                className="st54"
                d="M560.5 624C561.833 628.167 567.8 639 581 649"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth54Diagnozis.seal_right &&
              ...
              <path
                className="st54"
                d="M560.5 624C550.5 630 505.6 631.5 488 621.5"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth54Diagnozis.seal_center &&
          ...
          <g>
            ...
            >
              <path
                className={`vinir-fill ${tooth54Diagnozis.vinir_color}`}
          ...
          <g
            ...
            style={{
              visibility:
                tooth54Diagnozis.temporary_crown ||
                tooth54Diagnozis.ceramic_crown ||
                tooth54Diagnozis.mceramic_crown ||
                tooth54Diagnozis.metalic_crown ||
                tooth54Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth54Diagnozis.temporary_crown ||
          ...
          >
            ...
            {/*FISSURE*/}
            <path
              className={`st3 fissure ${tooth54Diagnozis.fissure ? 'diagnoze' : tooth54Diagnozis.fissure ? 'hidden' : ''}`}
          ...
          >
            <path
              className={`st3 fissure ${tooth54Diagnozis.fissure ? 'diagnoze' : ''}`}
              d="M596.6,579.3l-19.1,13.1c-6.9-0.2-13.8,0-20.6,0.7c-8.2,0.9-14.7,2.2-20.5,4.3c-8.6,3.2-16.4,8.4-22.6,15.1
                            c-0.4-0.6-0.8-1.1-1.3-1.6l-0.5,0.5c-4.2-2.7-8.5-5.3-12.8-7.8l-1.2-0.7c-4.2-2.4-8.6-4.9-12-8.3c-2.9-2.9-5.3-6.4-6.7-10.2
                            l-1,0.4c1.5,3.9,3.9,7.6,7,10.6c3.6,3.5,8,6,12.3,8.4l1.2,0.7c4.9,2.8,9.9,5.8,14.6,8.9c0,0,0,0,0,0.1c2.3,3.4,2.9,7.5,3.5,11.8
                            c0.2,1.5,0.4,3,0.7,4.5c1.3,6.9,4.5,13.4,9.2,18.7l0.8-0.7c-4.6-5.2-7.7-11.5-9-18.2c-0.3-1.5-0.5-3-0.7-4.4
        ...
        <g
          ...
          style={{
            visibility: 'inherit',
            transform: 'matrix(0.55, 0, 0, 0.55, 234, 96)',
          }}
          onMouseOver={() => {
        ...
        >
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth54Diagnozis.change_color ? 'diagnoze' : ''}`}
            ...
            >
              <path
                className={`st10 change-color ${tooth54Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g className="pulp">
            ...
            >
              <path
                className={`st22 target top ${tooth54Diagnozis.channel_class} ${tooth54Diagnozis.channel_class} ${tooth54Diagnozis.pulpit ? 'pulpit' : ''} ${tooth54Diagnozis.periodontit ? 'periodontit' : ''}`}
            ...
            >
              <path
                className={`st22 target middle ${tooth54Diagnozis.channel_class} ${tooth54Diagnozis.channel_class} ${tooth54Diagnozis.pulpit ? 'pulpit' : ''} ${tooth54Diagnozis.periodontit ? 'periodontit' : ''}`}
          ...
          <g
            className="stump hEmpty hIntact hImplant"
            style={{
              visibility: tooth54Diagnozis.culttab ? 'inherit' : 'hidden',
              opacity: tooth54Diagnozis.culttab ? 1 : 0,
            }}
          >
            <path
              className="st14"
          ...
          >
            <path
              className="st16"
              d="M606.5,406.4c-4.7-3.8-18.2-15.1-23.7-17.9c-20.6-10.8-45-14.3-68.3-10.7c-9.9,1.5-19.4,4.3-28.1,8.3
                            l50.7-25.9l30.1,1.8L606.5,406.4z"
            />
            <path
              className="st17"
              d="M606.8,408.2c-1.3,8.2-2.7,16.4-4.9,24.5c-2.9,10.7-7.3,21-13,30.7l-18.3-13.1l-21.6,2.8l-29.3-12l-28,8.1
          ...
          >
            <path
              className="st18"
              d="M575.8,367.1l-55.5-2.2c1.5-16.9,3.8-33.7,6.9-50.5c3-16.4,6.9-32.7,11.4-48.9c4-3.6,9.9-5.7,16-5.4
          ...
          <g
            ...
            style={{
              visibility:
                !tooth54Diagnozis.culttab && !tooth54Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          >
            ...
            <g className="with">
              ...
              <path
                className="st54"
                d="M578.5 440.499L567.5 476.499"
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth54Diagnozis.seal_right &&
