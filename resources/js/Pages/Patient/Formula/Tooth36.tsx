...
export default function Tooth36() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth36.caries_bottom =
          !teethDiagnozis.tooth36.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth36.caries_center =
          !teethDiagnozis.tooth36.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth36.caries_left =
          !teethDiagnozis.tooth36.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth36.caries_right =
          !teethDiagnozis.tooth36.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth36.seal_center =
            !teethDiagnozis.tooth36.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth36.seal_bottom =
            !teethDiagnozis.tooth36.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth36.seal_right =
            !teethDiagnozis.tooth36.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth36.wedge_shaped_defect_color =
          !teethDiagnozis.tooth36.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 1514.875 842.0025)"
          className={`st3 st4 st5 ${selectedTooth === 36 ? 'num-active' : ''}`}
        >
          36
        </text>
      </g>
      <g
        id="TH-36"
        className={`f-tooth-init ${(teethDiagnozis.tooth36.show || allTeeth) && !teethDiagnozis.tooth36.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 36 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth36Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g
            ...
            style={{
              visibility:
                tooth36Diagnozis.apex || tooth36Diagnozis.pulpit
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            style={{
              visibility:
                tooth36Diagnozis.implant || tooth36Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            className="abutment"
            style={{
              visibility: tooth36Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth36Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth36Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
            ...
            <circle
              ...
              r="12.25"
              transform="matrix(-1 0 0 1 1538.78 979)"
              style={{ fill: 'black', opacity: tooth36Diagnozis.pin ? 1 : 0 }}
            ></circle>
          </g>
          {/* CULTTAB */}
          <g
            className="stump"
            style={{
              visibility: !tooth36Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth36Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: teethDiagnozis.tooth36.tartar ? 1 : 0,
            }}
          >
            <path
            ...
            <g className="with up">
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth36Diagnozis.seal_right &&
                      !tooth36Diagnozis.seal_bottom) ||
                    (!tooth36Diagnozis.seal_right &&
                      tooth36Diagnozis.seal_bottom)
                      ? 5
                      : 0,
          ...
          <g
            ...
            style={{
              visibility:
                tooth36Diagnozis.temporary_crown ||
                tooth36Diagnozis.ceramic_crown ||
                tooth36Diagnozis.mceramic_crown ||
                tooth36Diagnozis.metalic_crown ||
                tooth36Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth36Diagnozis.temporary_crown ||
          ...
          >
            <path
              className={`st3 fissure ${tooth36Diagnozis.fissure ? 'diagnoze' : ''}`}
              d="M1573.3,1010.1c0.1-2.1,0.2-4.2-0.6-6.2c-1.1-3-3.6-4.9-6.1-6.7c-0.8-0.6-1.7-1.3-2.5-1.9
                            c-2.4-2-4.3-4.6-5.6-7.5c2.6-0.4,4.7-2.1,6.7-3.9c5.4-4.7,11.1-9,17-12.9l-0.6-0.9c-5.9,4-11.7,8.3-17.2,13.1
                            c-1.9,1.6-3.9,3.3-6.3,3.6c-2.7,0.3-5.3-1.3-7.7-2.9l-0.5-0.3c-5.6-3.6-11.7-6.3-18.1-8.1l-0.1,0c0.3-3.3-0.1-6.1-1.2-8.4
                            c-0.3-0.7-0.7-1.3-1-1.9c-0.9-1.6-1.7-3-1.6-4.8c0.2-1.8,1.4-3.1,2.7-4.5c0.9-1,1.9-2,2.5-3.3c1.7-3.4,0.5-7-0.6-10.5
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                id="dentin_n_35"
                className={`st10 change-color ${tooth36Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g
            style={{
              visibility: tooth36Diagnozis.culttab ? 'inherit' : 'hidden',
              opacity: tooth36Diagnozis.culttab ? 1 : 0,
            }}
          >
            <path
              className="st14"
          ...
          <g
            ...
            style={{
              visibility:
                !tooth36Diagnozis.culttab && !tooth36Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            ></path>
            <path
              className={`st7 ${tooth36Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
