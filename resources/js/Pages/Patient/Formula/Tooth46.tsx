...
export default function Tooth46() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth46.caries_bottom =
          !teethDiagnozis.tooth46.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth46.caries_center =
          !teethDiagnozis.tooth46.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth46.caries_left =
          !teethDiagnozis.tooth46.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth46.caries_right =
          !teethDiagnozis.tooth46.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth46.seal_center =
            !teethDiagnozis.tooth46.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth46.seal_bottom =
            !teethDiagnozis.tooth46.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth46.seal_right =
            !teethDiagnozis.tooth46.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth46.wedge_shaped_defect_color =
          !teethDiagnozis.tooth46.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 542.1611 842.0025)"
          className={`st3 st4 st5 ${selectedTooth === 46 ? 'num-active' : ''}`}
        >
          46
        </text>
      </g>
      <g
        id="TH-46"
        className={`f-tooth-init ${(teethDiagnozis.tooth46.show || allTeeth) && !teethDiagnozis.tooth46.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 46 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st9 change-color ${tooth46Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g
            ...
            style={{
              visibility:
                tooth46Diagnozis.apex || tooth46Diagnozis.pulpit
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            style={{
              visibility:
                tooth46Diagnozis.implant || tooth46Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g
            className="abutment"
            style={{
              visibility: tooth46Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth46Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: tooth46Diagnozis.pin ? 1 : 0,
            }}
          >
            <path
            ...
            <circle
              ...
              cy="979"
              r="12.25"
              style={{ fill: 'black', opacity: tooth46Diagnozis.pin ? 1 : 0 }}
            ></circle>
          </g>
          {/* CULTTAB */}
          <g
            className="stump"
            style={{
              visibility: !tooth46Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth46Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility: 'inherit',
              opacity: teethDiagnozis.tooth46.tartar ? 1 : 0,
            }}
          >
            <path
            ...
            <g className="with">
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth46Diagnozis.seal_left &&
                      !tooth46Diagnozis.seal_bottom) ||
                    (!tooth46Diagnozis.seal_left &&
                      tooth46Diagnozis.seal_bottom)
                      ? 5
                      : 0,
          ...
          <g
            ...
            style={{
              visibility:
                tooth46Diagnozis.temporary_crown ||
                tooth46Diagnozis.ceramic_crown ||
                tooth46Diagnozis.mceramic_crown ||
                tooth46Diagnozis.metalic_crown ||
                tooth46Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth46Diagnozis.temporary_crown ||
          ...
          >
            <path
              className={`st3 fissure ${tooth46Diagnozis.fissure ? 'diagnoze' : ''}`}
              d="M613.8,968.6c-4.5,0.5-8.6,2.8-11.3,6.4c-0.8,1.1-1.6,2.3-2.3,3.5c-2,3.2-3.8,6.3-7.3,6.6
                            c-2.2,0.2-4.2-0.9-6.2-2l-0.4-0.2c-6-3.3-12.3-5.7-18.9-7.2c-0.3-3.3,0-6,1-8.2c0.3-0.6,0.6-1.2,1-1.8c0.9-1.6,1.9-3.3,1.7-5.4
                            c-0.2-2.2-1.6-3.7-3-5.2c-0.9-0.9-1.8-1.9-2.4-3c-1.5-3-0.4-6.4,0.7-9.7c0.2-0.6,0.4-1.2,0.6-1.8c1.2-3.8,1.7-7.8,1.5-11.8
                            l-1.1,0.1c0.2,3.9-0.3,7.7-1.4,11.4c-0.2,0.6-0.4,1.2-0.6,1.8c-1.1,3.5-2.3,7.1-0.6,10.5c0.6,1.3,1.6,2.3,2.5,3.3
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                id="dentin_v_46"
                className={`change-color ${tooth46Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          >
            ...
            <path
              className="st57"
              d="M547 1128.2L484.2 1247.7L483.3 1249.4L474.9 1265.3C474.5 1266.9 475.3 1268.5 476.8 1269.1C478.3 1269.7 
          ...
          <g
            style={{
              visibility: tooth46Diagnozis.culttab ? 'inherit' : 'hidden',
              opacity: tooth46Diagnozis.culttab ? 1 : 0,
            }}
          >
            <path
              className="st14"
          ...
          <g
            ...
            style={{
              visibility:
                !tooth46Diagnozis.culttab && !tooth46Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
            ...
            ></path>
            <path
              className={`st7 ${tooth46Diagnozis?.cervical_caries ? 'cervical-caries' : ''}`}
