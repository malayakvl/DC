...
export default function Tooth53() {
  ...
  const setColordedPart = (diagnozis, toothPart = '') => {
    if (diagnozis === 'caries') {
      if (toothPart === 'bottom') {
        teethDiagnozis.tooth53.caries_bottom =
          !teethDiagnozis.tooth53.caries_bottom;
      }
      if (toothPart === 'center') {
        teethDiagnozis.tooth53.caries_center =
          !teethDiagnozis.tooth53.caries_center;
      }
      if (toothPart === 'left') {
        teethDiagnozis.tooth53.caries_left =
          !teethDiagnozis.tooth53.caries_left;
      }
      if (toothPart === 'right') {
        teethDiagnozis.tooth53.caries_right =
          !teethDiagnozis.tooth53.caries_right;
      }
      if (toothPart === 'top') {
    ...
    if (diagnozis === 'seal') {
      if (toothPart === 'center') {
        if (
          ...
          teethDiagnozis.tooth53.seal_center =
            !teethDiagnozis.tooth53.seal_center;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      if (toothPart === 'bottom') {
        if (
          ...
          teethDiagnozis.tooth53.seal_bottom =
            !teethDiagnozis.tooth53.seal_bottom;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
      ...
      if (toothPart === 'right') {
        if (
          ...
          teethDiagnozis.tooth53.seal_right =
            !teethDiagnozis.tooth53.seal_right;
        }
        dispatch(setToothDiagnoze(teethDiagnozis));
      }
    ...
    if (diagnozis === 'wedge_shaped_defect') {
      if (
        ...
        teethDiagnozis.tooth53.wedge_shaped_defect_color =
          !teethDiagnozis.tooth53.wedge_shaped_defect_color;
      }
      dispatch(setToothDiagnoze(teethDiagnozis));
    }
  ...
  const showHideOverlay = type => {
    if (type === 'over' && !excludeToothEffect.includes(diagnozis)) {
      if (
        teethType === 'child' &&
        !teethDiagnozis.tooth53.show &&
        !teethDiagnozis.tooth13.show
      ) {
  ...
  return (
    <>
      ...
      >
        <text
          transform="matrix(1 0 0 1 805 716)"
          className={`st3 st4 st5 ${selectedTooth === 53 ? 'num-active' : ''}`}
        >
          53
        </text>
      </g>
      <g
        id="TH-53"
        className={`f-tooth-init-milk ${(teethDiagnozis.tooth53.show || allTeeth) && !teethDiagnozis.tooth53.absent ? 'f-tooth-active' : ''} ${teethType}`}
        onClick={() => {
      ...
      >
        <g
          className={`underlay ${selectedTooth === 53 ? 'selected' : ''}`}
          style={{
            visibility: 'inherit',
        ...
        >
          <path
            className="st40"
            d="M779,217.9c0,0-4,32-6,53s-1,59,0,75s6.9,68.5,7.4,86.8
        ...
        <g
          ...
          style={{
            visibility: 'inherit',
            transform: 'matrix(0.55, 0, 0, 0.55, 22, 22)',
          }}
          onMouseOver={() => {
            showHideOverlay('over');
          }}
        ...
        >
          ...
          <g className="dentin">
            <g
              style={{
                visibility:
                  !tooth53Diagnozis.culttab &&
                  !tooth53Diagnozis.implant &&
                  !tooth53Diagnozis.shaper
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st24 ${tooth53Diagnozis.apex ? 'apex' : ''}`}
            ...
            <g
              style={{
                visibility:
                  tooth53Diagnozis?.apex || tooth53Diagnozis.change_color
                    ? 'inherit'
                    : 'hidden',
              }}
            >
              <path
                className={`st24 change-color ${tooth53Diagnozis?.change_color ? 'diagnoze-opacity' : ''} ${tooth53Diagnozis?.apex ? 'apex' : ''}`}
          ...
          <g
            className="pulp"
            style={{ visibility: tooth53Diagnozis.apex ? 'inherit' : 'hidden' }}
          >
            <g
              className="pulpitis-pfilling"
              style={{
                visibility: tooth53Diagnozis?.apex ? 'inherit' : 'hidden',
              }}
            >
              <path
          ...
          <g
            ...
            style={{
              visibility:
                tooth53Diagnozis.implant || tooth53Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          <g className="shaper" style={{ visibility: 'hidden', opacity: 0 }}>
            ...
            <path
              className="st45"
              d="M826.577 587.739C827.129 585.804 829.871 585.804 830.423 587.739L830.929 589.511C831.225 590.549 832.291 591.164 833.338 590.902L835.126 590.454C837.077 589.965 838.448 592.339 837.049 593.785L835.767 595.109C835.016 595.884 835.016 597.116 835.767 597.891L837.049 599.215C838.448 600.661 837.077 603.035 835.126 602.546L833.338 602.098C832.291 601.836 831.225 602.451 830.929 603.489L830.423 605.261C829.871 607.196 827.129 607.196 826.577 605.261L826.071 603.489C825.775 602.451 824.709 601.836 823.662 602.098L821.874 602.546C819.923 603.035 818.552 600.661 819.951 599.215L821.233 597.891C821.984 597.116 821.984 595.884 821.233 595.109L819.951 593.785C818.552 592.339 819.923 589.965 821.874 590.454L823.662 590.902C824.709 591.164 825.775 590.549 826.071 589.511L826.577 587.739Z"
            ></path>
          </g>
          {/* ABUTMENT */}
          <g
            className="abutment"
            style={{
              visibility: tooth53Diagnozis.abutment ? 'inherit' : 'hidden',
              opacity: tooth53Diagnozis.abutment ? 1 : 0,
            }}
          >
            <path
              className="st47"
              d="M791.5 598.3C790.8 592.9 792.4 587.8 794.7 583C796.9 578.5 799.8 574.1 803.7 570.6C810.3 564.6 819.3 560.1 829.5 560.2C839 560.3 847.3 564.4 853.5 569.9C858 573.8 861.4 578.8 864.5 583.8C866.6 587.1 868.6 590.6 868.8 594.8C869.1 599.9 866.1 604.3 863 608C859.6 612 855.8 615.6 852.5 619.9C850.7 622.3 848.9 624.8 846.6 626.9C842.7 630.4 837.5 632.7 831.9 633.5C824.7 634.5 817.3 633 812 629C809 626.7 807.1 623.8 805 621C802.6 617.7 800 614.4 797.7 611C794.8 607.1 792.1 603.2 791.5 598.3Z"
            ></path>
            <path
              className="st47"
              d="M805.107 597.848C804.655 594.327 805.688 591.001 807.172 587.87C808.592 584.936 810.463 582.066 812.979 579.784C817.238 575.871 823.046 572.936 829.627 573.001C835.757 573.066 841.113 575.74 845.114 579.327C848.018 581.87 850.212 585.131 852.212 588.392C853.567 590.544 854.858 592.827 854.987 595.566C855.18 598.892 853.244 601.761 851.244 604.174C849.05 606.783 846.598 609.131 844.469 611.935C843.307 613.5 842.146 615.131 840.662 616.5C838.145 618.783 834.79 620.283 831.176 620.804C826.53 621.457 821.755 620.478 818.335 617.87C816.399 616.37 815.173 614.478 813.818 612.652C812.27 610.5 810.592 608.348 809.108 606.131C807.236 603.587 805.494 601.044 805.107 597.848Z"
            ></path>
          ...
          >
            ...
            <circle
              ...
              cy="596.001"
              r="12.25"
              style={{ fill: 'black', opacity: tooth53Diagnozis.pin ? 1 : 0 }}
            ></circle>
          </g>
          {/* CULTTAB */}
          <g
            className="stump"
            style={{
              visibility: !tooth53Diagnozis.culttab ? 'hidden' : 'inherit',
              opacity: !tooth53Diagnozis.culttab ? 0 : 1,
            }}
          >
            <path
              className="st47"
          ...
          <g
            ...
            style={{
              visibility:
                !tooth53Diagnozis.culttab &&
                !tooth53Diagnozis.abutment &&
                !tooth53Diagnozis.implant &&
                !tooth53Diagnozis.apex &&
                !tooth53Diagnozis.shaper
                  ? 'inherit'
                  : 'hidden',
            }}
            ...
            <g className="with">
              <path
                ...
                style={{
                  stroke: 'rgb(81, 79, 72)',
                  strokeWidth:
                    (tooth53Diagnozis.seal_left &&
                      !tooth53Diagnozis.seal_bottom &&
                      !tooth53Diagnozis.seal_center) ||
                    (tooth53Diagnozis.seal_left &&
                      !tooth53Diagnozis.seal_bottom &&
                      !tooth53Diagnozis.seal_center) ||
                    (!tooth53Diagnozis.seal_left &&
          ...
          >
            ...
            >
              <path
                className={`vinir-fill ${tooth53Diagnozis.vinir_color}`}
          ...
          <g
            ...
            style={{
              visibility:
                tooth53Diagnozis.temporary_crown ||
                tooth53Diagnozis.ceramic_crown ||
                tooth53Diagnozis.mceramic_crown ||
                tooth53Diagnozis.metalic_crown ||
                tooth53Diagnozis.zirconia_crown
                  ? 'inherit'
                  : 'hidden',
              opacity:
                tooth53Diagnozis.temporary_crown ||
          ...
          >
            ...
            />
            <path
              className={`st3 fissure ${tooth53Diagnozis.fissure ? 'diagnoze' : tooth53Diagnozis.fissure ? 'hidden' : ''}`}
          ...
          {/*FISSURE*/}
          <g
            className={`st3 fissure ${tooth53Diagnozis.fissure ? 'diagnoze' : ''}`}
            style={{
              visibility:
                !tooth53Diagnozis.culttab &&
                !tooth53Diagnozis.abutment &&
        ...
        <g
          ...
          style={{
            visibility: 'inherit',
            transform: 'matrix(0.55, 0, 0, 0.55, 24, 115)',
          }}
          onMouseOver={() => {
        ...
        >
          ...
          <g className="dentin">
            ...
            >
              <path
                className={`st10 change-color ${tooth53Diagnozis.change_color ? 'diagnoze' : ''}`}
          ...
          <g className="pulp">
            <g>
              <path
                className={`st22 target top ${tooth53Diagnozis.channel_class} ${tooth53Diagnozis.channel_class} ${tooth53Diagnozis.pulpit ? 'pulpit' : ''} ${tooth53Diagnozis.periodontit ? 'periodontit' : ''}`}
          ...
          >
            <path
              className="st56 hIntact"
              d="M862.2 463.1C857.8 469.2 850 472.3 844 477.1C838.8 481.3 834.9 486.9 828.8 490.1C827.5 490.8 826.2 491.3 824.8 491.7C823.4 491.3 822 490.8 820.8 490.2C813.8 486.9 809.2 480.9 804.4 475.3C797.8 467.5 790.5 459.9 787.4 450.5C785.6 445.1 785.3 439.5 785.1 433.9C786.1 430.7 787.1 427.6 788.1 424.4C790 
            ...
            <path
              className="st57"
              d="M803.8 293.5L813.6 485.5C815.8 487.5 818.1 489.2 820.9 490.5C822.2 491.1 823.5 491.6 824.9 492C826.3 491.6 827.6 491 828.9 490.4C831.6 489 833.9 487 836.1 485L809.4 294.5C809.3 292.4 807.1 291 805.2 291.9C804.5 292 804 
                            292.7 803.8 293.5Z"
          ...
          >
            <path
              className="st16"
              d="M802.2,399.2c0.2-0.2,0.4-1.4,0.6-1.5c1.9-1.7,4-3.1,6.2-4.4h0c0.3-0.1,0.5-0.3,0.8-0.4s0.5-0.3,0.8-0.4
            ...
            <path
              className="st15"
              d="M862.2,463.1c-4.4,6.1-12.2,9.2-18.2,14c-5.2,4.2-9.1,9.8-15.2,13c-1.3,0.7-2.6,1.2-4,1.6
          ...
          >
            <path
              className="st30"
              d="M861,415.9c-4.4-5.6-11.3-13.3-16.8-17.9c-3.7-3.1-7.6-6-12.2-7.5c-3-1-6.2-1.3-9.3-1.1
                            c-11.8,0.7-22.1,7.9-27.9,18.2c-1.5,2.7-8.7,23.5-9.7,26.4l14.5-52.4l37.6-4.9L861,415.9z"
            />
            <path
              className="st17"
              d="M862.3,463.3c-4.4,6.1-12.2,9.2-18.2,14c-5.2,4.2-9.1,9.8-15.2,13c-1.3,0.7-2.6,1.2-4,1.6
          ...
          >
            <path
              className="st44"
              d="M852.183 414.639C852.915 417 851.353 419.453 848.904 419.788L802.399 426.139C799.951 426.474 797.788 424.531 797.86 422.061L799.014 382.117C799.07 380.157 800.54 378.526 802.484 378.268L836.02 373.805C837.953 373.547 839.789 374.721 840.367 376.584L852.183 414.639Z"
            ></path>
          </g>
          {/* IMPLANT/CULTTAB */}
          <g
          ...
          >
            <path
              className="st18"
              d="M843.9,376l-49.4,6.4c-3.2-26.2-5.8-52.5-7.9-78.8c-2-25.5-3.3-51-4.2-76.5c3.4-5.1,8.6-8.5,14.6-9.3
          ...
          <g
            ...
            style={{
              visibility:
                !tooth53Diagnozis.culttab && !tooth53Diagnozis.abutment
                  ? 'inherit'
                  : 'hidden',
            }}
          >
          ...
          >
            <path
              className="st61 level2"
              d="M874.5 451L873 449.5L872 448L871 445.5L869.5 443V440.5L868.5 437.5L866.5 435.5V434L864.5 430.5L863.5 427L862.5 425L860.5 421.5V420L859 418.5L857.5 416.5L856 415.5L855 413.5L854 412L852 409L848.5 407L846 403.5L842.5 401L841 399L839.5 398L836.5 396.5L833 395L831.5 393.5H828L824 392.5L821 393.5H817L813.5 395L811.5 396.5L808.5 398L805.5 400L804.5 401L803 403.5L800.5 405L798.5 409L797 410L795 413.5V415.5L793.5 416.5L792.5 418.5V420V423L791.5 425L790 427V429L789 433L787 435.5V439.5L785 442L782.5 
            ...
            >
              ...
              <path
                ...
                d="M782.4,464.9c1,4.9,2.6,9.8,4.7,14.4c2.8,6.4,6.5,12.3,10.5,17.9c3.5,4.8,7.5,9.5,11.3,14
                                c-3.3-19.6-10.2-59.8-11.2-61.5c-0.9-1.6-8.9-9.7-13.2-13.9c-0.7,2.3-1.2,4.6-1.7,7C781.5,450,781.3,457.5,782.4,464.9z"
                style={{
                  fill: teethDiagnozis.tooth53.caries_left
                    ? '#606c80'
                    : teethDiagnozis.tooth53.seal_left
                      ? teethDiagnozis.tooth53.seal_left_color
                      : 'transparent',
                }}
              />
            </g>
            ...
            >
              ...
              <path
                ...
                d="M860.3,498.4c2.8-1.7,5.5-3.4,7.9-5.5c3.4-3,6-6.7,7.7-10.8c1.3-7.2,1.4-14.5,0.4-21.8
                                ...
                                C852.6,440.5,857.5,477.6,860.3,498.4z"
                style={{
                  fill: teethDiagnozis.tooth53.caries_right
                    ? '#606c80'
                    : teethDiagnozis.tooth53.seal_right
                      ? teethDiagnozis.tooth53.seal_right_color
                      : 'transparent',
                }}
              />
            </g>
            ...
            >
              ...
              <path
                ...
                d="M784.6,435.8c4.3,4.3,12.3,12.3,13.2,13.9c0.9,1.7,7.8,41.8,11.2,61.5c0.6,0.7,1.2,1.4,1.7,2
                                ...
                                c-11.8,0.7-22.1,7.9-27.9,18.2c-3,5.3-4.8,11.2-6.6,17C787,428.2,785.7,431.9,784.6,435.8z"
                style={{
                  fill: teethDiagnozis.tooth53.caries_top
                    ? '#606c80'
                    : teethDiagnozis.tooth53.seal_top
                      ? teethDiagnozis.tooth53.seal_top_color
                      : 'transparent',
                }}
              />
            </g>
