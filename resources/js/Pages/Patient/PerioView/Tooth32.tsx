...
export default function Tooth32({ className = '', tDia }) {
  const tooth32 = tDia;

  return (
    <>
      <g id="48" className="df-tooth-text" data-number="48">
        <text transform="matrix(1 0 0 1 1213 340)" className="st3 st4 st5">
          32
        </text>
      </g>
      <g
        ...
        transform={
          className === 'bottom'
            ? 'matrix(0.6992818, 0.03170713, -0.03170713, 0.6992818, 466, -414)'
            : 'matrix(-0.6992818, -0.03170713, 0.03170713, -0.6992818, 2000 1064)'
        }
      >
        ...
        <g id="TH_32" className="common-view" style={{ visibility: tooth32.status !== 'absent' ? 'inherit' : 'hidden' }}>
          <g className="dentin">
            <g
            ...
            <g
              style={{ visibility: (tooth32.status === 'implant' || tooth32.status === 'middlepart') ? 'hidden' : 'inherit' }}
            >
              <path
                className="st10"
          ...
          <g
            className="implant"
            style={{ visibility: tooth32.status === 'implant' ? 'inherit' : 'hidden' }}
          >
            <path
              className="st18"
          ...
          <g className="crown" style={{ visibility: tooth32.status !== 'exist' && tooth32.status ? 'inherit' : 'hidden', opacity: (tooth32.status !== 'exist') ? 1 : 0 }}>
            <path
