...
export default function Tooth36({ className = '', tDia }) {
  const tooth36 = tDia;

  return (
    <>
      <g id="48" className="df-tooth-text" data-number="48">
        <text transform="matrix(1 0 0 1 1739 340)" className="st3 st4 st5">
          36
        </text>
      </g>
      <g
        ...
        transform={
          className === 'bottom'
            ? 'matrix(0.6910785, 0.1114022, -0.1114022, 0.6910785, 824, -526)'
            : 'matrix(-0.6910785, -0.1114022, 0.1114022, -0.6910785, 2697 1176)'
        }
      >
        ...
        <g id="TH_36" className="common-view" style={{ visibility: tooth36.status !== 'absent' ? 'inherit' : 'hidden' }}>
          <g className="dentin">
            <g
            ...
            <g
              style={{ visibility: (tooth36.status === 'implant' || tooth36.status === 'middlepart') ? 'hidden' : 'inherit' }}
            >
              <path
                className="st10"
          ...
          <g
            className="implant"
            style={{ visibility: tooth36.status === 'implant' ? 'inherit' : 'hidden' }}
          >
            <path
              className="st18"
          ...
          <g className="crown" style={{ visibility: tooth36.status !== 'exist' && tooth36.status ? 'inherit' : 'hidden', opacity: (tooth36.status !== 'exist') ? 1 : 0 }}>
            <path
