...
export default function Tooth11({ className = '', tDia }) {
  const tooth11 = tDia;

  return (
    <>
      <g id="11" className="df-tooth-text" data-number="11">
        <text transform="matrix(1 0 0 1 955 340)" className="st3 st4 st5 st34">
          11
        </text>
      </g>
      <g
        ...
        transform={
          className === 'bottom'
            ? 'matrix(-0.6970173, -0.06454959, 0.06454959, -0.6970173 1640 826)'
            : 'matrix(0.6970173, 0.06454959, -0.06454959, 0.6970173 313 -177)'
        }
      >
        ...
        <g id="TH_12" className="common-view" style={{ visibility: tooth11.status !== 'absent' ? 'inherit' : 'hidden' }}>
          <g className="dentin">
            <g
            ...
            <g
              style={{ visibility: (tooth11.status === 'implant' || tooth11.status === 'middlepart') ? 'hidden' : 'inherit' }}
            >
              <path
                className="st10"
          ...
          <g
            style={{ visibility: (tooth11.status == 'implant') ? 'inherit' : 'hidden' }}
          >
            <path
              className="st18"
          ...
          <g className="crown" style={{ visibility: tooth11.status !== 'exist' && tooth11.status ? 'inherit' : 'hidden', opacity: (tooth11.status !== 'exist') ? 1 : 0 }}>
            <path
