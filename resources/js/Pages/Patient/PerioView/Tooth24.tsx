...
export default function Tooth24({ className = '', tDia }) {
  const tooth24 = tDia;

  return (
    <>
      <g id="24" className="df-tooth-text" data-number="24">
        <text transform="matrix(1 0 0 1 1475 340)" className="st3 st4 st5">
          24
        </text>
      </g>
      <g
        ...
        transform={
          className === 'bottom'
            ? 'matrix(-0.6999377, 0.00933562, -0.00933562, -0.6999377 2458 744)'
            : 'matrix(0.6999377, -0.00933562, 0.00933562, 0.6999377 540 -95)'
        }
      >
        ...
        <g id="TH_24" className="common-view" style={{ visibility: tooth24.status !== 'absent' ? 'inherit' : 'hidden' }}>
          <g className="dentin">
            <g
            ...
            <g
              style={{ visibility: (tooth24.status === 'implant' || tooth24.status === 'middlepart') ? 'hidden' : 'inherit' }}
            >
              <path
                className="st10"
          ...
          <g
            style={{ visibility: (tooth24.status == 'implant') ? 'inherit' : 'hidden' }}
          >
            <path
              className="st18"
          ...
          <g className="crown" style={{ visibility: tooth24.status !== 'exist' && tooth24.status ? 'inherit' : 'hidden', opacity: (tooth24.status !== 'exist') ? 1 : 0 }}>
            <path
