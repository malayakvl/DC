...
export default function Tooth46({ className = '', tDia }) {
  const tooth46 = tDia;

  return (
    <>
      <g id="48" className="df-tooth-text" data-number="48">
        <text transform="matrix(1 0 0 1 311 340)" className="st3 st4 st5">
          46
        </text>
      </g>
      <g
      ...
      >
        ...
        <g id="TH_46" className="common-view" style={{ visibility: tooth46.status !== 'absent' ? 'inherit' : 'hidden' }}>
          ...
          <g className="crown" style={{ visibility: tooth46.status !== 'exist' && tooth46.status ? 'inherit' : 'hidden', opacity: (tooth46.status !== 'exist') ? 1 : 0 }}>
            <path
