...
export default function Tooth17({ className = '', tDia }) {
  const tooth17 = tDia;

  return (
    <>
      <g id="17" className="df-tooth-text" data-number="17">
        <text transform="matrix(1 0 0 1 175 340)" className="st3 st4 st5">
          17
        </text>
      </g>
      <g
        ...
        transform={
          className === 'bottom'
            ? 'matrix(-0.6950482, 0.0831159, -0.0831159, -0.6950482 505 698)'
            : 'matrix(0.6958441, -0.076167, 0.076167, 0.6958441 -111 -44)'
        }
      ...
      >
        ...
        <g id="TH_17" className="common-view" style={{ visibility: tooth17.status !== 'absent' ? 'inherit' : 'hidden' }}>
          <g className="dentin">
            <g
            ...
            <g
              style={{ visibility: (tooth17.status === 'implant' || tooth17.status === 'middlepart') ? 'hidden' : 'inherit' }}
            >
              <path
                className="st10"
          ...
          <g
            className="implant"
            style={{ visibility: tooth17.status === 'implant' ? 'inherit' : 'hidden' }}
          >
            <path
              className="st18"
