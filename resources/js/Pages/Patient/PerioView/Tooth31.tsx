...
export default function Tooth31({ className = '', tDia }) {
  const tooth31 = tDia;

  return (
    <>
      <g id="48" className="df-tooth-text" data-number="48">
        <text transform="matrix(1 0 0 1 1092 340)" className="st3 st4 st5">
          31
        </text>
      </g>
      <g
        ...
        transform={
          className === 'bottom'
            ? 'matrix(0.6991964, 0.03353777, -0.03353777, 0.6991964, 386, -414    )'
            : 'matrix(-0.6991964, -0.03353777, 0.03353777, -0.6991964, 1824 1064)'
        }
      >
        ...
        <g id="TH_31" className="common-view" style={{ visibility: tooth31.status !== 'absent' ? 'inherit' : 'hidden' }}>
          <g className="dentin">
            <g
            ...
            <g
              style={{ visibility: (tooth31.status === 'implant' || tooth31.status === 'middlepart') ? 'hidden' : 'inherit' }}
            >
              <path
                className="st10"
          ...
          <g
            className="implant"
            style={{ visibility: tooth31.status === 'implant' ? 'inherit' : 'hidden' }}
          >
            <path
              className="st18"
          ...
          <g className="crown" style={{ visibility: tooth31.status !== 'exist' && tooth31.status ? 'inherit' : 'hidden', opacity: (tooth31.status !== 'exist') ? 1 : 0 }}>
            <path
