...
export default function Tooth18({ className = '', tDia }) {
  const tooth18 = tDia;

  return (
    <>
      <g id="18" className="df-tooth-text" data-number="18">
        <text transform="matrix(1 0 0 1 45 340)" className="st3 st4 st5">
          18
        </text>
      </g>
      <g
        ...
        transform={
          className === 'bottom'
            ? 'matrix(-0.6950482, 0.0831159, -0.0831159, -0.6950482 285 698)'
            : 'matrix(0.6950482, -0.0831159, 0.0831159, 0.6950482 -157 -44)'
        }
        opacity="1"
        data-type="intact"
      >
        ...
        <g id="TH_18" className="common-view" style={{ visibility: tooth18.status !== 'absent' ? 'inherit' : 'hidden' }}>
          <g className="dentin">
            <g
            ...
            <g
              style={{ visibility: (tooth18.status === 'implant' || tooth18.status === 'middlepart') ? 'hidden' : 'inherit' }}
            >
              <path
                className="st10"
          ...
          <g
            className="implant"
            style={{ visibility: tooth18.status === 'implant' ? 'inherit' : 'hidden' }}
          >
            <path
              className="st18"
