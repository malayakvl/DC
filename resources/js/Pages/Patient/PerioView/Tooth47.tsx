...
export default function Tooth47({ className = '', tDia }) {
  const tooth47 = tDia;

  return (
    <>
      <g id="48" className="df-tooth-text" data-number="48">
        <text transform="matrix(1 0 0 1 178 340)" className="st3 st4 st5">
          47
        </text>
      </g>
      <g
        ...
        transform={
          className === 'bottom'
            ? 'matrix(0.6654039, -0.2173423, 0.2173423, 0.6654039 -315 -218)'
            : 'matrix(-0.6654039, 0.2173423, -0.2173423, -0.6654039 706 870)'
        }
      >
        ...
        <g id="TH_47" className="common-view" style={{ visibility: tooth47.status !== 'absent' ? 'inherit' : 'hidden' }}>
          <g className="dentin">
            <g
            ...
            <g
              style={{ visibility: (tooth47.status === 'implant' || tooth47.status === 'middlepart') ? 'hidden' : 'inherit' }}
            >
              <path
                className="st10"
          ...
          <g
            className="implant"
            style={{ visibility: tooth47.status === 'implant' ? 'inherit' : 'hidden' }}
          >
            <path
              className="st18"
          ...
          <g className="crown" style={{ visibility: tooth47.status !== 'exist' && tooth47.status ? 'inherit' : 'hidden', opacity: (tooth47.status !== 'exist') ? 1 : 0 }}>
            <path
