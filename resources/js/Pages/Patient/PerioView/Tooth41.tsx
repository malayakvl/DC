...
export default function Tooth41({ className = '', tDia }) {
  const tooth41 = tDia;

  return (
    <>
      <g id="48" className="df-tooth-text" data-number="48">
        <text transform="matrix(1 0 0 1 956 340)" className="st3 st4 st5">
          41
        </text>
      </g>
      <g
        ...
        transform={
          className === 'bottom'
            ? 'matrix(0.69937, -0.02969792, 0.02969792, 0.69937 236 -348)'
            : 'matrix(-0.69937, 0.02969792, -0.02969792, -0.69937 1724 1004)'
        }
      >
        ...
        <g id="TH_41" className="common-view" style={{ visibility: tooth41.status !== 'absent' ? 'inherit' : 'hidden' }}>
          <g className="dentin">
            <g
            ...
            <g
              style={{ visibility: (tooth41.status === 'implant' || tooth41.status === 'middlepart') ? 'hidden' : 'inherit' }}
            >
              <path
                className="st10"
          ...
          <g
            className="implant"
            style={{ visibility: tooth41.status === 'implant' ? 'inherit' : 'hidden' }}
          >
            <path
              className="st18"
          ...
          <g className="crown" style={{ visibility: tooth41.status !== 'exist' && tooth41.status ? 'inherit' : 'hidden', opacity: (tooth41.status !== 'exist') ? 1 : 0 }}>
            <path
