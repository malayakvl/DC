...
export default function Tooth27({ className = '', tDia }) {
  const tooth27 = tDia;

  return (
    <>
      <g id="27" className="df-tooth-text" data-number="27">
        <text transform="matrix(1 0 0 1 1865 340)" className="st3 st4 st5">
          27
        </text>
      </g>
      ...
      <g
        ...
        transform={
          className === 'bottom'
            ? 'matrix(-0.6978531, -0.05478109, 0.05478109, -0.6978531 3049 828)'
            : 'matrix(0.6931834, 0.0974505, -0.0974505, 0.6931834 756 -243)'
        }
      >
        ...
        <g id="TH_27" className="common-view" style={{ visibility: tooth27.status !== 'absent' ? 'inherit' : 'hidden' }}>
          <g className="dentin">
            <g>
              <path
                className="st9"
            ...
            <g
              style={{ visibility: (tooth27.status === 'implant' || tooth27.status === 'middlepart') ? 'hidden' : 'inherit' }}
            >
              <path
                className="st10"
          ...
          <g className="pulp">
            ...
            <g className="pulpitis-pfilling" data-position="27">
              <path
                className="st22 target"
          ...
          <g
            style={{ visibility: (tooth27.status == 'implant') ? 'inherit' : 'hidden' }}
          >
            <path
              className="st18"
          ...
          <g className="crown" style={{ visibility: tooth27.status !== 'exist' && tooth27.status ? 'inherit' : 'hidden', opacity: (tooth27.status !== 'exist') ? 1 : 0 }}>
            <path
