...
export default function Tooth48({ className = '', tDia }) {
  const tooth48 = tDia;
  ...
  return (
    <>
      ...
      <g
        ...
        transform={
          className === 'bottom'
            ? 'matrix(0.67697, -0.1780765, 0.1780765, 0.67697 -306 -238)'
            : 'matrix(-0.67697, 0.1780765, -0.1780765, -0.67697 436 890)'
        }
      >
        ...
        <g id="TH_48" className="common-view" style={{ visibility: tooth48.status !== 'absent' ? 'inherit' : 'hidden' }}>
          <g className="dentin">
            <g
            ...
            <g
              style={{ visibility: (tooth48.status === 'implant' || tooth48.status === 'middlepart') ? 'hidden' : 'inherit' }}
            >
              <path
                className="st10"
          ...
          >
            <path
              ...
              d="M205.5 1088.4C210.2 1098.5 217.8 1106.7 226.6 1113.5C227.2 1114 227.9 1114.5 228.6 1115C230.9 1116.6 233.2 1118.1 235.6 1119.5C236.8 1120.2 237.9 1120.8 239.1 1121.4C247.8 1125.7 257.2 1128.4 266.8 1130.1C268.9 1130.5 271.1 1130.8 273.3 1131C285.7 1132.5 298.2 1132.2 310.5 1130.2C311.1 1129.7 311.7 1129.3 312.2 1128.8C313.6 1127.4 315 1126 316.5 1124.5C317.9 1116.3 319.1 1105.7 319.6 1097.4C320 1089.9 320.1 1082.3 319.8 1074.8C311.2 1076.1 302.5 1077 293.8 1077.6C285.1 1078.2 276.5 1078.4 267.8 1078.2C261.3 1074.7 255.2 1070.8 249.4 1066.5C243.7 1062.3 238.3 1057.7 233.3 1052.7C228 1057 223 1061.7 218.5 1066.7C213.9 1071.8 209.8 1077.2 206.1 1082.9C206.1 1084.5 205.5 1086.8 205.5 1088.4Z"
              style={{ visibility: 'hidden' }}
            ></path>
            <path
              className="st57"
              d="M263.2 1075.5L239.3 1121.2L224.8 1148.9L219 1160.1C218.5 1161.1 217.2 1161.3 216.5 1160.5C216.1 1160.1 215.9 1159.5 216.1 1159L247.2 1064.7C247.9 1065.2 248.5 1065.7 249.2 1066.2C249.3 1066.3 249.4 1066.3 249.5 1066.4C250.2 1066.9 251 1067.5 251.7 1068C252.4 1068.5 253.1 1069 253.8 1069.4C253.9 1069.5 254 1069.5 254.1 1069.6C254.8 1070.1 255.5 1070.6 256.3 1071.1C256.3 1071.1 256.4 1071.1 256.4 1071.2C257.1 1071.7 257.9 1072.1 258.6 1072.6C259.4 1073.1 260.1 1073.6 260.9 1074C261.7 1074.5 262.5 1075 263.3 1075.4C263.1 1075.5 263.2 1075.5 263.2 1075.5Z"
            ></path>
          </g>
          <g
            className="stump"
          ...
          <g
            className="implant"
            style={{ visibility: tooth48.status === 'implant' ? 'inherit' : 'hidden' }}
          >
            <path
              className="st18"
