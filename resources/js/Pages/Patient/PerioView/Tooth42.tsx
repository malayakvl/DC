...
export default function Tooth42({ className = '', tDia }) {
  const tooth42 = tDia;

  return (
    <>
      <g id="48" className="df-tooth-text" data-number="48">
        <text transform="matrix(1 0 0 1 826 340)" className="st3 st4 st5">
          42
        </text>
      </g>
      <g
        ...
        transform={
          className === 'bottom'
            ? 'matrix(0.69937, -0.02969792, 0.02969792, 0.69937 146 -348)'
            : 'matrix(-0.6993994, 0.028994, -0.028994, -0.6993994 1542 1008)'
        }
      >
        ...
        <g id="TH_42" className="common-view" style={{ visibility: tooth42.status !== 'absent' ? 'inherit' : 'hidden' }}>
          <g className="dentin">
            <g
            ...
            <g
              style={{ visibility: (tooth42.status === 'implant' || tooth42.status === 'middlepart') ? 'hidden' : 'inherit' }}
            >
              <path
                className="st10"
          ...
          <g
            className="implant"
            style={{ visibility: tooth42.status === 'implant' ? 'inherit' : 'hidden' }}
          >
            <path
              className="st18"
          ...
          <g className="crown" style={{ visibility: tooth42.status !== 'exist' && tooth42.status ? 'inherit' : 'hidden', opacity: (tooth42.status !== 'exist') ? 1 : 0 }}>
            <path
