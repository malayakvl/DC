...
export default function Tooth37({ className = '', tDia }) {
  const tooth37 = tDia;

  return (
    <>
      <g id="48" className="df-tooth-text" data-number="48">
        <text transform="matrix(1 0 0 1 1866 340)" className="st3 st4 st5">
          37
        </text>
      </g>
      <g
        ...
        transform={
          className === 'bottom'
            ? 'matrix(0.6672204, 0.2117003, -0.2117003, 0.6672204, 994, -667)'
            : 'matrix(-0.6672204, -0.2117003, 0.2117003, -0.6672204, 2782 1318)'
        }
      >
        ...
        <g id="TH_37" className="common-view" style={{ visibility: tooth37.status !== 'absent' ? 'inherit' : 'hidden' }}>
          <g className="dentin">
            <g
            ...
            <g
              style={{ visibility: (tooth37.status === 'implant' || tooth37.status === 'middlepart') ? 'hidden' : 'inherit' }}
            >
              <path
                className="st10"
          ...
          >
            ...
            <g
              className="implant"
              style={{ visibility: tooth37.status === 'implant' ? 'inherit' : 'hidden' }}
            >
            <path
              className="st18"
          ...
          <g className="crown" style={{ visibility: tooth37.status !== 'exist' && tooth37.status ? 'inherit' : 'hidden', opacity: (tooth37.status !== 'exist') ? 1 : 0 }}>
            <path
