...
export default function Tooth33({ className = '', tDia }) {
  const tooth33 = tDia;

  return (
    <>
      <g id="48" className="df-tooth-text" data-number="48">
        <text transform="matrix(1 0 0 1 1346 340)" className="st3 st4 st5">
          33
        </text>
      </g>
      <g
        ...
        transform={
          className === 'bottom'
            ? 'matrix(0.6986273, 0.04381874, -0.04381874, 0.6986273, 560, -438)'
            : 'matrix(-0.6986273, -0.04381874, 0.04381874, -0.6986273, 2172 1087)'
        }
      >
        ...
        <g id="TH_33" className="common-view" style={{ visibility: tooth33.status !== 'absent' ? 'inherit' : 'hidden' }}>
          <g className="dentin">
            <g
            ...
            <g
              style={{ visibility: (tooth33.status === 'implant' || tooth33.status === 'middlepart') ? 'hidden' : 'inherit' }}
            >
              <path
                className="st10"
          ...
          <g
            className="implant"
            style={{ visibility: tooth33.status === 'implant' ? 'inherit' : 'hidden' }}
          >
            <path
              className="st18"
          ...
          <g className="crown" style={{ visibility: tooth33.status !== 'exist' && tooth33.status ? 'inherit' : 'hidden', opacity: (tooth33.status !== 'exist') ? 1 : 0 }}>
            <path
