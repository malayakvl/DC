...
return new class extends Migration
{
    ...
    {
        DB::unprepared("
            CREATE OR REPLACE FUNCTION core.post_opening_balance(
                p_schema text,
                p_invoice_id bigint
            )
            RETURNS void
    ...
    {
        DB::unprepared("DROP FUNCTION IF EXISTS core.post_opening_balance(text, bigint)");
    }
};
